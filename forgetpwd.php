...
<script type="text/javascript" src="csfnew/js/jquery-1.8.2.min.js"></script> 
<script type="text/javascript" src="csfnew/js/jquery.tablesorter.js"></script>
<script src="csfnew/js/jPages.js"></script>

<script src="csfnew/js/jquery.icheck.min.js?v=0.9.1"></script>
...
<script type="text/javascript" src="csfnew/js/jquery.multiselect.js"></script> 
...
<body class="forgotpwd"> 
  ...
  <div class="login-screen">
	...
	<div class="login-cnt forgot-screen" style="padding-bottom:0px !important; margin-top:20px !important;">
      <form name="forgotpwd" onSubmit="return checkFields();" method="post" action="forgetpwdsubmit.php" >
        ...
        <ul>
          ...
          <li><input type="submit" name="btnPwdSubmit" value ="Submit" style="margin-top: 5px;" /></li>
          <?php if($displayMessage !='') {  ?> <li><?php echo $displayMessage; ?></li> <?php } ?>
        </ul>
		<p style="text-align: justify;"> Please enter your registered email to receive a password reset mail. </p>
      </form>
    </div>
  </div>

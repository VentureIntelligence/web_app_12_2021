...
/*
formname - pepulse_fssubmit.php
filename - pepulse_fssubmit
invoked from -pepulse_fs.htm  AND pepulse_fs.php ( 2 files)
*/
...
//********Mail details
			...
			$RegDate=date("M-d-Y");
			$to="arun.natarajan@gmail.com,arihant@ventureintelligence.com,jayanth@ventureintelligence.com";
		   	//$to .="sow_ram@yahoo.com";
		$subject="FS Rep Download-" .$revenure_range_display."-".$firmname;
		$message="<html><center><b><u>FS Report Download</u></b></center><br>
...
?>
	    ...
	    <div id="maintextpro">
           ...
           <div id="headingtextpro">
            <div id="headingtextprobold">PE Pulse Financial Services<br /> <br /></div>
           Thanks for your interest in the PE Pulse Report on Financial Services report.
           <br /> <br />

			<span style="float:right" class="one">
		  	<a href="pepulse-fs.pdf"><img src="images/arrow.gif" border="0" /> Download this report </a></span>

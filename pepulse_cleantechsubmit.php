...
formname - pepulse_cleantechsubmit.php
filename - pepulse_cleantechsubmit
invoked from -pepulse_cleantech.htm  AND pepulse_cleantech.php ( 2 files)
*/
...
//********Mail details
			$RegDate=date("M-d-Y");
			$to="arun.natarajan@gmail.com,arihant@ventureintelligence.com,varatha@ventureintelligence.com";
		   	//$to .="sowmyakvn@gmail.com";
		$subject="Cleantech Rep Download-" .$revenure_range_display."-".$firmname;
		$message="<html><center><b><u>Cleantech Report Download</u></b></center><br>
		<head></head>		<body >
...
?>
	    ...
	    <div id="maintextpro">
           ...
           <div id="headingtextpro">
            <div id="headingtextprobold">PE Pulse on Cleantech<br /> <br /></div>
           Thanks for your intrest in this report.

			<span style="float:right" class="one"> <br/>
		  	<a href="pepulse-ct-2010.pdf"><img src="images/arrow.gif" border="0" /><b>Click Here</b></a> to download the PDF version.<br/> (Recommended: Use Right Click > Save As to download to your desktop)</span>

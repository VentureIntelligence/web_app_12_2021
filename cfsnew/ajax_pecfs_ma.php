        ...
        if(count($pedata) > 0){
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="myTable">
                    <thead><tr>
                        ...
                        <th style="width: 850px;" class="headertbma" data-order="'.$order_sector.'" id="sector_business">Sector</th>
                        <th style="width: 260px;" class="headertbma" data-order="'.$order_acquirer.'" id="acquirer">Acquirer</th>
                        <th style="width: 200px;" class="headertbma" data-order="'.$order_dates.'" id="dates">Date</th>

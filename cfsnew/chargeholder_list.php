        ...
        if(array_keys($Companies)){
            $labelid=0;
                ...
                foreach($Companies as $id => $name) {
                    ...
                    $checkoption.= '<div id="result_cc"><label class="ch_holder" style="cursor:pointer;"><input type="checkbox" class="chargeholderoption" value="'.$name.'" name="chargeholderoption"> '.$name.'</label></div>';

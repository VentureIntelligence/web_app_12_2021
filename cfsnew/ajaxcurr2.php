...
<div class="left-cnt" ><label>Take CAGR of past</label><select name="noofyear" id="noofyear">
    ...
    <div class="right-cnt">
        <label>Currency</label>  <select onChange="javascript:currencyconvert(this.value,<?php echo $_GET['vcid']; ?>)" name="ccur" id="ccur" size="100">
...
<div class="projection-cnt">
		...
		?>
                        ...
                        <li><?php if($FinanceAnnual[$i][OptnlIncome]==0){echo '&nbsp';}else{$vale = currency_convert($FinanceAnnual[$i][OptnlIncome],'INR',$_GET['queryString']);$tot=$vale/$convalue;echo round($tot,2); if($vale==''){echo '&nbsp';}} ?></li>
                        <li><?php if($FinanceAnnual[$i][OtherIncome]==0){echo '&nbsp';}else{ $vale = currency_convert($FinanceAnnual[$i][OtherIncome],'INR',$_GET['queryString']);$tot=$vale/$convalue;echo round($tot,2); if($vale==''){echo '&nbsp';}} ?></li>
                        <li><?php if($FinanceAnnual[$i][TotalIncome]==0){echo '&nbsp';}else{ $vale = currency_convert($FinanceAnnual[$i][TotalIncome],'INR',$_GET['queryString']);$tot=$vale/$convalue;echo round($tot,2); if($vale==''){echo '&nbsp';}} ?></li>
                        <li><?php if($FinanceAnnual[$i][OptnlAdminandOthrExp]==0){echo '&nbsp';}else{ $vale = currency_convert($FinanceAnnual[$i][OptnlAdminandOthrExp],'INR',$_GET['queryString']); $tot=$vale/$convalue;echo round($tot,2); if($vale==''){echo '&nbsp';}} ?></li>
                        <li><?php if($FinanceAnnual[$i][OptnlProfit]==0){echo '&nbsp';}else{ $vale = currency_convert($FinanceAnnual[$i][OptnlProfit],'INR',$_GET['queryString']);$tot=$vale/$convalue;echo round($tot,2);  if($vale==''){echo '&nbsp';}} ?></li>
                        <li><?php if($FinanceAnnual[$i][EBITDA]==0){echo '&nbsp';}else{ $vale = currency_convert($FinanceAnnual[$i][EBITDA],'INR',$_GET['queryString']); $tot=$vale/$convalue;echo round($tot,2); if($vale==''){echo '&nbsp';}} ?></li>
                        <li><?php if($FinanceAnnual[$i][Interest]==0){echo '&nbsp';}else{ $vale = currency_convert($FinanceAnnual[$i][Interest],'INR',$_GET['queryString']); $tot=$vale/$convalue;echo round($tot,2); if($vale==''){echo '&nbsp';}} ?></li>
                        <li><?php if($FinanceAnnual[$i][EBDT]==0){echo '&nbsp';}else{ $vale = currency_convert($FinanceAnnual[$i][EBDT],'INR',$_GET['queryString']);$tot=$vale/$convalue;echo round($tot,2);  if($vale==''){echo '&nbsp';}} ?></li>
                        <li><?php if($FinanceAnnual[$i][Depreciation]==0){echo '&nbsp';}else{ $vale = currency_convert($FinanceAnnual[$i][Depreciation],'INR',$_GET['queryString']);$tot=$vale/$convalue;echo round($tot,2);  if($vale==''){echo '&nbsp';}} ?></li>
                        <li><?php if($FinanceAnnual[$i][EBT]==0){echo '&nbsp';}else{ $vale = currency_convert($FinanceAnnual[$i][EBT],'INR',$_GET['queryString']);$tot=$vale/$convalue;echo round($tot,2);  if($vale==''){echo '&nbsp';}} ?></li>
                        <li><?php if($FinanceAnnual[$i][Tax]==0){echo '&nbsp';}else{ $vale = currency_convert($FinanceAnnual[$i][Tax],'INR',$_GET['queryString']); $tot=$vale/$convalue;echo round($tot,2); if($vale==''){echo '&nbsp';}} ?></li>
                        <li><?php if($FinanceAnnual[$i][PAT]==0){echo '&nbsp';}else{ $vale = currency_convert($FinanceAnnual[$i][PAT],'INR',$_GET['queryString']); $tot=$vale/$convalue;echo round($tot,2); if($vale==''){echo '&nbsp';}} ?></li>
                        <li><?php echo '&nbsp'; ?></li>
                        <li><?php if($FinanceAnnual[$i][BINR]==0){echo '&nbsp';}else{ $vale = currency_convert($FinanceAnnual[$i][BINR],'INR',$_GET['queryString']); $tot=$vale/$convalue;echo round($tot,2); if($vale==''){echo '&nbsp';}} ?></li>
                        <li><?php if($FinanceAnnual[$i][DINR]==0){echo '&nbsp';}else{ $vale = currency_convert($FinanceAnnual[$i][DINR],'INR',$_GET['queryString']); $tot=$vale/$convalue;echo round($tot,2); if($vale==''){echo '&nbsp';}} ?></li>
                        <li><?php echo '&nbsp'; ?></li>
                         <li><?php echo '&nbsp'; ?></li>
                       <li><?php if($FinanceAnnual[$i][EmployeeRelatedExpenses]==0){echo '&nbsp';}else{ $vale = currency_convert($FinanceAnnual[$i][EmployeeRelatedExpenses],'INR',$_GET['queryString']); $tot=$vale/$convalue;echo round($tot,2); if($vale==''){echo '&nbsp';}} ?></li>
                        <li><?php if($FinanceAnnual[$i][ForeignExchangeEarningandOutgo]==0){echo '&nbsp';}else{ $vale = currency_convert($FinanceAnnual[$i][ForeignExchangeEarningandOutgo],'INR',$_GET['queryString']); $tot=$vale/$convalue;echo round($tot,2); if($vale==''){echo '&nbsp';}} ?></li>
                        <li><?php if($FinanceAnnual[$i][EarninginForeignExchange]==0){echo '&nbsp';}else{ $vale = currency_convert($FinanceAnnual[$i][EarninginForeignExchange],'INR',$_GET['queryString']); $tot=$vale/$convalue;echo round($tot,2); if($vale==''){echo '&nbsp';}} ?></li>
                        <li><?php if($FinanceAnnual[$i][OutgoinForeignExchange]==0){echo '&nbsp';}else{ $vale = currency_convert($FinanceAnnual[$i][OutgoinForeignExchange],'INR',$_GET['queryString']); $tot=$vale/$convalue;echo round($tot,2); if($vale==''){echo '&nbsp';}} ?></li>
                        </ul>  
		<?php
		}
		else{
		?>
                             ...
                             <ul>
                        <li><h4>FY <?php echo $FinanceAnnual[$i][FY];?></h4></li>  
                        <li><?php if($FinanceAnnual[$i][OptnlIncome]==0){echo '&nbsp';}else{ $tot= ($FinanceAnnual[$i][OptnlIncome])/$convalue;echo round($tot,2); } ?></li>
                        <li><?php if($FinanceAnnual[$i][OtherIncome]==0){echo '&nbsp';}else{ $tot= ($FinanceAnnual[$i][OtherIncome])/$convalue;echo round($tot,2); } ?></li>
                        <li><?php if($FinanceAnnual[$i][TotalIncome]==0){echo '&nbsp';}else{ $tot= ($FinanceAnnual[$i][TotalIncome])/$convalue;echo round($tot,2); } ?></li>
                        <li><?php if($FinanceAnnual[$i][OptnlAdminandOthrExp]==0){echo '&nbsp';}else{ $tot= ($FinanceAnnual[$i][OptnlAdminandOthrExp])/$convalue;echo round($tot,2); } ?></li>
                        <li><?php if($FinanceAnnual[$i][OptnlProfit]==0){echo '&nbsp';}else{ $tot= ($FinanceAnnual[$i][OptnlProfit])/$convalue;echo round($tot,2); } ?></li>
                        <li><?php if($FinanceAnnual[$i][EBITDA]==0){echo '&nbsp';}else{ $tot= ($FinanceAnnual[$i][EBITDA])/$convalue;echo round($tot,2); } ?></li>
                        <li><?php if($FinanceAnnual[$i][Interest]==0){echo '&nbsp';}else{ $tot= ($FinanceAnnual[$i][Interest])/$convalue;echo round($tot,2); } ?></li>
                        <li><?php if($FinanceAnnual[$i][EBDT]==0){echo '&nbsp';}else{ $tot= ($FinanceAnnual[$i][EBDT]/$convalue);echo round($tot,2); } ?></li>
                        <li><?php if($FinanceAnnual[$i][Depreciation]==0){echo '&nbsp';}else{ $tot= ($FinanceAnnual[$i][Depreciation])/$convalue;echo round($tot,2); } ?></li>
                        <li><?php if($FinanceAnnual[$i][EBT]==0){echo '&nbsp';}else{$tot= ($FinanceAnnual[$i][EBT])/$convalue;echo round($tot,2); } ?></li>
                        <li><?php if($FinanceAnnual[$i][Tax]==0){echo '&nbsp';}else{ $tot= ($FinanceAnnual[$i][Tax])/$convalue;echo round($tot,2); } ?></li>
                        <li><?php if($FinanceAnnual[$i][PAT]==0){echo '&nbsp';}else{ $tot= ($FinanceAnnual[$i][PAT])/$convalue;echo round($tot,2); } ?></li>
                        <li><?php echo '&nbsp'; ?></li>
                        <li><?php if($FinanceAnnual[$i][BINR]==0){echo '&nbsp';}else{ $tot= ($FinanceAnnual[$i][BINR])/$convalue;echo round($tot,2); } ?></li>
                        <li><?php if($FinanceAnnual[$i][DINR]==0){echo '&nbsp';}else{ $tot= ($FinanceAnnual[$i][DINR])/$convalue;echo round($tot,2); } ?></li>
                        <li><?php echo '&nbsp'; ?></li>
                         <li><?php echo '&nbsp'; ?></li>
                      <li><?php if($FinanceAnnual[$i][EmployeeRelatedExpenses]==0){echo '&nbsp';}else{ $tot= ($FinanceAnnual[$i][EmployeeRelatedExpenses])/$convalue;echo round($tot,2); } ?></li>
                        ...
                        <li><?php if($FinanceAnnual[$i][EarninginForeignExchange]==0){echo '&nbsp';}else{ $tot=($FinanceAnnual[$i][EarninginForeignExchange])/$convalue;echo round($tot,2); } ?></li>
                        <li><?php if($FinanceAnnual[$i][OutgoinForeignExchange]==0){echo '&nbsp';}else{ $tot= ($FinanceAnnual[$i][OutgoinForeignExchange])/$convalue;echo round($tot,2); } ?></li>
                        </ul> 

...
$balancesheet_new = new balancesheet_new();global $FinanceAnnual;
...
?>
 ...
 <?php for($i=0;$i<count($FinanceAnnual);$i++){ 
    ?>  
        <td><?php if($FinanceAnnual[$i][TotalIncome]==0){echo '-';}else{ echo $FinanceAnnual[$i][TotalIncome]; } ?></td>
           <?php
}
?>
  </tr>
...
?>
  ...
  <tr>
    <?php for($i=0;$i<count($FinanceAnnual);$i++){ 
        ...
        ?> 
        <td><?php if($FinanceAnnual[$i][EBITDA]==0){echo '-';}else{ echo $FinanceAnnual[$i][EBITDA]; } ?></td>
                     <?php
    }
?>
  </tr>
...
?>
  ...
  <tr>
    <?php for($i=0;$i<count($FinanceAnnual);$i++){ 
        ?>   
         <td><?php if($FinanceAnnual[$i][PAT]==0){echo '-';}else{ echo $FinanceAnnual[$i][PAT]; } ?></td>
 <?php
}
?>
  </tr>
...
$FinanceAnnual1_new = $balancesheet_new->getFullList(1,100,$fields1,$where1,$order1,"name",$group1); 
if(count($FinanceAnnual1_new)==0){
   $FinanceAnnual1_new = $balancesheet_new->getFullList_withoutPL(1,100,$fields1,$where_withoutPL,$order1,"name",$group1); 
}
//echo '<pre>';
//print_r($FinanceAnnual1);
//echo '</pre>';

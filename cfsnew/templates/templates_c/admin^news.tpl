<?php /* Smarty version 2.5.0, created on 2014-01-27 08:37:17
         compiled from admin/news.tpl */ ?>
<?php $this->_load_plugins(array(
array('function', 'html_options', 'admin/news.tpl', 137, false),)); ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<div class="breadcrumb">
	...
	<div class="breadtext">&nbsp;</div>
		...
		<div class="adtitle" align="center">Add News</div>


<form name="Frm_AddNews" id="Frm_AddNews" action="" method="post" onSubmit="return NewsValidation('Frm_AddNews')" enctype="multipart/form-data">
...
<input type="hidden" name="op" id="op" value="" />
		...
		<div align="center">
			...
			<input type="text" id="answer[Date]" size="26" name="answer[Date]" class="" forError="Date"/>	
		</div><br />
		
		<div align="center">
			<label id="req_answer[Name]">Name:</label>
			<input type="text" id="answer[Name]" size="26" name="answer[Name]" class="" forError="Name"/>	
		</div><br />
		
				
		<div align="center">
			<label id="req_answer[url]">url:</label>
			<input type="text" id="answer[url]" size="26" name="answer[url]" class="" forError="url"/>	
		</div><br />

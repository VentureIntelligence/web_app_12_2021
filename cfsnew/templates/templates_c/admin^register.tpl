<?php /* Smarty version 2.5.0, created on 2014-01-28 02:51:57
	...
	<div id="accountdetails">	
			<div id="formbg">						
				<div id="inputdesc">
					<div id="inputbgform">
						<div id="inputform">
							<div class="errormsg" style="padding:3px;"><?php echo $this->_tpl_vars['ExistError']; ?>
</div><div class="sucsmsg"><?php echo $this->_tpl_vars['SucsMsg']; ?>
</div>

...
<br>
		<div align="center">
			<label >Name</label>
			<input type="text" id="answer[UserName]" size="26" name="answer[UserName]" class="req_value" forError="UserName" value="<?php echo $this->_tpl_vars['AdminUser']['user_name']; ?>
">		
		</div><br />
		<div align="center">
			<label >First Name</label>
			<input type="text" id="answer[FirstName]" size="26" name="answer[FirstName]" class="req_value" forError="FirstName" value="<?php echo $this->_tpl_vars['AdminUser']['first_name']; ?>
">		
		</div><br />

		<div align="center">
			<label >Last Name</label>
			<input type="text" id="answer[LastName]" size="26" name="answer[LastName]" class="req_value" forError="LastName" value="<?php echo $this->_tpl_vars['AdminUser']['last_name']; ?>
"/>
		</div>
<br />
		<div align="center">
...
<div align="">
      ...
      <input type="checkbox" name="answer[is_enabled]" id="answer[is_enabled]" <?php if ($this->_tpl_vars['AdminUser']['is_enabled'] == 1): ?>checked<?php endif; ?> value="1" style="margin-left:42px; position: relative; top: 6px;" />
    </div>

<br /><br/>
<div align="">
      <label  >Login as admin</label>
      <input type="checkbox" name="answer[admin_api_access]" id="answer[admin_api_access]" <?php if ($this->_tpl_vars['AdminUser']['admin_api_access'] == 1): ?>checked<?php endif; ?> value="1" style="margin-left:42px; position: relative; top: 6px;" />
    </div>

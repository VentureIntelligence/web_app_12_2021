<?php /* Smarty version 2.5.0, created on 2014-01-27 08:37:10
         compiled from admin/rating.tpl */ ?>
<?php $this->_load_plugins(array(
array('function', 'html_options', 'admin/rating.tpl', 137, false),)); ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<div class="breadcrumb">
	...
	<div class="breadtext">&nbsp;</div>
		...
		<div class="adtitle" align="center">Add Rating</div>
...
<input type="hidden" name="op" id="op" value="" />
		...
		<br />
		<div align="center">
			<label id="req_answer[Url]">Title:</label>
			<input type="text" id="answer[Title]" size="26" name="answer[Title]" class="" forError="Url"/>	
		</div><br />
		<div align="center">

<?php /* Smarty version 2.5.0, created on 2020-09-10 12:20:01
         compiled from admin/fullapi_tracker.tpl */ ?>
...
'; ?>
	...
	var partnerapi = <?php echo $this->_tpl_vars['fullapitrackinglist']; ?>
;
...
fullapi-tracker.php">Clear Search</a></span>
                  <div style="clear: both;"></div>
               </div>
               <label style=" font: bold 13px &quot;Courier New&quot;, Courier, monospace;  margin: 10px 10px; color: #000;  position: absolute;">API URL https://api.ventureintelligence.asia/webapi/pe/</label>

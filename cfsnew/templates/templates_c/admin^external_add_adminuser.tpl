...
function myFunction() {
    ...
    if(inputString!=""){
 	jQuery.post("ajaxemailcfsmailcheck.php", {groupnamesuggest: ""+inputString+""}, function(data){
				if(data !="") {
                                        alert(data);
...
<input type="hidden" name="location_for_mail" value="FULL API - WEB ACCESS ONLY - CFS" />
		...
		<div id="slider">
			<ul>
                            <li>
                                ...
                                <div align="center">
                                       <label  >Name</label>	
                                        <input type="text" id="answer[UserName]" size="26" name="answer[UserName]" class="req_value"  forError="UserName" value="<?php echo $this->_tpl_vars['Request']['UserName']; ?>
" />
                                </div>                                 <br><br>
                                <div align="center">
...
" />
                                ...
                                <div align="center">
                                      <label >First Name</label>	
                                        <input type="text" id="answer[FirstName]" size="26" name="answer[FirstName]" class="req_value"  forError="FirstName"  value="<?php echo $this->_tpl_vars['Request']['FirstName']; ?>
" />
                                </div> <br><br>
                                <div align="center">
                                     <label >Last Name</label>	
				 <input type="text" id="answer[LastName]" size="26" name="answer[LastName]" class="req_value"  forError="LastName"  value="<?php echo $this->_tpl_vars['Request']['LastName']; ?>
" />
                                </div><br><br>
                                  <div align="center">
                                 ...
                                 <div align="center">
                                     <label >Enable Permission</label>	
                                         <input type="checkbox" name="answer[usr_flag]" id="answer[usr_flag]" class="usr_flag" value="4"  style="position: relative;left: -115px; top: 6px;"   />
                                </div> 
                                <br><br>
                                 <div align="center">
                                     <label >Login as Admin</label>	
                                         <input type="checkbox" name="answer[api_access]" id="answer[api_access]" class="api_access" value="1"  style="position: relative;left: -115px; top: 6px;"   />
                                </div> 
                               
		<input type="hidden" name="answer[external_api_access]" id="answer[external_api_access]" value="1"/>
         <input type="hidden" name="answer[emailcheck]" id="answer[emailcheck]"/>                     

<?php /* Smarty version 2.5.0, created on 2020-09-10 12:19:03
         compiled from admin/external_add_adminuser.tpl */ ?>
                                ...
                                <input type="hidden" name="answer[external_api_access]" id="answer[external_api_access]" value="1"/>
                                 <div align="center">
                                     <label >Enable Permission</label>	
                                        <input type="checkbox" name="answer[usr_flag]" id="answer[usr_flag]" class="usr_flag" <?php if ($this->_tpl_vars['Request']['usr_flag'] == 1): ?>checked<?php endif; ?> value="4"  style="position: relative;left: -115px; top: 6px;"   />
                                </div> 

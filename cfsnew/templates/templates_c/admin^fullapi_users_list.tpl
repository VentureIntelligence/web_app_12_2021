<?php /* Smarty version 2.5.0, created on 2020-09-10 12:19:56
         compiled from admin/fullapi_users_list.tpl */ ?>
...
;
	var fullapi_usersDetails = <?php echo $this->_tpl_vars['fullapi_list']; ?>
;
    console.log(fullapi_usersDetails);
 <?php echo ' 
$( document ).ready( function() {

   $(\'.req_cin\').keyup(function() {
				var searchfilter =$(\'.req_cin\').val();
				 var table = $(\'#fullapi_usersDetails\').DataTable();
				 var filtered = table.search(searchfilter).column().data().draw();
			  });

		table1 = $(\'#fullapi_usersDetails\').DataTable({
				"autoWidth": false,
				 data: fullapi_usersDetails,
				"ordering": true,
                "order": [],
         ...
         <form method="get" enctype="multipart/form-data">
            <div class="xbrlContainer">
               <div class="search_box">
                  ...
                  <a style="float:right;padding: 8px;font-size: 16px;" href="user-fullapi-create.php" >Create User</a>
               ...
               <table class="maintable" id="fullapi_usersDetails">
                  <thead>
                     <tr>
                        <th >Name</th>
                        <th>Company</th>

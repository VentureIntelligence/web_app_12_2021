<?php /* Smarty version 2.5.0, created on 2020-09-10 12:18:38
         compiled from admin/editGroup_API.tpl */ ?>
<?php $this->_load_plugins(array(
array('function', 'html_options', 'admin/editGroup_API.tpl', 345, false),)); ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<?php echo '"+op1+\'&expupdate=1\');
 ...
 <form  method="post" name="sortlist" id="sortlist" action="editGroup_API.php">    
...
<br />
	...
	<div align="center">
        ...
        <div class="row"  style="margin-left:100px;">
            <div id="suggest">
            <form action="editGroup_API.php" method="get" id="groupsearch">
...
<?php endif; ?>" onkeyup="suggest(this.value);" onblur="fill();" class=""  autocomplete=off   required>
                ...
                <?php if ($this->_tpl_vars['searchname']): ?> <input type="button" value="Show all" onclick="window.location.href='editGroup_API.php';"> <?php endif; ?>
...
;"> <span style="float:left;color:#000">Group Name</span> <img src="images/sort.gif"></th>
            ...
            <th>Expiry Date </th>
            <th>Api Access </th>
            <th style="width: 6%;">Mobile App Access </th>
            <th>Actions</th>
            <th>Status</th>
          </tr>
        </thead>

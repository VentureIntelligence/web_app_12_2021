<?php /* Smarty version 2.5.0, created on 2020-08-18 17:00:00
         compiled from admin/cfs_dashboard.tpl */ ?>
...
<link href="<?php echo $this->_tpl_vars['ADMIN_CSS_PATH']; ?>
jquery.multiselect_new.css" rel="stylesheet">
<script src="<?php echo $this->_tpl_vars['ADMIN_JS_PATH']; ?>
jquery-1.12.4.js"></script>
<script src="<?php echo $this->_tpl_vars['ADMIN_JS_PATH']; ?>
jquery-ui.js"></script>
<script src="<?php echo $this->_tpl_vars['ADMIN_JS_PATH']; ?>
jquery.multiselect_new.js"></script>
            ...
            <div style="width:100%;margin: 0px 0px 15px 0px;">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td id="xbrl_PEBacked"><?php echo $this->_tpl_vars['cfsdashboard']['xbrl_PEBacked_count']; ?>
</td>
                        <td id="xbrl_nonPEBacked"><?php echo $this->_tpl_vars['cfsdashboard']['xbrl_nonPEBacked_count']; ?>
</td>
                        <td id="xbrl_pebacked_nonpebacked_total"><?php echo $this->_tpl_vars['cfsdashboard']['xbrl_pebacked_nonpebacked_total']; ?>
</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 20px;">Non XBRL</td>
                        <td id="nonxbrl_PEBacked"><?php echo $this->_tpl_vars['cfsdashboard']['nonxbrl_PEBacked_count']; ?>
</td>
                        <td id="nonxbrl_nonPEBacked"><?php echo $this->_tpl_vars['cfsdashboard']['nonxbrl_nonPEBacked_count']; ?>
</td>
                        <td id="nonxbrl_pebacked_nonpebacked_total"><?php echo $this->_tpl_vars['cfsdashboard']['nonxbrl_pebacked_nonpebacked_total']; ?>
</td>
                    </tr>
                    <tr>
                        <td><b>Total</b></td>
                        <td id="xbrl_nonxbrl_pebacked_total"><?php echo $this->_tpl_vars['cfsdashboard']['xbrl_nonxbrl_pebacked_total']; ?>
</td>
                        <td id="xbrl_nonxbrl_nonpebacked_total"><?php echo $this->_tpl_vars['cfsdashboard']['xbrl_nonxbrl_nonpebacked_total']; ?>
</td>
                        <td id="total"><?php echo $this->_tpl_vars['cfsdashboard']['total']; ?>
</td>
                    </tr>
                    </tbody>
                </table>  
...
$this->_sections['List']['loop'] = is_array($this->_tpl_vars['industries1']) ? count($this->_tpl_vars['industries1']) : max(0, (int)$this->_tpl_vars['industries1']);
...
?>
                        <tr> <td>  <?php echo $this->_tpl_vars['industries1'][$this->_sections['List']['index']]['iname']; ?>
  
                        <span style="float:right"> <?php echo $this->_tpl_vars['industries1'][$this->_sections['List']['index']]['comcount']; ?>
 </span>
                        </td></tr>
                ...
                <div style="width:49%;float:right">
                    <table class="table">
                        ...
                        <tbody id="second">
                         <?php if (isset($this->_sections['List'])) unset($this->_sections['List']);
$this->_sections['List']['name'] = 'List';
$this->_sections['List']['loop'] = is_array($this->_tpl_vars['industries2']) ? count($this->_tpl_vars['industries2']) : max(0, (int)$this->_tpl_vars['industries2']);
$this->_sections['List']['show'] = true;
$this->_sections['List']['max'] = $this->_sections['List']['loop'];
$this->_sections['List']['step'] = 1;
$this->_sections['List']['start'] = $this->_sections['List']['step'] > 0 ? 0 : $this->_sections['List']['loop']-1;
...
$this->_sections['List']['last']       = ($this->_sections['List']['iteration'] == $this->_sections['List']['total']);
?>
                        <tr> <td>  <?php echo $this->_tpl_vars['industries2'][$this->_sections['List']['index']]['iname']; ?>
 
                        <span style="float:right"> <?php echo $this->_tpl_vars['industries2'][$this->_sections['List']['index']]['comcount']; ?>
 </span>

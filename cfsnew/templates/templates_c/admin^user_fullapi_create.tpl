<?php /* Smarty version 2.5.0, created on 2020-09-10 12:19:33
         compiled from admin/user_fullapi_create.tpl */ ?>
...
<div class="container">
   <div class="content" style="height: 385px;">
      <div>
...
index.php">Back to Home</a></span>
      ...
      <div class="select_log" align="center">
        <h3 class="p_title"> Select User Type </h3>
      </div>
      <div class="select_log" align="center">
        <!-- <p class="desc_content"> Sample Text Sample Text Sample Text Sample Text Sample Text Sample Text Sample Text Sample Text Sample Text  </p> -->
        <hr />
      </div>
      <div class="select_log" align="center">
        <div class="partners_type">
            <a href="#" class="internal_partners_btn" style="cursor: not-allowed;"> Internel Users <i class="fa fa-sign-in" aria-hidden="true"></i></a>
            <a href="create-fullapi-user.php?type=external_fullapi" class="external_partners_btn"> External Users <i class="fa fa-sign-in" aria-hidden="true"></i></a>
        </div>

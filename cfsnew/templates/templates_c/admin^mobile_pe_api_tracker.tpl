<?php /* Smarty version 2.5.0, created on 2020-02-25 13:01:21
         compiled from admin/mobile_pe_api_tracker.tpl */ ?>
...
;
	var customerTrack = <?php echo $this->_tpl_vars['customerTrackinglist']; ?>
;
...
mobile_api_tracker.php">Clear Search</a></span>
                  <div style="clear: both;"></div>
               </div>
               <label style=" font: bold 13px &quot;Courier New&quot;, Courier, monospace;  margin: 10px 10px; color: #000;  position: absolute;">https://api.ventureintelligence.com/mobileapi/pe </label>

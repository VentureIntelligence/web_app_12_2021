<?php /* Smarty version 2.5.0, created on 2020-06-04 05:32:36
...
index.htm">Home</a></li>
    <li><a href="<?php echo @constant('BASE_URL'); ?>
products.htm" class="active">Products</a></li>
    <li><a href="<?php echo @constant('BASE_URL'); ?>
events.htm">Events</a></li>
    <!--<li><a href="https://www.ventureintelligence.com/news.htm">News</a></li>-->
    <li><a href="<?php echo @constant('BASE_URL'); ?>
aboutus.htm">About Us</a></li>
    <li class="last"><a href="<?php echo @constant('BASE_URL'); ?>
contactus.htm">Contact Us</a></li>
</ul>
</div>
...
<ul>
    ...
    <li>
    <div class="keeplogin"><input type="checkbox" name="chkTerm" CHECKED /> By accessing this database, you agree to the  <a href="<?php echo @constant('BASE_URL'); ?>
terms.htm">terms & conditions</a> of use upon which access is provided.</div>
    </li>
    ...
    <?php if (( $this->_tpl_vars['displayMessage'] || $this->_tpl_vars['displayMessage2'] )): ?><li><font color="red"><?php if ($this->_tpl_vars['displayMessage']): ?><?php echo $this->_tpl_vars['displayMessage']; ?>
<?php endif; ?></font> <?php if ($this->_tpl_vars['displayMessage2']): ?><?php echo $this->_tpl_vars['displayMessage2']; ?>
<?php endif; ?> </li><?php endif; ?> 
    <?php if (( $this->_tpl_vars['ErrMsg'] || $this->_tpl_vars['ErrMsg2'] )): ?><li><font color="red"><?php if ($this->_tpl_vars['ErrMsg']): ?><?php echo $this->_tpl_vars['ErrMsg']; ?>
<?php endif; ?></font> <?php if ($this->_tpl_vars['ErrMsg2']): ?><?php echo $this->_tpl_vars['ErrMsg2']; ?>
<?php endif; ?> </li><?php endif; ?> 
    <?php if ($this->_tpl_vars['auth'] == 1): ?><li><font color="green"><?php if ($this->_tpl_vars['auth'] == 1): ?>Authorization successful. Please login now<?php endif; ?></font></li><?php endif; ?> 
</ul>
</form>
...
<div class="free-trail"><span>Request a demo</span> <a href="<?php echo @constant('BASE_URL'); ?>
trial.htm">Click Here</a></div>
  ...
  <div class="popup_content" id="popup_content">
      ...
      <?php 
           ...
           // print_r($deviceDetail_versions);
            ...
            foreach($device_array as $da) { 
                $device_array_item_selected = explode("_", $da['device_details']);
                ...
                if ($da['device_details'] == @$targer_device_compare) {	 
                    ...
                    echo "<p style='width:100%; float:left;'> <b class='recommended'>Recommended</b>   &nbsp; <input type='radio' name='dauth' value=".$da['id'].' id="dauth'.$count.'" class="popup-label" >
                            <label class="popup-label-text" for="dauth'.$count.'">  '. $device_selected.'</label></p>';
                } else {
         ...
         ?>
      <input type="hidden" name="device_details" value="<?php if ($this->_tpl_vars['device_details']): ?><?php echo $this->_tpl_vars['device_details']; ?>
<?php endif; ?>" >
      <input type="hidden" name="user_email" value="<?php if ($this->_tpl_vars['emailid']): ?><?php echo $this->_tpl_vars['emailid']; ?>
<?php endif; ?>" >
        <input type="hidden" name="user_password" value="<?php if ($this->_tpl_vars['emailpassword']): ?><?php echo $this->_tpl_vars['emailpassword']; ?>
<?php endif; ?>" >

<?php /* Smarty version 2.5.0, created on 2019-09-20 06:23:33
...
<form name="Frm_EditUser" id="Frm_EditUser" action="add_adminuser.php" method="post" onSubmit="return Validation('Frm_EditUser')" enctype="multipart/form-data">
	...
	<div id="slidecontent">
		...
		<div id="slider">
			<ul>
                            <li>
                                <div class="adminbox">
                                <div class="adtitle" align="center">Add Admin User</div>    

<?php /* Smarty version 2.5.0, created on 2013-11-20 01:49:03
         compiled from detaildup.tpl */ ?>
<?php $this->_load_plugins(array(
array('modifier', 'count', 'detaildup.tpl', 161, false),
array('modifier', 'number_format', 'detaildup.tpl', 210, false),
array('function', 'math', 'detaildup.tpl', 601, false),)); ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
" class="active"><i></i> DETAIL VIEW</a></li>
</ul>
</div>
...
?> 
   ...
   <tr>
       ...
       <?php if ($this->_tpl_vars['CompanyProfile']['Website'] != ""): ?>
            <td> website
            <span><?php echo $this->_tpl_vars['CompanyProfile']['Website']; ?>
</span></td> 
       <?php endif; ?>
    </tr>  
...
.xls">Click Here</a></div-->
		...
		<?php if ($this->_tpl_vars['BSHEET_MEDIA_PATH']): ?>	
                    <div class="btn-cnt p10">
                    <form> <input  name="" type="button" value="BALANCESHEET EXPORT" onClick="window.location.href='<?php echo $this->_tpl_vars['MEDIA_PATH']; ?>

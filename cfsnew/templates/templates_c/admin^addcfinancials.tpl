<?php /* Smarty version 2.5.0, created on 2019-07-01 14:02:26
         compiled from admin/addcfinancials.tpl */ ?>
...
<div class="breadcrumb">
  ...
  <?php if ($this->_tpl_vars['updated']): ?> <h3 style="text-align: center;color: red;margin-bottom: 4%;"> <?php echo $this->_tpl_vars['updated']; ?>
 </h3><?php endif; ?>
...
<?php if ($this->_tpl_vars['Usr_Type'] != 2): ?><div class="PLDFlip">Click to Upload P&L Detail:</div><?php endif; ?>
<div class="PLDPanel">
...
<?php if ($this->_tpl_vars['Usr_Type'] != 2): ?><div class="CFFlip">Click to Upload Cashflow - Old :</div><?php endif; ?>
<div class="CFPanel">
...
<?php if ($this->_tpl_vars['Usr_Type'] != 2): ?><div class="CFFlip1">Click to Upload Cashflow:</div><?php endif; ?>
<div class="CFPanel1">

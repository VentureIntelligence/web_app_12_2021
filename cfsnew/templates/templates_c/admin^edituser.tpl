<?php /* Smarty version 2.5.0, created on 2019-01-24 07:57:06
         compiled from admin/edituser.tpl */ ?>
<?php $this->_load_plugins(array(
array('function', 'html_options', 'admin/edituser.tpl', 327, false),)); ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<div id="slidecontainer">
	...
	<div id="slidecontent">
		...
		<div align="center">
			...
			<input type="text" id="FirstName" size="26" name="answer[FirstName]" class="" forError="FirstName" value="<?php echo $this->_tpl_vars['User']['firstname']; ?>
">		
		</div><br />

		<div align="center">
			<label id="req_answer[LastName]">Last Name:</label>
			<input type="text" id="answer[LastName]" size="26" name="answer[LastName]" class="" forError="LastName" value="<?php echo $this->_tpl_vars['User']['lastname']; ?>
"/>
		</div>
<br />
		<div align="center">
			<label id="req_answer[Email]">Email:</label>
			  <input type="email" id="answer[Email]" size="26" name="answer[Email]" class="" forError="Email" value="<?php echo $this->_tpl_vars['User']['email']; ?>
"/>
		</div>
<br />
		<div align="center">
		...
		<div align="center">
			<label id="req_answer[Group]">Group:</label>
			  <select type="text" id="answer[Group]"  name="answer[Group]" class="" forError="Group" value="" style="margin-left:-10px;"/>
					<?php echo $this->_plugins['function']['html_options'][0](array('options' => $this->_tpl_vars['grouplist'],'selected' => $this->_tpl_vars['User']['GroupList']), $this) ; ?>
...
<br />
		<div align="center">
			<label id="req_answer[expiry]">Expiry Date Limit:</label>
			  <input type="text" size="26" forerror="expiry" class="" name="answer[expiry]" id="answer[expiry]" value="<?php echo $this->_tpl_vars['User']['expire']; ?>
">
		</div> 
-->
...
<br />
			...
			<label id="req_answer[devCnt]">Devices Allowed:</label>
                        <input type="text" id="devCnt" name="devCnt"  forError="devCnt" value="<?php echo $this->_tpl_vars['User']['deviceCount']; ?>
"><br>
		</div>														
<br />
              <div align="center">
			<label id="req_answer[expLmt]">Export Limit:</label>
                        <input type="text" id="expLmt" name="expLmt" forError="expLmt" value="<?php echo $this->_tpl_vars['User']['exportLimit']; ?>
"><br>
		</div>														
<br /> 
		<div align="">
			<label id="req_answer[send_mail]">Send mail to customer:</label>
			  <input type="checkbox" name="answer[sendmail_cust]" id="answer[sendmail_cust]" class="send_mail" <?php if ($this->_tpl_vars['User']['sendmail_cust'] == 1): ?>checked<?php endif; ?> value="1"  style="position: relative; left: 50px; top: 6px;"   /> 
		</div>
		<br />
		<br />
		<div align="center">

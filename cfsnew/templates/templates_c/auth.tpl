<?php /* Smarty version 2.5.0, created on 2019-04-08 12:19:19
...
<form name="pelogin" onSubmit="return checkFields();" method="post" action="" >
    ...
    <ul style="width:300px">
        ...
        <li><label>Email</label> <input type=text name="emailid" value="<?php echo $this->_tpl_vars['emailid']; ?>
" style="padding: 5px;"/></li>
        <li><label>Authorization Code</label> <input type=password name="authCode" value="<?php echo $this->_tpl_vars['authCode']; ?>
" style="padding: 5px;"/></li>
         <input type="hidden" value="<?php echo $this->_tpl_vars['device']; ?>
" name="autdevice" ></input>
        ...
        <li><font color="red"><?php echo $this->_tpl_vars['displayMessage']; ?>
</font></li>
        <li><font color="green"><?php echo $this->_tpl_vars['successMessage']; ?>
</font></li>
   </ul>

<?php /* Smarty version 2.5.0, created on 2014-01-27 08:37:02
         compiled from admin/othercomparables.tpl */ ?>
<?php $this->_load_plugins(array(
array('function', 'html_options', 'admin/othercomparables.tpl', 137, false),)); ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<div class="breadcrumb">
	...
	<div class="breadtext">&nbsp;</div>
		...
		<div class="adtitle" align="center">Add Other Comparables</div>


<form name="Frm_AddCompetitors" id="Frm_AddCompetitors" action="" method="post" onSubmit="return AddCompetitorsValidation('Frm_AddCompetitors')" enctype="multipart/form-data">

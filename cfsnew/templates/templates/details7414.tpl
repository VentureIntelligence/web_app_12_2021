...
<div style="overflow: hidden;">
 <div class="btn-cnt p10" style="float:right;">
    {if $PLSTANDARD_MEDIA_PATH}
           ...
           <input  name="" type="button" value="Standard P&L EXPORT" onClick="window.location.href='downloadtrack.php?vcid={$Company_Id}'" />
    ...
    {if $PLDETAILED_MEDIA_PATH}
        ...
        <input  name="" type="button" value="Detailed P&L EXPORT" onClick="window.location.href='{$MEDIA_PATH}pldetailed/PLDetailed_{$VCID}.xls'" />
    ...
    {if $BSHEET_MEDIA_PATH}	
       ...
       <input  name="" type="button" value="BALANCESHEET EXPORT" onClick="window.location.href='{$MEDIA_PATH}balancesheet/BalSheet_{$VCID}.xls'" />
    {/if}
    {if $CASHFLOW_MEDIA_PATH}

            <input  name="" type="button" value="CASHFLOW EXPORT" onClick="window.location.href='{$MEDIA_PATH}cashflow/Cashflow_{$VCID}.xls'" />

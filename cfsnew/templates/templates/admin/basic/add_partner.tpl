...
$(document).ready(function(e){
   ...
   // }
     ...
     if(partner_type_control == "CFS"){
         $("#title_id").html("Create Basic API Partner");
        document.title = 'Create Sub API Partner';
        $("#partner-internal").hide();
        $("#partner_type option[value='external_partner']").attr("selected","selected");
        $("#partner_info").val("CFS");
         ...
         <div id="slidecontent">
            <div id="slider">
               <ul>
                  <li>
                     <div class="adminbox">
                        <div align="center"> <a href="partner-api-create.php" style="float: right;">Back to Create Partner</a> </div><br />

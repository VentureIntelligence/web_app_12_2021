         ...
         <div id="slidecontent">
            <div id="slider">
               <ul>
                  <li>
                     <div class="adminbox">
                        <div align="center"> <a href="basic/partners-list.php" style="float: right;">Back to Partners</a> </div>
    ...
    $("#update_internal_partner").on('submit', function(e){
        ...
        $.ajax({
            ...
            success: function(response){
				...
				if(response == "1"){
                  alert('Update Basic Partner Details Successfully');
                  window.location = 'basic/partners-list.php';
               }else if(response == "0"){

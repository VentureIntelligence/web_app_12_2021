               ...
               <ul>
                  <li>
                     <div class="adminbox">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                               <label for="partner_search_limit">Search Count</label>
                            </div>
                            <div class="col-md-6" style="width: 65%;">
                                <input type="number" class="form-control" placeholder="Enter Search Count Limit" name="partner_search_limit" autocomplete="off"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                               <label for="partner_api_limit">API Count</label>
                            </div>
                            <div class="col-md-6" style="width: 65%;">

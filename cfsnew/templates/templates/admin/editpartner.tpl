         ...
         <div id="slidecontent">
            <div id="slider">
               <ul>
                  <li>
                     <div class="adminbox">
                        <div align="center"> <a href="partner/partners-list.php" style="float: right;">Back to Partners</a> </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" style="width: 53%;">
                              ...
                              <input type="number" class="total_search_count" id="partner_search_count" name="partner_search_count" value="{$partner_details.serachCount}" placeholder="Enter Search Count"/>		
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6" style="width: 53%;">
                              ...
                              <input type="number" class="total_search_count" id="partner_api_count" name="partner_api_count" value="{$partner_details.apiCount}" placeholder="Enter API Count"/>		
                            </div>
                        </div>
...
$(function() {
  $("form[name='update_form']").validate({
        ...
        $.ajax({
            ...
            success: function(response){
				...
				if(response == "1"){
                  ...
                  window.location = 'partner/partners-list.php';
               }else if(response == "0"){
   ...
   var TokenID = $("#partner_token").val();
    ...
    $.ajax({ 
        type: 'POST',
        url: "partner/partner_api_count_details.php",
        data: {"token": TokenID},
        success: function(response){
            if(response !=''){

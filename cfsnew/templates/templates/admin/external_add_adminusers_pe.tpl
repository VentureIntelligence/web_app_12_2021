                            ...
                            <li>
                                ...
                                <div align="center">
                                       <label  >User Name</label>	
                                        <input type="text" id="answer[UserName]" size="26" name="answer[UserName]" class="req_value"  forError="UserName" value="{$Request.user_name}" />
                                </div>                                 <br><br>
                                <div align="center">
					...
					<input type="password" id="password_again" size="26" name="password_again" class="req_password_again" forError="req_password_again" disabled="disabled" />
                                ...
                                <div align="center">
                                      <label >First Name</label>	
                                        <input type="text" id="answer[FirstName]" size="26" name="answer[FirstName]" class="req_value"  forError="FirstName"  value="{$Request.first_name}" />
                                </div> <br><br>
                                <div align="center">
                                     <label >Last Name</label>	
				 <input type="text" id="answer[LastName]" size="26" name="answer[LastName]" class="req_value"  forError="LastName"  value="{$Request.last_name}" />
                                </div><br><br>
                                  {* <div align="center">
                                ...
                                *}
                                <br><br>
                                 ...
                                 <div align="center">
                                     <label >API Access</label>	
                                         <input type="checkbox" name="answer[external_api_access]" id="answer[external_api_access]" class="external_api_access" value="<?php echo $this->_tpl_vars['Request']['external_api_access']; ?>"  style="position: relative;left: -115px; top: 6px;"   />
                                </div> 

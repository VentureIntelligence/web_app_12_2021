	...
	<div align="center">
        ...
        <div class="row"  style="margin-left:100px;">
            ...
            <form action="editGroup-api-pe.php" method="get" id="groupsearch">
                ...
                {if $searchname} <input type="button" value="Show all" onclick="window.location.href='editGroup-api-pe.php';"> {/if}
        ...
        <tbody>
          {section name=List loop=$GroupList1}
            <tr>
                ...
                <td>{$GroupList1[List].DCompanyName}</td> 
                ...
                <td width="3%" align="center"><a href="editadmingroup-api-pe.php?auid={$GroupList1[List].DCompId}"><img src="images/edit.png" width="16" height="16" title="Click to Edit" alt="Click to Edit" style="cursor:pointer;" /></a></td>

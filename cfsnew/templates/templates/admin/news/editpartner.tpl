         ...
         <div id="slidecontent">
            <div id="slider">
               <ul>
                  <li>
                     <div class="adminbox">
                        <div align="center"> <a href="news/partners-list.php" style="float: right;">Back to Partners</a> </div>
    ...
    $("#update_internal_partner").on('submit', function(e){
        ...
        $.ajax({
            ...
            success: function(response){
				...
				if(response == "1"){
                  alert('Update News Partner Details Successfully');
                  window.location = 'news/partners-list.php';
               }else if(response == "0"){

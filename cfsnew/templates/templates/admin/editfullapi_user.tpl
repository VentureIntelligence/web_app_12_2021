                  ...
                  <li>
                     <div class="adminbox">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="fullapi_name" name="fullapi_name" value="{$fullapi_details.userName}" placeholder="Enter Name"/>		
                              <input type="hidden" class="fullapi_id" name="fullapi_id" value="{$fullapi_details.fullapi_user_id}" />
                              <input type="hidden" id="user_id" class="user_id" name="user_id" value="{$fullapi_details.user_id}" />
                              <input type="hidden" id="fullapi_search_count" name="fullapi_search_count" value="{$fullapi_details.serachCount}"/>		
                              <input type="hidden" id="fullapi_api_count" name="fullapi_api_count" value="{$fullapi_details.apiCount}"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                              <input type="text" id="fullapi_company" name="fullapi_company" value="{$fullapi_details.user_company}" placeholder="Enter Company Name"/>		
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                              <select class="form-control" id="fullapi_type" name="fullapi_type" style="width: 260px;">
                                 <option id="type_internal" value="internal_user" {if $fullapi_details.userType == "internal_user"} selected="selected"{/if}>Internal User</option>
                                 <option id="type_external" value="external_user" {if $fullapi_details.userType == "external_user"} selected="selected"{/if}>External User</option>
                              </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" style="width: 60%;">
                              ...
                              <div class="input-group startdatepicker date">
                                 <input class="form-control" type="text" id="sdate" name="fullapi_validate_from" value="{$fullapi_details.validityFrom}" placeholder="DD/MM/YYYY" readonly />
                                 <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                              </div>
                              {* <input type="datetime" id="datetimepicker_from" name="fullapi_validate_from" value="{$fullapi_details.validityFrom}" placeholder="Validate From"/>		
                              <br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" style="width: 60%;">
                              {* <input type="datetime" id="datetimepicker_to" name="fullapi_validate_to" value="{$fullapi_details.validityTo}" placeholder="Validate To"/> *}
                              <div class="input-group expiredatepicker date">
                                 <input class="form-control" type="text" id="edate" name="fullapi_validate_to" value="{$fullapi_details.validityTo}" placeholder="DD/MM/YYYY" />
                                 <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                              </div>
                            </div>
                        </div>
                        <div class="row" style="display:none;">
                            ...
                            <div class="col-md-6" style="width: 53%;">
                              ...
                              <input type="number" class="total_search_count" id="fullapi_search_count1" name="fullapi_search_count1" value="{$fullapi_details.serachCount}" placeholder="Enter Search Count"/>		
                            </div>
                        </div>
                        <div class="row" style="display:none;">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6" style="width: 53%;">
                              ...
                              <input type="number" class="total_search_count" id="fullapi_api_count1" name="fullapi_api_count1" value="{$fullapi_details.apiCount}" placeholder="Enter API Count"/>		
                            </div>
                        </div>
                        <div class="row r_email">
                           <div align="center" id="partner-external" class="partner-external">
                              ...
                              <div class="col-md-6">
                                 <input type="text" id="fullapi_email" name="fullapi_email" placeholder="Enter Email" value="{$external_details.username}" placeholder="Enter E-Mail" autocomplete="off"/>		
                              </div>
                           </div>
                           </div>
                           ...
                           <div class="row r_pass">
                              <div align="center" id="partner-external" class="partner-external">
                                 ...
                                 <div class="col-md-6">
                                    <input type="text" id="fullapi_ip" name="fullapi_ip" value="{$external_details.ipAddress}" placeholder="Enter IP Address" />		
                            ...
                            <div class="col-md-6" style="width: 53%;">
                              <input type="text" id="fullapi_token" name="fullapi_token" style="width: 199px;" readonly value="{$fullapi_details.userToken}" />		
                        ...
                        <div class="row r_pass">
                           <div align="center">
                              ...
                              <div class="col-md-6">
                                 <input type="checkbox" id="fullapi_isadmin" name="fullapi_isadmin" {if $external_details.isadmin == "1"} checked="checked"{/if} style="margin-right: 240px;"/>		
                              </div>
                           </div>
                           </div>
                           <div class="row">
                           <div align="center">
                              ...
                              <div class="col-md-6">
                                 <input type="checkbox" id="fullapi_status" name="fullapi_status" {if $fullapi_details.user_status == "1"} checked="checked"{/if} style="margin-right: 240px;"/>		
                              </div>
                           </div>
                           </div>

                  ...
                  <li>
                     <div class="adminbox">
                        ...
                        <div align="center">
                           ...
                           <input type="text" id="partner_name" name="partner_name" value="{$fullapi_details.userName}" required readonly/>		
						         <input type="hidden" class="partner_id" name="partner_id" value="{$fullapi_details.fullapi_user_id}" />
						         <input type="hidden" id="user_id" class="user_id" name="user_id" value="{$fullapi_details.user_id}" />
                        </div>
                        <br />
						<div align="center">
                           <label id="req_answer">Company</label>
                           <input type="text" id="partner_company" name="partner_company" value="{$fullapi_details.user_company}" required readonly/>		
                        </div>
                        <br />
						<div align="center">
                           <label id="req_answer">Type</label>
                           {* <input type="text" id="partner_type" name="partner_type" value="{$fullapi_details.partnerType}" required/> *}
						...
						<div align="center">
                           ...
                           <input type="text" id="user_token" name="user_token" style="width: 207px;"  required value="{$fullapi_details.userToken}" readonly/>		
                           <button onclick="myToken()" type="button" id="copied" style="padding:8px;">Copy</button>
                        </div>
                        <br />
						<div align="center">
                           <label id="req_answer">Validate From</label>
                           <input type="text" name="partner_validate_from" value="{$fullapi_details.validityFrom}" required readonly/>		
                        </div>
                        <br />
						<div align="center">
                           <label id="req_answer">Validate To</label>
                           <input type="text" name="partner_validate_to" value="{$fullapi_details.validityTo}" required readonly/>		
                        </div>
                        <br />
						<div align="center" style="display:none;">
                           <label id="req_answer">Search Count</label>
                           <input type="number" id="partner_search_count" name="partner_search_count" value="{$fullapi_details.serachCount}" required readonly/>		
                        </div>
                        {* <br /> *}
						<div align="center" style="display:none;">
                           <label id="req_answer">API Count</label>
                           <input type="number" id="partner_api_count" name="partner_api_count" value="{$fullapi_details.apiCount}" required readonly/>		
                        </div>
                        {* <br /> *}
                        {if $fullapi_details.userType == "external_user"}
                        <div align="center">
                        ...
                        <div align="center">
                           ...
                           <input type="text" value="{$external_details.ipAddress}" required readonly/>		
                        </div>
                        <br />
                        {/if}
                        {if $fullapi_details.userType == "external_user"}
                        <div align="center">
                           ...
                           <input type="text" value="{if $fullapi_details.isadmin == "1"} Yes {else} No {/if}" required readonly/>		
                        </div>
                        <br />
                        {/if}
                        ...
                        <div align="center">
                           ...
                           <input type="text" value="{if $fullapi_details.user_status == "1"} Active {else} Inactive {/if}" required readonly/>		
                        </div>
                        <br />
                        <br />
                     </div>

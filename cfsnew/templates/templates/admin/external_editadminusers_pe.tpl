...
<div id="slidecontainer">
	...
	<div id="slidecontent">
		...
		<div class="adtitle" align="center">Edit PE External API User</div>
		<div align="center">
			<label id="req_answer[FirstName]">First Name:</label>
			<input type="text" id="answer[FirstName]" size="26" name="answer[FirstName]" class="req_value" forError="FirstName" value="{$AdminUser.first_name}">		
		</div><br />

		<div align="center">
			<label id="req_answer[LastName]">Last Name:</label>
			<input type="text" id="answer[LastName]" size="26" name="answer[LastName]" class="req_value" forError="LastName" value="{$AdminUser.last_name}"/>
		</div>
<br />
		<div align="center">

                  ...
                  <li>
                     <div class="adminbox">
						...
						<div align="center">
                           ...
                           <input type="number" id="partner_search_count" name="partner_search_count" value="{$partner_details.serachCount}" required readonly/>		
                        </div>
                        <br />
						<div align="center">
                           <label id="req_answer">API Count</label>
                           <input type="number" id="partner_api_count" name="partner_api_count" value="{$partner_details.apiCount}" required readonly/>		
                        </div>
                        <br />

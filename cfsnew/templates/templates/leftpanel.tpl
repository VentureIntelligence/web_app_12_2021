...
<label> <input type="checkbox" name="answer[Permissions2]" id="answer[Permissions2]" value="1" {if $REQUEST_Answer.Permissions eq 1 or $REQUEST_Answer.Permissions2 eq 1 or count($REQUEST_Answer) eq 0} checked {/if}/> Non-PE Backed</label>
</li>
<li>

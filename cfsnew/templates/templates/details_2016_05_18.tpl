...
<div>
 <div class="btn-cnt p10" style="float:right;">
    ...
    {/if}
    {if $BSHEET_MEDIA_PATH || $BSHEET_MEDIA_PATH_NEW}	
       ...
       {if $BSHEET_MEDIA_PATH_NEW}<input  name="" type="button" value="New Template" onClick="window.open('{$MEDIA_PATH}balancesheet_new/New_BalSheet_{$VCID}.xls','_blank')" style="  width: 93%;border-top: 0;" />{/if}
       {if $BSHEET_MEDIA_PATH }<input  name="" type="button" value="Old Template" onClick="window.open('{$MEDIA_PATH}balancesheet/BalSheet_{$VCID}.xls','_blank')" style="  width: 93%;border-top: 0;" />{/if}
       </div>
       </span>

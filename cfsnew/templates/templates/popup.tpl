...
<div id="testpopup" style=""></div>
 <div class="lb" id="popup-box-copyrights1" >
...
{literal}
  <script type="text/javascript">
		...
		if (isMobile) {
            ...
            document.getElementById("popup-box-copyrights1").style.display = "block";
		} else {
            document.getElementById("testpopup").style.display = "none";
            document.getElementById("popup-box-copyrights1").style.display = "none";
		}
	</script>
{/literal}

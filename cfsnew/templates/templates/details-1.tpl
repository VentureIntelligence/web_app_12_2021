    ...
    <div id="chargesRegistered"  class="work-masonry-thumb col-4 tab_menu empty-container">
     ...
     <div class="master-data-header" style="">
        <ul class="primary">
            ...
            <li class="active" style="padding-left:0px;"> <a href="javascript:;"  data-head="bod" data-head="bod">Board of Directors</a>  </li>
        </ul>
...
<div class="lb" id="plexport-popup" style="width: 650px; overflow: visible; left: 50%; top: 50%; transform: translate(-50%, -50%);">
  ...
  <div class="lookup-body" style="margin-bottom: 5px; padding: 15px;">
      ...
      <b><a href="javascript:;" onClick="window.open('downloadtrack.php?vcid={$Company_Id}','_blank')" class="agree-plexport">I Agree</a></b><!-- <b><a href="javascript:;" class="close-lookup">Cancel</a></b> --> 
  </div>
</div>
<div id="maskscreen"></div>
<div class="lb" id="plconexport-popup" style="width: 650px; overflow: visible; left: 50%; top: 50%; transform: translate(-50%, -50%);">
  ...
  <div class="lookup-body" style="margin-bottom: 5px; padding: 15px;">
      &copy; TSJ Media Pvt. Ltd. This data is meant for the internal and non-commercial use of the purchaser and cannot be resold, rented, licensed or otherwise transmitted without the prior permission of TSJ Media. Any unauthorized redistribution will constitute a violation of copyright law.<br/><br/>
      <b><a href="javascript:;" onClick="window.open('downloadtrack.php?vcid={$Company_Id}&type=consolidated','_blank')" class="agree-plconexport">I Agree</a></b><!-- <b><a href="javascript:;" class="close-lookup">Cancel</a></b> --> 
  </div>
</div>
<div id="maskscreen"></div>
<div class="lb" id="bsexport-popup" style="width: 650px; overflow: visible; left: 50%; top: 50%; transform: translate(-50%, -50%);">
  ...
  <div class="lookup-body" style="margin-bottom: 5px; padding: 15px;">
      &copy; TSJ Media Pvt. Ltd. This data is meant for the internal and non-commercial use of the purchaser and cannot be resold, rented, licensed or otherwise transmitted without the prior permission of TSJ Media. Any unauthorized redistribution will constitute a violation of copyright law.<br/><br/>
      <b><a href="javascript:;" onClick="window.open('{$MEDIA_PATH}balancesheet_new/New_BalSheet_{$VCID}.xls','_blank')" class="agree-bsexport">I Agree</a></b><!-- <b><a href="javascript:;" class="close-lookup">Cancel</a></b> --> 
  </div>
</div>
<div id="maskscreen"></div>
<div class="lb" id="bsconexport-popup" style="width: 650px; overflow: visible; left: 50%; top: 50%; transform: translate(-50%, -50%);">
  ...
  <div class="lookup-body" style="margin-bottom: 5px; padding: 15px;">
      &copy; TSJ Media Pvt. Ltd. This data is meant for the internal and non-commercial use of the purchaser and cannot be resold, rented, licensed or otherwise transmitted without the prior permission of TSJ Media. Any unauthorized redistribution will constitute a violation of copyright law.<br/><br/>
      <b><a href="javascript:;" onClick="window.open('{$MEDIA_PATH}balancesheet_new/New_BalSheet_{$VCID}_1.xls','_blank')" class="agree-bsconexport">I Agree</a></b><!-- <b><a href="javascript:;" class="close-lookup">Cancel</a></b> --> 
  </div>
</div>
<div class="lb" id="popup-box-deals">
    <div class="title">Send this to Venture</div>
        <form>
            ...
            <div class="entry">
                    <h5>Link</h5>
                    <p>www.ventureintelligence.com/cfsnew/details.php?vcid={$VCID}  <input type="hidden" name="message_fc" id="message_fc" value="https://www.ventureintelligence.com/cfsnew/details.php?vcid={$VCID}"  />   
...
<div class="lb" id="popup-box-FY-data">
    <div class="title">Send this to Venture</div>
        <form>
            <div class="entry">
                <label> To*</label>
                <p>cfs@ventureintelligence.in</p>
                <input type="hidden" name="toaddress_fc" id="toaddress_fc"  value="cfs@ventureintelligence.in"/>
            </div>
            <div class="entry">
                <h5>Subject*</h5>
...
<div class="model">
    <div class="lb" id="mail-boxDetail">
        <div class="title">Send Mail to Customer</div>
            ...
            <div class="entry entry-pad">
                <label> From</label>
                    <input type="text" name="smc_fromaddress" id="smc_fromaddress" value="cfs@ventureintelligence.com"  />
            </div>
            <div class="entry entry-pad">
                <label> To</label>

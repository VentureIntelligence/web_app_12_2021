...
var methods = {
    ...
    addOnly: function(item) {
        this.data("tokenInputObject").addOnly(item);
        return this;
    },
...
$.TokenList = function (input, url_or_data, settings) {
    ...
    var input_box = $("<input type=\"text\" tabindex=\"1\" autocomplete=\"off\">")
        .css({
            outline: "none"
        })
    ...
    function add_token (item) {
        ...
        if($.isFunction(callback)) {
            ...
            callback.call(hidden_input,item,hidden_input);
        }
    }

    // Add a token to the token list based on user input
    function add_tokenOnly (item) {
    ...
    function delete_token (token) {
        ...
        if($.isFunction(callback)) {
            callback.call(hidden_input,token_data,hidden_input);
        }
    }

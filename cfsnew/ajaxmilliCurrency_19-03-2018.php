...
<div class="cfs_menu">
    <ul>
        ...
        <li data-row="companyProfile" href="javascript:;" class="subMenu">COMPANY PROFILE</li>
        <li data-row="filings" href="javascript:;" class="subMenu">FILINGS</li>
        <li data-row="signatories_result" href="javascript:;" class="subMenu">BOARD OF DIRECTORS</li>
        <li data-row="rating-info" href="javascript:;" class="subMenu">COMPANY RATING</li>
        <li data-row="chargesRegistered" href="javascript:;" class="subMenu">INDEX OF CHARGES</li>
        <li data-row="similar-company" href="javascript:;" class="subMenu">SIMILAR COMPANIES</li>
    </ul>
</div>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            ?>
              ...
              <tr>
                ...
                <?php for($i=0;$i<count($FinanceAnnual);$i++){  
                if($_GET['queryString']!='INR'){?>
                    <td><?php if($FinanceAnnual[$i][Priod_period]==0){echo '&nbsp';}else{ $vale = currency_convert($FinanceAnnual[$i][Priod_period],'INR',$_GET['queryString']);$tot=$vale/$convalue;echo round($tot,2);  if($vale==''){echo '&nbsp';}} ?></td>
               <?php
                }
                else
                {
                    ?>    
                      <td><?php if($FinanceAnnual[$i][Priod_period]==0){echo '&nbsp';}else{ $tot= ($FinanceAnnual[$i][Priod_period]/$convalue);echo round($tot,2); } ?></td>
             <?php
                }
            }
            ?>
            ...
            ?>
              ...
              <tr>
                 ...
                 <?php for($i=0;$i<count($FinanceAnnual);$i++){ 
                if($_GET['queryString']!='INR'){?>
                    <td><?php if($FinanceAnnual[$i][BINR]==0){echo '&nbsp';}else{$vale = currency_convert($FinanceAnnual[$i][BINR],'INR',$_GET['queryString']); $tot=$vale/$convalue;echo number_format($tot, 2, '.', ','); if($vale==''){echo '&nbsp';}} ?></td>
             <?php
                }
                else
                {
                    ?>     
                     <td><?php if($FinanceAnnual[$i][BINR]==0){echo '&nbsp';}else{ $tot= ($FinanceAnnual[$i][BINR]);echo number_format($tot, 2, '.', ','); } ?></td>
             <?php
                }
            }
            ?>
              ...
              <tr>
                ...
                <?php for($i=0;$i<count($FinanceAnnual);$i++){ 
                if($_GET['queryString']!='INR'){?>
                    <td><?php if($FinanceAnnual[$i][DINR]==0){echo '&nbsp';}else{$vale = currency_convert($FinanceAnnual[$i][DINR],'INR',$_GET['queryString']);$tot=$vale/$convalue;echo number_format($tot, 2, '.', ',');  if($vale==''){echo '&nbsp';}} ?></td>
               <?php
                }
                else
                {
                    ?>   
                     <td><?php if($FinanceAnnual[$i][DINR]==0){echo '&nbsp';}else{ $tot= ($FinanceAnnual[$i][DINR]);echo number_format($tot, 2, '.', ','); } ?></td>
             <?php
                }
            }
            ?>
           ...
           /*     $frnExgEarnCont = '';
            ...
            if($frnExgEarnin!='')
            {
              ...
              <tr>
               ...
               for($i=0;$i<count($FinanceAnnual);$i++){ 
                if($_GET['queryString']!='INR'){?>
                    <td><?php if($FinanceAnnual[$i][EarninginForeignExchange]==0){echo '&nbsp';}else{ $vale = currency_convert($FinanceAnnual[$i][EarninginForeignExchange],'INR',$_GET['queryString']);$tot=$vale/$convalue;echo round($tot,2);  if($vale==''){echo '&nbsp';}} ?></td>
               <?php
                }
                else
                {
                    ?>      
                     <td><?php if($FinanceAnnual[$i][EarninginForeignExchange]==0){echo '&nbsp';}else{ $tot=($FinanceAnnual[$i][EarninginForeignExchange]/$convalue); echo round($tot,2); } ?></td>
             <?php
                }
            }
            ?>

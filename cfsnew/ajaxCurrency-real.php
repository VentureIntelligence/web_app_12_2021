   ...
   <?php
    ...
    for($i=0;$i<count($FinanceAnnual);$i++){
        if($_GET['queryString']!='INR'){
            ...
            $EmpRelatedExp .= '<td>'. $vale = currency_convert($FinanceAnnual[$i][EmployeeRelatedExpenses],'INR',$_GET['queryString']); $tot=$vale/$convalue;echo round($tot,2).'</td>';
        }
    }
 else {
        if($FinanceAnnual[$i][EmployeeRelatedExpenses]!=0){
            $EmpRelatedExp .= '<td>'. $tot= ($FinanceAnnual[$i][EmployeeRelatedExpenses]/$convalue);echo round($tot,2).'</td>';
        }
...
<?php
    ...
    for($i=0;$i<count($FinanceAnnual);$i++){
        if($_GET['queryString']!='INR'){
            ...
            $frnExgEarnCont .= '<td>'. $vale = currency_convert($FinanceAnnual[$i][ForeignExchangeEarningandOutgo],'INR',$_GET['queryString']); $tot=$vale/$convalue;echo round($tot,2).'</td>';
        }
    }
 else {
        if($FinanceAnnual[$i][ForeignExchangeEarningandOutgo]!=0){
            $frnExgEarnCont .= '<td>'. $tot= ($FinanceAnnual[$i][ForeignExchangeEarningandOutgo]/$convalue);echo round($tot,2).'</td>';
        }
  ...
  <tr>
    ...
    <?php for($i=0;$i<count($FinanceAnnual);$i++){ 
    if($_GET['queryString']!='INR'){?>
        <td><?php if($FinanceAnnual[$i][ForeignExchangeEarningandOutgo]==0){echo '&nbsp';}else{$vale = currency_convert($FinanceAnnual[$i][ForeignExchangeEarningandOutgo],'INR',$_GET['queryString']);$tot=$vale/$convalue;echo round($tot,2);  if($vale==''){echo '&nbsp';}} ?></td>
   <?php
    }
    else
    {
        ?>   
         <td><?php if($FinanceAnnual[$i][ForeignExchangeEarningandOutgo]==0){echo '&nbsp';}else{ $tot= $FinanceAnnual[$i][ForeignExchangeEarningandOutgo]/$convalue;echo round($tot,2); } ?></td>
 <?php
    }
}
?>
   ...
   <?php
    ...
    for($i=0;$i<count($FinanceAnnual);$i++){
        if($_GET['queryString']!='INR'){
            ...
            $frnExgEarnin .= '<td>'. $vale = currency_convert($FinanceAnnual[$i][EarninginForeignExchange],'INR',$_GET['queryString']); $tot=$vale/$convalue;echo round($tot,2).'</td>';
        }
    }
 else {
        if($FinanceAnnual[$i][EarninginForeignExchange]!=0){
            $frnExgEarnin .= '<td>'. $tot= ($FinanceAnnual[$i][EarninginForeignExchange]/$convalue);echo round($tot,2).'</td>';
        }
    ...
    for($i=0;$i<count($FinanceAnnual);$i++){
        if($_GET['queryString']!='INR'){
            if($FinanceAnnual[$i][OutgoinForeignExchange]!=0){
             $frnExgOutgoin .= '<td>'. $vale = currency_convert($FinanceAnnual[$i][OutgoinForeignExchange],'INR',$_GET['queryString']); $tot=$vale/$convalue;echo round($tot,2).'</td>';
        }
    }
 else {
        if($FinanceAnnual[$i][OutgoinForeignExchange]!=0){
            $frnExgOutgoin .= '<td>'. $tot= ($FinanceAnnual[$i][OutgoinForeignExchange]/$convalue);echo round($tot,2).'</td>';
        }

                ...
                if($plstandard[21] !='' && $plstandard[21] !='CIN Number'){
                    ...
                    if(mysql_num_rows($result) >0){
                        ...
                        if($pl_check_count > 0){
                            ...
                            echo "update plstandard set BINR='$BINR',DINR='$DINR',updated_date='$added_date' where PLStandard_Id='$pls_id'";
                            mysql_query("update plstandard set BINR='$BINR',DINR='$DINR',updated_date='$added_date' where PLStandard_Id='$pls_id'");
                        }
                    }
                }
            }
        ...
        if($cin_check_count > 0){
            ...
            while($cprofileDetails = mysql_fetch_array($cprofile_check)){
                ...
                if(mysql_num_rows($cprofileD) > 0){
                    while($cprofileDs = mysql_fetch_array($cprofileD)){

...
//if(isset($_GET["action"]) && ($_GET["action"] == "upload")){
    ...
    $source_flag = 31;
        ...
        $cprofile_check = mysql_query("SELECT cin FROM cprofile WHERE source_flag2='$source_flag' group by cin limit $start,120" );
        ...
        if($cin_check_count > 0){
           ...
           // echo    $cin_number = 'U32204HR2008PTC046212';
                ...
                if(mysql_num_rows($cprofileD) > 0){
                    while($cprofileDs = mysql_fetch_array($cprofileD)){
                        ...
                        if($pl_check_count > 0){
                            ...
                            echo "UPDATE  `cprofile` SET FYCount='$FYCount',GFYCount='$GFYCount',source_flag1='$source_flag'  WHERE Company_Id='$cprofile_id'";
                            mysql_query("UPDATE  `cprofile` SET FYCount='$FYCount',GFYCount='$GFYCount',source_flag1='$source_flag'  WHERE Company_Id='$cprofile_id'" );   
                            $i=0;
                        ...
                        mysql_query("delete from cagr where CId_FK='$cprofile_id' and Updated_date!='$Added_Date' and ResultType='$ResultType'");
                        mysql_query("delete from growthpercentage where CId_FK='$cprofile_id' and Updated_date!='$Added_Date' and ResultType='$ResultType'");
                    }
                }
                $u++;
            }
    ...
    echo "insert into test (start_id,added_date,total_cnt,end_date) values ('$start','$Added_Date','$u','$end_Date')";
        mysql_query("insert into test (start_id,added_date,total_cnt,end_date) values ('$start','$Added_Date','$u','$end_Date')");
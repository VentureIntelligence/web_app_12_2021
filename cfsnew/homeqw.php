...
$growthResults = $growthpercentage->SearchHome($fields,$where,$order,$group,$page,$limit,$client);
//pr($growthResults);
...
$cagrResults = $cagr->SearchHome($fields,$where,$order,$group,$page,$limit,$client);
//pr($SearchResults);
...
//pr($_REQUEST);
   ...
   $paginationdiv= '<ul class="pagination">';
                 ...
                 $paginationdiv.='<li class="arrow unavailable"><a href="home.php?page='.$prevpage.'" >&laquo;</a></li>';
                  }
                  ...
                  $paginationdiv.='<li  class="'.(($pages[$i]==$page)?"current":" ").'"><a href="home.php?page='.$pages[$i].'">'.$pages[$i].'</a></li>';
                  
                 }
                 if($pages[$i]==$page+2 && $totalpages>4){
                 ...
                 $paginationdiv.='<li class="arrow"><a   href="home.php?page='.$nextpage.'">&raquo;</a></li>';
                     } else {  

...
/*
$DB_USER = "venturei_admin16"; //your db user name
$DB_PASSWORD = "[^Is&k~PQpMQ"; // your db password
$DB_DATABASE_NAME = "venture_peinvestments"; //your db name */

//for dev
// $DB_USER = "venturei_dev"; //your db user name
// $DB_PASSWORD = "6ij3syTGcs02"; // your db password
$DB_USER = "venturei_admin16"; //your db user name
$DB_PASSWORD = "%KTbNCJ@mO^iM9#c"; // your db password

...
//error_reporting(E_ALL);
    ...
    $exportsql = stripslashes("SELECT a.PLStandard_Id, a.CId_FK, a.IndustryId_FK,a.OptnlIncome,a.EBITDA,a.EBDT ,a.EBT,a.Tax,a.PAT ,a.FY as FY, a.ResultType, b.Company_Id, b.FCompanyName,b.ListingStatus,a.TotalIncome as TotalIncome,b.FYCount AS FYValue,b.Permissions1, b.SCompanyName, b.Industry, b.Sector, b.CIN FROM plstandard a ,cprofile b, industries indu  WHERE a.CId_FK = b.Company_Id 
  and indu.Industry_Id = b.Industry and a.FY=(SELECT max(aa.FY) as MFY FROM plstandard aa WHERE aa.CId_FK=a.CId_FK)  GROUP BY b.Company_Id ORDER BY FIELD(a.FY,'16') DESC,FIELD(a.FY,'15') DESC, a.FY DESC, b.SCompanyName asc");

                ...
                if($partner_type == "internal_partner"){
                    if($partner_name != '' && $partner_company != '' && $partner_validate_from != '' && $partner_validate_to != '' && $partner_search_count != '' && $partner_api_count != '' ){
                        $sql = 'UPDATE `api_partner` SET 
                                ...
                                `serachCount` = "'.$partner_search_count.'", 
                                `apiCount` = "'.$partner_api_count.'", 
                        ...
                        $sql_pass = mysql_query("select password from external_api_users WHERE `user_id` = '$user_id'");
                        ...
                        $sql_external = 'UPDATE `external_api_users` SET 
                                        `partnername` = "'.$partner_name.'",

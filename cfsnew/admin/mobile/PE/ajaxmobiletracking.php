<?php 
       ...
       // if($_POST){
                ...
                (select count(DISTINCT(companyName)) from apitracking  where user='".$user."' and (companyName !='')) as betweendateCount
                from apitracking as a where a.user='".$user."' and date(createdAt) between '$from_date' and '$to_date'";

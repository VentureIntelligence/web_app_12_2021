<?php 
       ...
       // if($_POST){
                ...
                // echo $partner_type; exit;
                
               if($partner_type == "external_partner"){
                        //echo "select password from external_api_users WHERE `user_id` = '$user_id'";
                        $sql_pass = mysql_query("select password from basic_api_users WHERE `user_id` = '$user_id'");
                        ...
                        // $sql_external = 'UPDATE `basic_api_users` SET 
                        ...
                        if($sql_external_updated == TRUE) {
                                ...
                                $sql = 'UPDATE `basic_api_partners` SET 
                                    `partnerName` = "'.$partner_name.'", 

<?php 
       ...
       // if($_POST){
               ...
               $validate_partner_email = "select count(*) as partner from basic_api_users WHERE username = '$partner_email'";
               ...
               // exit;
                ...
                if($partner_info == "CFS"){
                  ...
                  if($partner_name != '' && $partner_email != '' && $partner_company != '' && $partner_password != '' && $partner_duration_from != '' && $partner_duration_to != ''){
                     ...
                     // $sql_external = "INSERT INTO basic_api_users (partnername, username, password, companyName, partner_status, createdAt) 
                     //             VALUES ('$partner_name', '$partner_email', '$password', '$partner_company', '$status', now())";
                     $sql_external = "INSERT INTO basic_api_users ( username, password, companyName, partner_status,api_type, createdAt,updatedAt) 
                  ...
                  if($partner_external_added == TRUE) {
                     ...
                     $sql = "INSERT INTO basic_api_partners (partnerName, partner_company, partnerType, partnerToken, validityFrom, validityTo,overallCount , user_id , partner_status, createdAt,updatedAt,api_type,module_type) 
                     VALUES ('$partner_name', '$partner_company', '$partner_type', '$partner_token', '$partner_duration_from', '$partner_duration_to','$partner_overall_limit', '$external_partner_id', '$status', now(),now(),'$partner_subapi_info','$partner_info')";

...
// +----------------------------------------------------------------------+
//
// $Id: categoryPicker.php,v 1.1.1.1 2005/01/17 07:43:59 rsalvado Exp $
 ...
 * @access       public
 */
class HTML_QuickForm_categoryPicker extends HTML_QuickForm_input
{
    // {{{ constructor
     ...
     * @return    void
     */
    function HTML_QuickForm_categoryPicker($elementName=null, $elementLabel=null, $attributes=null)
    {

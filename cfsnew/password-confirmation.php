...
<body class="forgotpwd"> 
  ...
  <div class="login-screen">
    ...
    <div class="login-cnt forgot-screen" style="width: 400px;">  
      ...
      <h3> <center> Password Reset Confirmation  </center></h3>
      ...
      <?php 
          ...
          if(isset($_POST['id']) && isset($_POST['email']) && isset($_POST['new_pass'])  && isset($_POST['db_type'])){
              ...
              if($getCountPe >=1) {
                $updatepwdrsPe = mysql_query("Update dealmembers set Passwrd='$newpassword' where EmailId='$emailid'"); 
              ...
              if($getCountRe >=1) {
                $updatepwdrsRe=mysql_query("Update RElogin_members set Passwrd='$newpassword' where EmailId='$emailid'"); 
              ...
              if($getCountMa >=1) {
                $updatepwdrsMa=mysql_query("Update malogin_members set Passwrd='$newpassword' where EmailId='$emailid'"); 
              ...
              if($noError) {
                ...
                ?>   <p> <center> Your password has been reset. Please
                
                 <a href="<?php echo $loginUrl;?>"> Click Here  </a>
                 
                  to Login </center>  </p>  <br /> <br />   <?php
              } else {

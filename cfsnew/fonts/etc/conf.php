...
$DB_PASSWORD = "FmAetpEo5cY*"; // your db password


$DB_DATABASE_NAME = "venture_peinvestments"; //your db name
...
case "ventureintelligence.com":
	...
	define('FOLDER_CREATE_PATH',$_SERVER['DOCUMENT_ROOT']."/cfs-old/media/"); 
...
define('BASE_URL','//www.ventureintelligence.com/');
define('ADMIN_BASE_URL','//www.ventureintelligence.com/cfsnew/admin/');

...
{
    $order.="FIELD(a.FY,'16') DESC,FIELD(a.FY,'15') DESC, a.FY DESC, b.SCompanyName asc";
}
...
/*Advanced Searches Starts*/
		...
		$fields = array("a.PLStandard_Id, a.CId_FK, b.Industry,a.OptnlIncome,a.EBITDA,a.EBDT ,a.EBT,a.Tax,a.PAT ,a.FY, b.Company_Id, b.FCompanyName,b.ListingStatus","TotalIncome","b.Permissions1"," b.SCompanyName");
	...
	if(count($_REQUEST['answer']['Region']) > 0 && $_REQUEST['answer']['Region'] != NULL){
		...
		$total=count($allSearchResults);
               ...
               /* $total_top = $total = $plstandard->SearchHomecount($where,$group);
...
if($_REQUEST['YOYCAGR'] != ("gAnyOf" || 'gacross' || "CAGR")){
	...
	//$order = " a.FY DESC,b.SCompanyName ASC";
        $order1 = "b.SCompanyName ASC,a.FY DESC";
         $order2="FIELD(a.FY,'16') DESC,FIELD(a.FY,'15') DESC, a.FY DESC, b.SCompanyName asc";
//	pr($fields);
//	pr($where);
//	pr($order);
//	pr($group);
...
//echo "<div class='' style='display:none'>case 5 $where</div>";
            $allSearchResults_top = $plstandard->SearchHome_WithCharges_cnt($chargewhereTop,$fields,$whereTop,$order2,$group);
            $total_top=$allSearchResults_top[0]['count'];
           ...
           //$SearchExport = $plstandard->SearchHomeExport($fields,$where,$order,$group);
            ...
            $total_top = $plstandard->allSearchHomecount($whereTop,$group);
...
// $order = " a.FY DESC,b.SCompanyName ASC";
           ...
           // $fields2= array("a.PLStandard_Id, a.CId_FK, b.Industry,a.OptnlIncome,a.EBITDA,a.EBDT ,a.EBT,a.Tax,a.PAT ,a.FY, a.ResultType,b.CIN, b.Company_Id, b.FCompanyName,b.ListingStatus","a.TotalIncome as TotalIncome","b.GFYCount AS GFY","b.Permissions1"," b.SCompanyName"," b.Industry"," b.Sector");
            $orderc="FIELD(t1.FY,'16') DESC,FIELD(t1.FY,'15') DESC, t1.FY DESC, t1.SCompanyName asc"; 
                
      if($chargewhere!=''){
           
//          $fields = array("a.GrowthPerc_Id, a.CId_FK, b.Industry,a.OptnlIncome,a.EBITDA,a.EBDT ,a.EBT,a.Tax,a.PAT ,max(a.FY) as FY, a.ResultType,b.CIN, b.Company_Id, b.FCompanyName,b.ListingStatus","a.TotalIncome as TotalIncome","b.GFYCount AS GFY","b.Permissions1","b.FYCount","b.SCompanyName"," b.Industry"," b.Sector");
//        $fields2 = array("a.GrowthPerc_Id, a.CId_FK, b.Industry,a.OptnlIncome,a.EBITDA,a.EBDT ,a.EBT,a.Tax,a.PAT ,max(a.FY) as FY, a.ResultType,b.Company_Id, b.FCompanyName,b.ListingStatus","a.TotalIncome as TotalIncome","b.GFYCount AS GFY","b.Permissions1","b.FYCount","b.SCompanyName"," b.Industry"," b.Sector");

         

//echo "<div class='' style='display:none'>case 7</div>";
...
//echo "<div class='' style='display:none'>case 8</div>";
...
$group = " t1.SCompanyName ";
$fields = array("a.PLStandard_Id, a.CId_FK, b.Industry,a.OptnlIncome,a.EBITDA,a.EBDT ,a.EBT,a.Tax,a.PAT ,a.FY as FY, a.ResultType,b.Company_Id, b.FCompanyName,b.ListingStatus","a.TotalIncome as TotalIncome","b.Permissions1","b.FYCount as FYValue"," b.SCompanyName"," b.Industry"," b.Sector");
...
//echo "<div class='' style='display:none'>case 9  </div>";
...
/*Growth Search CAGR Ends*/
        ...
        $_SESSION['resultCompanyId'] = $countids;
            unset($_SESSION['totalResults_top']);
         if(!empty($total_top)){
           $_SESSION['totalResults'] = $total_top;  
           $_SESSION['totalResults_top'] = '';             
         }else{
           $_SESSION['totalResults_top'] = 'yes';               
         }
         if (!isset($_SESSION['totalResults_top']) || ($_SESSION['totalResults_top'] != '')){
           $_SESSION['totalResults'] = $total;
         }
        
        $template->assign("totalrecord_1",$_SESSION['totalResults']);
         
        // echo "<div class='total_top' style='display:none'>$total_top</div>";

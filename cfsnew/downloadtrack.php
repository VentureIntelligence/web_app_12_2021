...
$frnExgOutgoin = '';
    ...
    $col = 1;
			...
			for($i=0;$i<count($FinanceAnnual);$i++){
				...
				if($_GET['queryString']!='INR'){
					if($FinanceAnnual[$i][OptnlIncome]==0){$OptnlIncome ='0';}else{ $vale = $FinanceAnnual[$i][OptnlIncome]/$usdconversion;$tot=$vale/$convalue;$OptnlIncome = round($tot,2);  if($vale==''){$OptnlIncome = '0';}} 
					if($FinanceAnnual[$i][OtherIncome]==0){$OtherIncome ='0';}else{ $vale = $FinanceAnnual[$i][OtherIncome]/$usdconversion;$tot=$vale/$convalue;$OtherIncome = round($tot,2);  if($vale==''){$OtherIncome = '0';}} 
					if($FinanceAnnual[$i][TotalIncome]==0){$TotalIncome ='0';}else{ $vale = $FinanceAnnual[$i][TotalIncome]/$usdconversion;$tot=$vale/$convalue;$TotalIncome = round($tot,2);  if($vale==''){$TotalIncome = '0';}}
					if($FinanceAnnual[$i][CostOfMaterialsConsumed]==0){$CostOfMaterialsConsumed ='0';}else{ $vale = $FinanceAnnual[$i][CostOfMaterialsConsumed]/$usdconversion;$tot=$vale/$convalue;$CostOfMaterialsConsumed = round($tot,2);  if($vale==''){$CostOfMaterialsConsumed = '0';}} 
					if($FinanceAnnual[$i][PurchasesOfStockInTrade]==0){$PurchasesOfStockInTrade ='0';}else{ $vale = $FinanceAnnual[$i][PurchasesOfStockInTrade]/$usdconversion;$tot=$vale/$convalue;$PurchasesOfStockInTrade = round($tot,2);  if($vale==''){$PurchasesOfStockInTrade = '0';}}
					if($FinanceAnnual[$i][ChangesInInventories]==0){$ChangesInInventories ='0';}else{ $vale = $FinanceAnnual[$i][ChangesInInventories]/$usdconversion;$tot=$vale/$convalue;$ChangesInInventories = round($tot,2);  if($vale==''){$ChangesInInventories = '0';}}
					if($FinanceAnnual[$i][EmployeeRelatedExpenses]==0){$EmployeeRelatedExpenses ='0';}else{ $vale = $FinanceAnnual[$i][EmployeeRelatedExpenses]/$usdconversion;$tot=$vale/$convalue;$EmployeeRelatedExpenses = round($tot,2);  if($vale==''){$EmployeeRelatedExpenses = '0';}}
					if($FinanceAnnual[$i][CSRExpenditure]==0){$CSRExpenditure ='0';}else{ $vale = $FinanceAnnual[$i][CSRExpenditure]/$usdconversion;$tot=$vale/$convalue;$CSRExpenditure = round($tot,2);  if($vale==''){$CSRExpenditure = '0';}}
					if($FinanceAnnual[$i][OtherExpenses]==0){$OtherExpenses ='0';}else{ $vale = $FinanceAnnual[$i][OtherExpenses]/$usdconversion;$tot=$vale/$convalue;$OtherExpenses = round($tot,2);  if($vale==''){$OtherExpenses = '0';}}
					if($FinanceAnnual[$i][OptnlAdminandOthrExp]==0){$OptnlAdminandOthrExp ='0';}else{ $vale = $FinanceAnnual[$i][OptnlAdminandOthrExp]/$usdconversion;$tot=$vale/$convalue;$OptnlAdminandOthrExp = round($tot,2);  if($vale==''){$OptnlAdminandOthrExp = '0';}}
					if($FinanceAnnual[$i][OptnlProfit]==0){$OptnlProfit ='0';}else{ $vale = $FinanceAnnual[$i][OptnlProfit]/$usdconversion;$tot=$vale/$convalue;$OptnlProfit = round($tot,2);  if($vale==''){$OptnlProfit = '0';}}
					if($FinanceAnnual[$i][EBITDA]==0){$EBITDA ='0';}else{ $vale = $FinanceAnnual[$i][EBITDA]/$usdconversion;$tot=$vale/$convalue;$EBITDA = round($tot,2);  if($vale==''){$EBITDA = '0';}}
					if($FinanceAnnual[$i][Interest]==0){$Interest ='0';}else{ $vale = $FinanceAnnual[$i][Interest]/$usdconversion;$tot=$vale/$convalue;$Interest = round($tot,2);  if($vale==''){$Interest = '0';}}
					if($FinanceAnnual[$i][EBDT]==0){$EBDT ='0';}else{ $vale = $FinanceAnnual[$i][EBDT]/$usdconversion;$tot=$vale/$convalue;$EBDT = round($tot,2);  if($vale==''){$EBDT = '0';}}
					if($FinanceAnnual[$i][Depreciation]==0){$Depreciation ='0';}else{ $vale = $FinanceAnnual[$i][Depreciation]/$usdconversion;$tot=$vale/$convalue;$Depreciation = round($tot,2);  if($vale==''){$Depreciation = '0';}}
					if($FinanceAnnual[$i][EBT_before_Priod_period]==0){$EBT_before_Priod_period ='0';}else{ $vale = $FinanceAnnual[$i][EBT_before_Priod_period]/$usdconversion;$tot=$vale/$convalue;$EBT_before_Priod_period = round($tot,2);  if($vale==''){$EBT_before_Priod_period = '0';}}
					if($FinanceAnnual[$i][Priod_period]==0){$Priod_period ='0';}else{ $vale = $FinanceAnnual[$i][Priod_period]/$usdconversion;$tot=$vale/$convalue;$Priod_period = round($tot,2);  if($vale==''){$Priod_period = '0';}}
					if($FinanceAnnual[$i][EBT]==0){$OptnlAdminandOthrExp ='0';}else{ $vale = $FinanceAnnual[$i][EBT]/$usdconversion;$tot=$vale/$convalue;$EBT = round($tot,2);  if($vale==''){$EBT = '0';}}
					if($FinanceAnnual[$i][CurrentTax]==0){$CurrentTax ='0';}else{ $vale = $FinanceAnnual[$i][CurrentTax]/$usdconversion;$tot=$vale/$convalue;$CurrentTax = round($tot,2);  if($vale==''){$CurrentTax = '0';}}
					...
					if($FinanceAnnual[$i][Tax]==0){$Tax ='0';}else{ $vale = $FinanceAnnual[$i][Tax]/$usdconversion;$tot=$vale/$convalue;$Tax = round($tot,2);  if($vale==''){$Tax = '0';}}
					if($FinanceAnnual[$i][PAT]==0){$PAT ='0';}else{ $vale = $FinanceAnnual[$i][PAT]/$usdconversion;$tot=$vale/$convalue;$PAT = round($tot,2);  if($vale==''){$PAT = '0';}}
					if($FinanceAnnual[$i][BINR]==0){$BINR ='0';}else{ $vale = $FinanceAnnual[$i][BINR]/$usdconversion;$tot=$vale/$convalue;$BINR = round($tot,2);  if($vale==''){$BINR = '0';}}
					if($FinanceAnnual[$i][DINR]==0){$DINR ='0';}else{ $vale = $FinanceAnnual[$i][DINR]/$usdconversion;$tot=$vale/$convalue;$DINR = round($tot,2);  if($vale==''){$DINR = '0';}}
					if($FinanceAnnual[$i][profit_loss_of_minority_interest]==0){$profit_loss_of_minority_interest ='0';}else{ $vale = $FinanceAnnual[$i][profit_loss_of_minority_interest]/$usdconversion;$tot=$vale/$convalue;$profit_loss_of_minority_interest = round($tot,2);  if($vale==''){$profit_loss_of_minority_interest = '0';}}
					if($FinanceAnnual[$i][total_profit_loss_for_period]==0){$total_profit_loss_for_period ='0';}else{ $vale = $FinanceAnnual[$i][total_profit_loss_for_period]/$usdconversion;$tot=$vale/$convalue;$total_profit_loss_for_period = round($tot,2);  if($vale==''){$total_profit_loss_for_period = '0';}}
					if($FinanceAnnual[$i][EarninginForeignExchange]==0){$EarninginForeignExchange ='0';}else{ $vale = $FinanceAnnual[$i][EarninginForeignExchange]/$usdconversion;$tot=$vale/$convalue;$EarninginForeignExchange = round($tot,2);  if($vale==''){$EarninginForeignExchange = '0';}}
					if($FinanceAnnual[$i][OutgoinForeignExchange]==0){$OutgoinForeignExchange ='0';}else{ $vale = $FinanceAnnual[$i][OutgoinForeignExchange]/$usdconversion;$tot=$vale/$convalue;$OutgoinForeignExchange = round($tot,2);  if($vale==''){$OutgoinForeignExchange = '0';}}
			   ...
			   else
			   {
						...
						if($FinanceAnnual[$i][OptnlIncome]==0){$OptnlIncome ='0';}else{$tot=($FinanceAnnual[$i][OptnlIncome]/$convalue);if($_GET['rconv'] =='r'){$OptnlIncome =number_format("$tot");}else{$OptnlIncome =round($tot,2);} }
						if($FinanceAnnual[$i][OtherIncome]==0){$OtherIncome ='0';}else{$tot=($FinanceAnnual[$i][OtherIncome]/$convalue);if($_GET['rconv'] =='r'){$OtherIncome =number_format("$tot");}else{$OtherIncome =round($tot,2);} } 
						if($FinanceAnnual[$i][TotalIncome]==0){$TotalIncome ='0';}else{$tot=($FinanceAnnual[$i][TotalIncome]/$convalue);if($_GET['rconv'] =='r'){$TotalIncome =number_format("$tot");}else{$TotalIncome =round($tot,2);} }
						if($FinanceAnnual[$i][CostOfMaterialsConsumed]==0){$CostOfMaterialsConsumed ='0';}else{$tot=($FinanceAnnual[$i][CostOfMaterialsConsumed]/$convalue);if($_GET['rconv'] =='r'){$CostOfMaterialsConsumed =number_format("$tot");}else{$CostOfMaterialsConsumed =round($tot,2);} }
						if($FinanceAnnual[$i][PurchasesOfStockInTrade]==0){$PurchasesOfStockInTrade ='0';}else{$tot=($FinanceAnnual[$i][PurchasesOfStockInTrade]/$convalue);if($_GET['rconv'] =='r'){$PurchasesOfStockInTrade =number_format("$tot");}else{$PurchasesOfStockInTrade =round($tot,2);} }
						if($FinanceAnnual[$i][ChangesInInventories]==0){$ChangesInInventories ='0';}else{$tot=($FinanceAnnual[$i][ChangesInInventories]/$convalue);if($_GET['rconv'] =='r'){$ChangesInInventories =number_format("$tot");}else{$ChangesInInventories =round($tot,2);} }
						if($FinanceAnnual[$i][EmployeeRelatedExpenses]==0){$EmployeeRelatedExpenses ='0';}else{$tot=($FinanceAnnual[$i][EmployeeRelatedExpenses]/$convalue);if($_GET['rconv'] =='r'){$EmployeeRelatedExpenses =number_format("$tot");}else{$EmployeeRelatedExpenses =round($tot,2);} }
						if($FinanceAnnual[$i][CSRExpenditure]==0){$CSRExpenditure ='0';}else{$tot=($FinanceAnnual[$i][CSRExpenditure]/$convalue);if($_GET['rconv'] =='r'){$CSRExpenditure =number_format("$tot");}else{$CSRExpenditure =round($tot,2);} }
						if($FinanceAnnual[$i][OtherExpenses]==0){$OtherExpenses ='0';}else{$tot=($FinanceAnnual[$i][OtherExpenses]/$convalue);if($_GET['rconv'] =='r'){$OtherExpenses =number_format("$tot");}else{$OtherExpenses =round($tot,2);} }
						if($FinanceAnnual[$i][OptnlAdminandOthrExp]==0){$OptnlAdminandOthrExp ='0';}else{$tot=($FinanceAnnual[$i][OptnlAdminandOthrExp]/$convalue);if($_GET['rconv'] =='r'){$OptnlAdminandOthrExp =number_format("$tot");}else{$OptnlAdminandOthrExp =round($tot,2);} }
						if($FinanceAnnual[$i][OptnlProfit]==0){$OptnlProfit ='0';}else{$tot=($FinanceAnnual[$i][OptnlProfit]/$convalue);if($_GET['rconv'] =='r'){$OptnlProfit =number_format("$tot");}else{$OptnlProfit =round($tot,2);} }
						if($FinanceAnnual[$i][EBITDA]==0){$EBITDA ='0';}else{$tot=($FinanceAnnual[$i][EBITDA]/$convalue);if($_GET['rconv'] =='r'){$EBITDA =number_format("$tot");}else{$EBITDA =round($tot,2);}}
						if($FinanceAnnual[$i][Interest]==0){$Interest ='0';}else{$tot=($FinanceAnnual[$i][Interest]/$convalue);if($_GET['rconv'] =='r'){$Interest =number_format("$tot");}else{$Interest =round($tot,2);}}
						if($FinanceAnnual[$i][EBDT]==0){$EBDT ='0';}else{$tot=($FinanceAnnual[$i][EBDT]/$convalue);if($_GET['rconv'] =='r'){$EBDT =number_format("$tot");}else{$EBDT =round($tot,2);} }
						if($FinanceAnnual[$i][Depreciation]==0){$Depreciation ='0';}else{$tot=($FinanceAnnual[$i][Depreciation]/$convalue);if($_GET['rconv'] =='r'){$Depreciation =number_format("$tot");}else{$Depreciation =round($tot,2);} }
						if($FinanceAnnual[$i][EBT_before_Priod_period]==0){$EBT_before_Priod_period ='0';}else{$tot=($FinanceAnnual[$i][EBT_before_Priod_period]/$convalue);if($_GET['rconv'] =='r'){$EBT_before_Priod_period =number_format("$tot");}else{$EBT_before_Priod_period =round($tot,2);}}
						if($FinanceAnnual[$i][Priod_period]==0){$Priod_period ='0';}else{$tot=($FinanceAnnual[$i][Priod_period]/$convalue);if($_GET['rconv'] =='r'){$Priod_period =number_format("$tot");}else{$Priod_period =round($tot,2);}}
						if($FinanceAnnual[$i][EBT]==0){$EBT ='0';}else{$tot=($FinanceAnnual[$i][EBT]/$convalue);if($_GET['rconv'] =='r'){$EBT =number_format("$tot");}else{$EBT =round($tot,2);} }
						if($FinanceAnnual[$i][CurrentTax]==0){$CurrentTax ='0';}else{$tot=($FinanceAnnual[$i][CurrentTax]/$convalue);if($_GET['rconv'] =='r'){$CurrentTax =number_format("$tot");}else{$CurrentTax =round($tot,2);} }
						...
						if($FinanceAnnual[$i][Tax]==0){$Tax ='0';}else{$tot=($FinanceAnnual[$i][Tax]/$convalue);if($_GET['rconv'] =='r'){$Tax =number_format("$tot");}else{$Tax =round($tot,2);} }
						if($FinanceAnnual[$i][PAT]==0){$PAT ='0';}else{$tot=($FinanceAnnual[$i][PAT]/$convalue);if($_GET['rconv'] =='r'){$PAT =number_format("$tot");}else{$PAT =round($tot,2);} }
						if($FinanceAnnual[$i][BINR]==0){$BINR ='0';}else{$tot=($FinanceAnnual[$i][BINR]);$BINR =round($tot,2); }
						if($FinanceAnnual[$i][DINR]==0){$DINR ='0';}else{$tot=($FinanceAnnual[$i][DINR]);$DINR =round($tot,2); }
						if($FinanceAnnual[$i][profit_loss_of_minority_interest]==0){$profit_loss_of_minority_interest ='0';}else{$tot=($FinanceAnnual[$i][profit_loss_of_minority_interest]/$convalue);if($_GET['rconv'] =='r'){$profit_loss_of_minority_interest =number_format("$tot");}else{$profit_loss_of_minority_interest =round($tot,2);}}
						if($FinanceAnnual[$i][total_profit_loss_for_period]==0){$total_profit_loss_for_period ='0';}else{$tot=($FinanceAnnual[$i][total_profit_loss_for_period]/$convalue);if($_GET['rconv'] =='r'){$total_profit_loss_for_period =number_format("$tot");}else{$total_profit_loss_for_period =round($tot,2);} }
						if($FinanceAnnual[$i][EarninginForeignExchange]==0){$EarninginForeignExchange ='0';}else{$tot=($FinanceAnnual[$i][EarninginForeignExchange]/$convalue);if($_GET['rconv'] =='r'){$EarninginForeignExchange =number_format("$tot");}else{$EarninginForeignExchange =round($tot,2);} }
						if($FinanceAnnual[$i][OutgoinForeignExchange]==0){$OutgoinForeignExchange ='0';}else{$tot=($FinanceAnnual[$i][OutgoinForeignExchange]/$convalue);if($_GET['rconv'] =='r'){$OutgoinForeignExchange =number_format("$tot");}else{$OutgoinForeignExchange =round($tot,2);} }

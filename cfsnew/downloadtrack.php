...
if(isset($_GET['type']) && $_GET['type']=='consolidated'){
    ...
    $col = 1;
			...
			$objPHPExcel->getActiveSheet()->setCellValue('A16', 'Operational, Admin & Other Expenses')->getStyle("A16")->applyFromArray($boldStyle);
			$objPHPExcel->getActiveSheet()->setCellValue('A17', 'Operating Profit')->getStyle("A17")->applyFromArray($headerArray) ;
			$objPHPExcel->getActiveSheet()->setCellValue('A18', 'EBITDA')->getStyle("A18")->applyFromArray($boldStyle);
			$objPHPExcel->getActiveSheet()->setCellValue('A19', 'Interest')->getStyle("A19")->applyFromArray($headerArray) ;
			$objPHPExcel->getActiveSheet()->setCellValue('A20', 'EBDT')->getStyle("A20")->applyFromArray($boldStyle);
			$objPHPExcel->getActiveSheet()->setCellValue('A21', 'Depreciation')->getStyle("A21")->applyFromArray($headerArray) ;
			$objPHPExcel->getActiveSheet()->setCellValue('A22', 'EBT before Exceptional Items')->getStyle("A22")->applyFromArray($boldStyle);
			...
			for($i=0;$i<count($FinanceAnnual);$i++){
			   ...
			   else
			   {
				...
				$row++;
				$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($col,$row,$TotalIncome )->getStyleByColumnAndRow($col,$row)->applyFromArray($boldStyle);
				$row++;
				...
				$row++;
				$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow( $col,$row,$OptnlAdminandOthrExp )->getStyleByColumnAndRow($col,$row)->applyFromArray($boldStyle);
				$row++;
				...
				$row++;
				$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow( $col,$row,$EBITDA )->getStyleByColumnAndRow($col,$row)->applyFromArray($boldStyle);
				$row++;
				...
				$row++;
				$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow( $col,$row,$EBDT )->getStyleByColumnAndRow($col,$row)->applyFromArray($boldStyle);
				$row++;
				...
				$row++;
				$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow( $col,$row,$EBT )->getStyleByColumnAndRow($col,$row)->applyFromArray($boldStyle);
				$row++;
				...
				$row++;
				$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow( $col,$row,$Tax )->getStyleByColumnAndRow($col,$row)->applyFromArray($boldStyle);
				$row++;

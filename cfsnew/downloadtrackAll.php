...
if($toturcount2[0][3] >= $toturcount2[0][7]){
	...
	echo "<div style='background-color:#F5F0E4;width:300px;height:100px;border-radius:10px;margin:0px auto;'><br/><br/><span style='color:#000000;width:150px;height:80px;border-radius:10px;margin-left:110px;'><a href=GLOBAL_BASE_URL.'cfs/media/plstandard/PLStandard_".$_GET['vcid'].".xls' style='text-decoration:none;color:#800000;'>Download</a></span></div>";
	$file=GLOBAL_BASE_URL.'cfs/media/plstandard/PLStandard_'.$_GET['vcid'].'.xls';
	//readfile($file);*/
            // We'll be outputting a PDF
    $file=FOLDER_CREATE_PATH.'companyDetail/companyDetail_'.$_GET['vcid'].'.xls';      
...
$companyname = $cprofile->getCompanies($where2,$order);
   ...
   $filename=$companyname[$_GET['vcid']].'.xls';//die;

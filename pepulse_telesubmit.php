...
//********Mail details
		...
		$subject="Telecom Rep Download-" .$revenure_range_display."-".$firmname;
		$message="<html><center><b><u>Telecom Report Download</u></b></center><br>
		<head></head>		<body >
...
?>
	    ...
	    <div id="maintextpro">
           ...
           <div id="headingtextpro">
            <div id="headingtextprobold">PE Pulse on Telecom<br /> <br /></div>
           Thanks for your interest in the PE Pulse Report on Telecom report.

			<span style="float:right" class="one">
		  	<a href="pepulse-tele.pdf"><img src="images/arrow.gif" border="0" />Click Here to Download the report </a></span>

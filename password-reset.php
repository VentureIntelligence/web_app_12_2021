    ...
    <?php   
        ...
        $getresetDetailResult = mysql_fetch_assoc($getresetDetailResult); 
          ...
          <input type="hidden" name="email" id="email" value="<?php echo $resetUserEmail;?>" />
            <ul>           
           <li><label style="width:40%;"> New Password:  </label>  <input type="password" id="newpassword" name="new_pass" 
          ...
          <?php 
              ...
              if($resetUserDbType =='cfs') {
                ?> Click here to    <a href="<?php echo $loginUrl;?>"> <a href="<?php echo GLOBAL_BASE_URL; ?>forgetpwd.php?value=cfs"> Reset Password </a> <?php
              } else if($resetUserDbType =='P') {
                ?> Click here to  <a href="<?php echo GLOBAL_BASE_URL; ?>forgetpwd.php?value=P"> Reset Password </a> <?php
              } else if($resetUserDbType =='R') {
                ?> Click here to  <a href="<?php echo GLOBAL_BASE_URL; ?>forgetpwd.php?value=R"> Reset Password </a> <?php
              } else if($resetUserDbType =='M') {
                ?> Click here to <a href="<?php echo GLOBAL_BASE_URL; ?>forgetpwd.php?value=M"> Reset Password </a> <?php
              } 
          }

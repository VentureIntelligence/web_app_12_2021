...
//********Mail details
			...
			$RegDate=date("M-d-Y");
			$to="arun.natarajan@gmail.com,arihant@ventureintelligence.com,ashok@ventureintelligence.com";
		   	//$to .="sow_ram@yahoo.com";
		$subject="EDU Rep Download-" .$revenure_range_display."-".$firmname;
		$message="<html><center><b><u>Education Report Download</u></b></center><br>
...
?>
	    ...
	    <div id="maintextpro">
           ...
           <div id="headingtextpro">
            <div id="headingtextprobold">PE Pulse Education<br /></div>

			...
			//echo "<Br>password to check-" .$adminpassword;
				if((trim($loggedadminpwd)!=""))
				{
					...
					/*if($cmpvalue==0)
						...
						echo "<Br>False";*/
					if(($cmpvalue==0) && ( ($cmpvalue1==0) || ($cmpvalue2==0)) )
					{
						//&& ($cmpvalue1==0))
						...
						header( 'Location: '. GLOBAL_BASE_URL .'adminvi/admin.php' ) ;
					}
					else
					{
...
<body>
<form name="viadmin" onSubmit="return checkFields();" method="post" action="adminip.php" >
  ...
  <div id="leftpanel">
    ...
    <div id="vertbgpropelogin">
    	...
    	<div id="vertMenupelogin">
        	...
        	<div> <input type=password name="adminpassword" value="" size="23"> <br /><br /> <br /></div>
	       	<div> <span style="float:right" >
        	<input type="submit" name="btnSubmit" value ="Authenticate"> </span> <br /><br /></div>

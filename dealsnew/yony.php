...
<?php include_once('refine.php');?>
 ...
 <?php
 $sqlYear = "SELECT year(`peinvestments`.`dates`),count(`peinvestments`.`PEId`),sum(`peinvestments`.`amount`) FROM `peinvestments` where dates > '1997-01-01' and dates < DATE(NOW())  group by year(`peinvestments`.`dates`)";
...
<li class="active"><a href="yony.php"><i class="i-trend-view"></i>Trend View</a></li>
</ul><br>
...
<label><input name="typeoff" type="radio"  value="0" onclick="testing();" checked="checked"/> Year On year</label>
<label><input name="typeoff" type="radio"  value="1" onclick="testing();" />Indusrty</label>
<label><input name="typeoff" type="radio"  value="2" onClick="handleChange(this);"/>Stage</label>
<label><input name="typeoff" type="radio" value="3" onClick="handleChange(this);"/>Range</label>
<label><input name="typeoff" type="radio" value="4" onClick="handleChange(this);"/>Investor Type</label>
<label><input name="typeoff" type="radio" value="5" onClick="handleChange(this);"/>Region</label>
...
<table cellpadding="0" cellspacing="0" width="50%" class="profile-view-table">
<thead><tr><th style="text-align:center">Year</th>
    <th style="text-align:center;">No. of Deals</th>
    <th style="text-align:center;">Amount($m)</th></tr></thead>

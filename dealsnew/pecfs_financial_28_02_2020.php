...
//        echo '</pre>';
    ...
    //    exit();
            ...
            $financial_data .= '<div style="height:200px;font-size:16px;text-align:center;margin-top:200px;"><span display: inline-block;vertical-align: middle;line-height: normal;> Data not found. Please <a href="mailto:junaid@kutung.com?subject=Request for financials linking&body='.GLOBAL_BASE_URL.'dealsnew/dealdetails.php?value=1829487383/0/&scr=EMAIL"  id="financial_data" style="font-weight:bold;cursor:pointer;text-decoration: underline;color: #624C34;">Click Here</a> to alert Venture Intelligence about this. Thanks.</span></div>';
        }
    }else{

        $financial_data .= '<div style="height:200px;font-size:16px;text-align:center;margin-top:200px;"><span display: inline-block;vertical-align: middle;line-height: normal;>Data not found. Please <a href="mailto:junaid@kutung.com?subject=Request for financials linking&body='.GLOBAL_BASE_URL.'dealsnew/dealdetails.php?value=1829487383/0/&scr=EMAIL"  id="financial_data" style="font-weight:bold;cursor:pointer;text-decoration: underline;color: #624C34;">Click Here</a> to alert Venture Intelligence about this. Thanks. </span></div>'; //Company not found in CFS.
    }
}else{
    $financial_data .= '<div style="height:200px;font-size:16px;text-align:center;margin-top:200px;"><span display: inline-block;vertical-align: middle;line-height: normal;>Data not found. Please <a href="mailto:junaid@kutung.com?subject=Request for financials linking&body='.GLOBAL_BASE_URL.'dealsnew/dealdetails.php?value=1829487383/0/&scr=EMAIL"  id="financial_data" style="font-weight:bold;cursor:pointer;text-decoration: underline;color: #624C34;">Click Here</a> to alert Venture Intelligence about this. Thanks.</span></div>'; //CIN number not found.
}

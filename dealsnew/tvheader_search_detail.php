...
<?php if($_SESSION['vconly']==1) { ?> 
   <a href="index.php?value=1">
    <?php } else {  ?> 
      <a href="index.php">
    <?php } ?>
  <img src="images/logo.gif" width="167" height="45" alt="Venture Intelligence"
   title="Venture Intelligence" border="0" /></a></div></td>
<td class="right-box">
...
<label><input class="investment-nav" name="investments" type="radio" value=3  <?php if($vcflagValue==3) { ?> checked="checked" <?php } ?>/>Social VC</label></div>
</div>
 -->

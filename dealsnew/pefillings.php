...
<td class="profile-view-left" style="width:100%;">
    <div class="result-cnt"> 
            ...
            if(!in_array($industryId,$pe_industries)){
               ...
               /* echo '<div style="font-size:20px;padding:10px 10px 10px 10px;"><b> You dont have access to this information!</b></div>';*/
                echo '<div style="font-size:20px;padding:10px 10px 10px 10px;"><b> The filings section is currently not accessible. Please try after some time</b></div>';
                exit;
            } ?>
 ...
 <div class="view-detailed">
                            ...
                            <div class="view-table view-table-list filing-cnt" style="padding-top: 3px !important;">
                                <h3>FILINGS</h3>
                                                ...
                                                foreach ($items1 as $folder => $innerArray) {
                                                    if (is_array($innerArray)){
                                                        ...
                                                        foreach ($innerArray as $key => $value) {
                                                            //echo "<tr><td><a href='$value' target='_blank'  >$key</a></td></tr>";

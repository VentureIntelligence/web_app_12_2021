...
<?php include_once('marefine.php');?>
 ...
 <form name=companyDisplay method="post" action="exportMA.php">
 <?php
...
<td class="profile-view-left" style="width:100%;">
    ...
    <div class="result-title"> 
        ...
        <?php if(!$_POST){ ?> 
                           ...
                           <?php
                               ...
                               ?>
                                          <span class="result-for">  for Mergers & Acquistions Investment</span>  
  ...
  <div class="profilemain">
               ...
               <ul>
                 ...
                 <li><h4>Deal Amount(US$M)</h4><p><?php echo $hideamount;?></p></li>
		...
		?>
                        <td><h4>Company Type</h4> <p><?php echo $target_listing_stauts_display;?></p></td></tr>
                        <tr><td><h4>Industry</h4> <p><?php echo $myrow["industry"];?></p></td>
                        <td><h4>Sector</h4> <p><?php echo $myrow["sector_business"];?></p></td></tr>
                        <tr><td><h4>City (Target)</h4> <p><?php echo $myrow["TargetCity"];?></p></td>
                         <td><h4>Country (Target)</h4> <p><?php echo $myrow["TargetCountry"];?></p></td></tr>
                        <tr><td colspan="2"><h4>Website</h4> <p><a href=<?php echo $webdisplay; ?> target="_blank"><?php echo  $myrow["website"]; ?></a></td></p>	</td></tr> 
                        <tr><td colspan="2"><h4>Links</h4> <p style="word-break: break-all;">
                                <?php
      ...
      <div  class="work-masonry-thumb col-1" href="http://erikjohanssonphoto.com/work/aizone-ss13/">
         ...
         <?php
                        ...
                        <td><h4>Acquirer Company Type</h4><p><?php echo $acquirer_listing_stauts_display ;?></p></td></tr>

                        <tr><td><h4>City (Acquirer)</h4><p><?php echo $Acquirercityname;?></p></td>
                        <td><h4>Country (Acquirer)</h4><p><?php echo $Acquirercountryname;?></p></td>
                        </tr>               
                         </tbody>
                    </table>
                    </div>   

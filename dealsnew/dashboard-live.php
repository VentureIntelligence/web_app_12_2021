...
//"#967855","#816346","#725e46","#625645","#504941","#EAB875","#DCBB93","#C18842","#6C5536"],
           ...
           var data = google.visualization.arrayToDataTable([
           ['Year'<?php if(count($deal)>0){ foreach($deal as $industry => $values)
                      { 
                          echo ",'".$industry."'";
           } }?>]
                       <?php
                       for($i=$fixstart;$i<=$fixend;$i++)
                        {
                        ?>   ,["<?php echo $i; ?>"
                             <?php if(count($deal)>0){foreach($deal as $industry => $values)
  ...
  divheight=  document.getElementById("visualization").offsetHight;
       ...
       for($i=$fixstart;$i<=$fixend;$i++)
       {
        ...
        $totaldealsarray[$i]=$totaldeals;
          ...
          var data1 = google.visualization.arrayToDataTable([
            ['Year'<?php if(count($deal)>0){ foreach($deal as $Stage => $values)
                      { 
                          echo ",'".$Stage."'";
            }}?>]
                       <?php
                       for($i=$fixstart;$i<=$fixend;$i++)
                        {
                        ?>   ,["<?php echo $i; ?>"
                             <?php if(count($deal)>0){foreach($deal as $Stage => $values)
   ...
   var data3 = google.visualization.arrayToDataTable([
      ['Industry','deal','year1','year2']
          <?php 
              ...
              if(count($deal)>0){ foreach($deal as $Stage => $values)
              { 
                    $sumdeal=0;
              ?>  ,[ <?php echo "'".$Stage."'".",";
                       for($i=$fixstart;$i<=$fixend;$i++)
...
"#967855","#816346","#725e46","#625645","#504941","#EAB875","#DCBB93","#C18842","#6C5536"]*/});
  ...
  divheight=  document.getElementById("visualization").offsetHight;
        // Create and populate the data table.
          ...
          var data1 = google.visualization.arrayToDataTable([
            ['Year'<?php if(count($deal)>0){foreach($deal as $range => $values)
                      { 
                          echo ",'".$range."'";
            }}?>]
                       <?php
                       for($i=$fixstart;$i<=$fixend;$i++)
                        {
                        ?>   ,["<?php echo $i; ?>"
                             <?php if(count($deal)>0){foreach($deal as $range => $values)
                            {?>,<?php echo ($values[$i]['dealcount']!="")?$values[$i]['dealcount']:0;
                             }}?>]
                           <?php 
                             }
...
"#967855","#816346","#725e46","#625645","#504941","#EAB875","#DCBB93","#C18842","#6C5536"]*/});
  ...
  divheight=  document.getElementById("visualization").offsetHight;
        // Create and populate the data table.
          ...
          var data1 = google.visualization.arrayToDataTable([
            ['Year'<?php if(count($deal)>0){foreach($deal as $InvestorTypeName => $values)
                      { 
                       ...
                       for($i=$fixstart;$i<=$fixend;$i++)
                        {
                        ?>   ,["<?php echo $i; ?>"
                             <?php if(count($deal)>0){foreach($deal as $InvestorTypeName => $values)
                            {?>,<?php echo ($values[$i]['dealcount']!="")?$values[$i]['dealcount']:0;
                             }}?>]
                           <?php 
                             }
...
"#967855","#816346","#725e46","#625645","#504941","#EAB875","#DCBB93","#C18842","#6C5536"]*/});
  ...
  divheight=  document.getElementById("visualization").offsetHight;
        // Create and populate the data table.
          ...
          var data1 = google.visualization.arrayToDataTable([
            ['Year'<?php if(count($deal)>0){foreach($deal as $region  => $values)
                      { 
                          echo ",'".$region."'";
            }}?>]
                       <?php
                       for($i=$fixstart;$i<=$fixend;$i++)
                        {
                        ?>   ,["<?php echo $i; ?>"
                             <?php if(count($deal)>0){foreach($deal as $region => $values)
                            {?>,<?php echo ($values[$i]['dealcount']!="")?$values[$i]['dealcount']:0;
                             }}?>]
                           <?php 
                             }

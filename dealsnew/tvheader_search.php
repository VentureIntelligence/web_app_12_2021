...
<label  id="vctour4"><input class="investment-nav" name="investments" type="radio" data-name="INVESTMENT - SOCIAL" value=3  <?php if($vcflagValue==3) { ?> checked="checked" <?php } ?>/>Social</label></div>
</div>
...
<h3 id="investmenttype">INVESTMENTS - VC</h3>
<?php }elseif($_GET['value']==3){ ?>
<h3 id="investmenttype">INVESTMENTS - SOCIAL</h3>
<?php }elseif($_GET['value']==4){ ?>
<h3 id="investmenttype">INVESTMENTS - CLEANTECH</h3>
<?php }elseif($_GET['value']==5){ ?>
<h3 id="investmenttype">INVESTMENTS - INFRASTRUCTURE</h3>
<?php }
else{ ?>
    <h3 id="investmenttype">INVESTMENTS - PE</h3>
<?php }    ?>

...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="myTable">
              <thead><tr>
                ...
                <th class="alignr header <?php echo ($orderby=="amount" ||$orderby=="hideamount,amount")?$ordertype:""; ?>" id="amount">Amount(US$M)</th>
                </tr></thead>
              <tbody id="movies">
						<?php
						if ($company_cnt>0)
						   ...
						   While($myrow=mysql_fetch_array($companyrs, MYSQL_BOTH))
                                                    {
                                                           ...
                                                           $hideFlagset = 0;$hideBracketRow = false;
                                            ...
                                            <?php
                                                            if(($compResult==0) && ($compResult1==0))
                                                            {
                                                                    ...
                                                                    $icount++;
                                            ?>
                                                            <td ><a class="postlink" href="dealdetails.php?value=<?php echo $myrow["PEId"];?>/<?php echo $vcflagValue;?>/<?php echo $searchallfield;?> "><?php  echo $openDebtBracket;?><?php echo $openBracket ; ?><a class="postlink" href="dealdetails.php?value=<?php echo $myrow["PEId"];?>/<?php echo $vcflagValue;?>/<?php echo $searchallfield;?> "><?php echo trim($myrow["companyname"]);?> </a> <?php echo $closeBracket ; ?><?php echo $closeDebtBracket;?></a></td>
                                            <?php
                                                            }
                                                            else
                                                            {

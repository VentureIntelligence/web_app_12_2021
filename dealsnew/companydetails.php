...
//              / echo "adsasd";
    ...
    <div class="lb" id="popup-box" style="z-index: 11111;">
                                        ...
                                        <h2 id="companyinfo" class="box_heading content-box ">Investments and Exits Snapshot</h2>
                                         ...
                                         <div class="accordions_dealcontent" style="padding-top: 20px;">
                                            ...
                                            <ul class="tabView">
                                                <?php
                                                if($incubator_cnt>0) { ?> 
                                                    <li href="#incubation">Incubators</li>
                                                <?php } ?>
                                                <?php
                                                if($angel_cnt>0) { ?> 
                                                ...
                                                <?php
                                                if($investor_cnt>0) { ?> 
                                                    <li href="#investments" class="current">PE/VC Investors</li>
                                                <?php } ?>
                                                <?php
                                                ...
                                                <div id="incubation" class="tab-items">
                                                    <?php
                                                       ...
                                                       <div  class="col-md-6">
                                                        ...
                                                        <thead><tr><th>Incubators</th></tr></thead>
                                                            <tbody>
                                ...
                                <?php
                                                    ...
                                                    { 
                                                        if(!in_array($myrow1["PECompanyId"], $company_id)){                                    
                                                            ...
                                                            <div style="display:inline-block;margin: 8px 0px;font-weight: 600;">

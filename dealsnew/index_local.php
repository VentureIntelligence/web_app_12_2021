...
echo 'Hello';
echo '<pre>'; print_r($listallcompany); echo '</pre>';
...
if (trim($buttonClicked == "")) {
    ...
    $exportsql = $companysql;
     ...
     echo 'listallcompany'.$listallcompany.'<br/>';

    echo 'ComapnySql'.$companysql.'<br/>';

    echo 'listallcompaniesName : '.$_POST['listallcompanies'].'<br />';
    ...
    if ($companyrsall = mysql_query($companysql)) {
        ...
        echo 'ComapnyCount'.$company_cntall.'<br />';
...
if ($listallcompany != 1) {
    ...
    ?>
       <div class="include" style="float: left; margin-bottom:10px;margin-top:15px;">
                          ...
                          <input type="checkbox" name="listallcompanies" id="Listall"  class="listall" value="1" <?php if ($listallcompany == 1) {echo "checked";}?>/>
                                      <b class="blinktext">Include Deals that are not counted for aggregate data calculation 123</b>
...
echo 'else';
                              ?>
                            <div class="include" style="float: left; margin-bottom:10px;margin-top:15px;">
                          <label style="font-size:13px;    float: left;" ><input type="checkbox" name="listallcompanies" id="Listall"  class="listall" value="2" <?php if ($listallcompany == 1) {echo "checked";}?>/>
                                      <b >  Include Deals that are not counted for aggregate data calculation 456</b>
                           <a style="margin-top: 0px !important;cursor: pointer;  float: right !important;" class="help-icon tooltip"><img width="18" height="18" border="0" src="images/help.png" alt="" style="vertical-align:middle">
                                <span style="width: 25%;">
                                <img class="showtextlarge" src="images/callout.gif" style="left: 5px;">
                                Target/Company in () indicates the deal is not to be used for calculating aggregate data owing to the it being a tranche / not meeting Venture Intelligence definitions for PE.
...
<div class=""></div>
            ...
            <input type="hidden" name="listallcompanies1" value=<?php echo $listallcompany; ?> >
...
<?php } */?>
    ...
    <input type="hidden" name="txtsearchon" value="1" >
            <input type="hidden" name="vcflagValue" value=<?php echo $vcflagValue; ?> >
            <input type="hidden" name="txtmonth1" value=<?php echo $month1; ?> >
            <input type="hidden" name="listallcompanies2" value=<?php echo $listallcompany; ?> >
            <input type="hidden" name="debt_equity" value=<?php echo $debt_equity; ?> >
            <input type="hidden" name="companyType" value=<?php echo $companyType; ?> >
            <input type="hidden" name="countryid" value=<?php echo $investor_head; ?> >
            <input type="hidden" name="invandor" value=<?php echo $invandor; ?> >

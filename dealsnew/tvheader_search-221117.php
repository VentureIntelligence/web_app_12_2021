...
<li ><div style="float:right;padding: 9px 15px" class="key-search"><b></b> <input  autofocus="autofocus" type="text" id="searchallfield" name="searchallfield" placeholder=" Keyword Search"

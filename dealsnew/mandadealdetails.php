...
include_once($refineUrl); ?>
 ...
 <?php
        ...
        investortype as its,stage as s
         ...
         $sql="SELECT pe.PECompanyId, pe.price_to_book, pe.book_value_per_share, pe.price_per_share, pec.companyname, pec.industry as industryId, i.industry, pec.sector_business,
                 pe.DealAmount, DATE_FORMAT( DealDate, '%M-%Y' ) as dt, pec.website,pec.linkedIn, pec.city,
                ...
                pec.uploadfilename,pe.source,pe.Valuation,pe.FinLink,pe.Company_Valuation,pe.Revenue_Multiple,pe.EBITDA_Multiple,pe.PAT_Multiple,pe.ExitStatus,pe.Revenue,pe.EBITDA,pe.PAT,pe.stakeSold,pec.CINNo, pec.Address1, pec.Address2, pec.Telephone,pec.Email,pec.tags,pec.state,pec.RegionId,pec.countryid
...
*/
        $onMgmtSql="select pec.PECompanyId,mgmt.PECompanyId,mgmt.ExecutiveId,
                        exe.ExecutiveName,exe.Designation,exe.Company from
                        pecompanies as pec,executives as exe,pecompanies_management as mgmt, manda as pe
        where pe.MandAId='$SelCompRef' and  pec.PEcompanyID = pe.PECompanyID and mgmt.PECompanyId=pec.PECompanyId and exe.ExecutiveId=mgmt.ExecutiveId";
                            ...
                            <div class="title-links">
                                ...
                                if(($exportToExcel==1))
                                     ...
                                     <?php
                                                         ...
                                                         <a class ="export" id="expshowdeals" target="_blank" href=<?php echo "'".$samplexls."'";?>  style='float:right;padding: 7px 10px !important;'><!-- <span class="download-icon"></span> -->Sample Export</a>
                                 <?php } ?>
                             </div>
    ...
    <div class="list-tab mt-list-tab " style="background: #fff !important;">
                <?php
                      ...
                      <?php
                           ...
                           ?>
                           <div>
                             <?php  if($vcflagValue=="0-0" || $vcflagValue=="0-1" || $vcflagValue=="0-2" || $vcflagValue=="1-1" || $vcflagValue=="1-0")
                    {
                        $actionlink1="mandaindex.php?value=".$vcflagValue;
                    }
                   
                    ?>
                      <ul class="inner-list inner-list_width1">
                        <li><a class="postlink list-view"  href="<?php echo $actionlink1; ?>"  id="icon_grid-view"><!--<img src="images/list-icon.png" />--><i></i> <!-- List View --></a></li>
                        <li class="active"><a id="icon_detailed-view" class="postlink detail-view"  href="mandadealdetails.php?value=<?php echo $_GET['value'];?>" ><!--<img src="images/bar-icon.png" />--><i></i> <!-- Detail View --></a></li> 
                        </ul> 
            ...
            //if($strvalue[3]!='Directory'){ ?>
                    ...
                    <div class="inner-section inner-section-width1 redirection-icon">
                        ...
                        <?php if ($prevKey!='-1') {?> 
                            <a  class="postlink" id="previous" href="mandadealdetails.php?value=<?php echo $prevNextArr[$prevKey]; ?>/<?php echo $VCFlagValue;?>/"> 
                        ...
                        <?php if ($nextKey < count($prevNextArr)) { ?>
                            <a class="postlink" id="next" href="mandadealdetails.php?value=<?php echo $prevNextArr[$nextKey]; ?>/<?php echo $VCFlagValue;?>/">
       ...
       <div class="row section1" style="    display: inline-flex;">
        ...
        <div  class="work-masonry-thumb1 col-p-8 dealinfo" id="deal_info" style="background: #f4f4f4 !important">
                ...
                <!-- SHP Valid -->
                    ...
                    ?>
                    <div class="linkfillings"><a href="pefillings_shp.php?cname=<?php echo $myrow['companyname'];?>&value=<?php echo $value;?>&location_cont=<?php echo $_GET['value']; ?>" class="postlink">Filings / SHP</a></div>
                    <?php } ?>
                    <!-- End SHP Valid -->
                    <div class="accordions_dealtitle"><span></span>
            ...
            <tr>
                <td id="tourinvestor">
                    <h4>Deal Size (US $M) </h4>
                </td>
                <td id="tourinvestor" class="">
                    <p>
                     <?php if($myrow["DealAmount"]==1){   ?>
                          <?php echo $hideamount;?> 
                     <?php } else { ?>
        ...
        <?php 
         ...
         <tr>
              ...
              <td class="">
                        <p><?php echo $exitstatusdisplay;?></p>
                </td> 
            </tr>
            <?php } ?> 
          <tr>
              <td><h4>Deal Period</h4></td>
        ...
        <tr>
         ...
         <?php if($myrow["stakeSold"]!="" && $myrow["stakeSold"] > 0) {?>
         <tr>
                <td><h4>Stake Sold</h4></td> 
                <td class=""><p>
               <?php
                        echo $myrow["stakeSold"].' %';
                    ?> </p></td> 
            </tr>
        <?php } ?>
        <?php if($myrow["DealType"]!="") {?>
        <tr>
              <td><h4>Deal Type</h4></td>
      <td class=""><p><?php echo $myrow["DealType"];?></p></td>
          </tr>
          <?php } ?>
               ...
               <tr>
                ...
                <td><p>
                     <?php   if($myrow["type"] == 1){ $type_val = "IPO"; } else if($myrow["type"] == 2){ $type_val = "Open Market Transaction"; }else if($myrow["type"] == 3){ $type_val = "Reverse Merger";}else{ $type_val = "Open Market Transaction"; }
                        ?><?php echo $type_val;?></p>
                        </td>
                         <?php } ?>
          </tr>
                          ...
                          <div id="exitinvestments" >
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0" class="tableview tableInvest">
                                                            ...
                                                            <tbody>
                                                                 <?php
                                                                    ...
                                                                    While($myInvestorrow=mysql_fetch_array($irrcompanyrs, MYSQL_BOTH))
                                                                            {
                                                    ...
                                                    <?php } else {?>
                                                         <table width="100%" cellspacing="0" cellpadding="0" class="tableview tableInvest">
                                                            <tbody>
                                                             <tr>
                                                                <td style="border-bottom: none !important;background-color: #fff;">
                ...
                <div  class="work-masonry-thumb1 accordian-group" >
                     <div class="accordions">
                        ...
                        <!--  <?php if($field_class_pre !=0 || $field_class_post !=0 || $field_class_ev !=0 ){ ?>
                         ...
                         <!-- <div class="accordions_dealcontent"> -->
                            <div class="accordions_dealtitle active"><span></span>
                                <h2 id="companyinfo" class="box_heading content-box ">Investment Details</h2>
                            </div>
                            <div class="accordions_dealcontent" style="display: none;">
                ...
                if($investmentdeals !=""){?>
                                   <tr>
                                       <td style="background-color: #fff;">
                                           <p ><?php print nl2br($investmentdeals) ;?></p>
                                       </td>
                                   </tr>
                            <?php    } else{?>
                                 <tr>
                                        <td style="background-color: #fff;"><p class="text-center">No data available</p></td>
                                    </tr>
                            <?php }?>
                     ...
                     <div class="accordions">
                        ...
                        <h2 id="companyinfo" class="box_heading content-box ">Financials</h2>
                         ...
                         <div class="accordions_dealcontent" style="display: none;">
                           <table cellpadding="0" cellspacing="0" class="tableInvest tableValuation">
                                <tbody>
                                <?php if(($dec_company_valuation1 >0 && $dec_revenue_multiple1 >0 && $dec_ebitda_multiple1 >0 && $dec_pat_multiple1 >0)||(($dec_revenue > 0 || $dec_revenue < 0) || ($dec_ebitda > 0 || $dec_ebitda < 0) || ($dec_pat > 0 || $dec_pat < 0))){?>
                            <tr class="tableValuationwidth">
                                        <td id="tourinvestor" class="<?php echo $valuation_label; ?>">
                                            <h4>Revenue</h4>
                                        </td>
                                        ...
                                        {
                                        ?>
                                        <td  style='width:30%'><p><?php echo $dec_revenue ;?></p></td>
                                         <?php
                                        }
                                        else{
                                            if($dec_company_valuation1 >0 && $dec_revenue_multiple1 >0){
                                               
                                           ?>      
                                            <td  style='width:30%'><p><?php echo  number_format($dec_company_valuation1/$dec_revenue_multiple1, 2, '.', ''); ?></p></td>
                                         <?php       
                                            }else{
                                    ...
                                    <tr class="tableValuationwidth">
                                        <td id="tourinvestor" class="<?php echo $valuation_label; ?>" >
                                         ...
                                         <?php if($dec_ebitda > 0 || $dec_ebitda < 0)
                                            {
                                            ?>
                                            <td  style='width:30%'><p><?php echo $dec_ebitda ;?></p></td>
                                             <?php
                                            }
                                            else{
                                                if($dec_company_valuation1 >0 && $dec_ebitda_multiple1 >0){
                                               ?>      
                                               <td  style='width:30%'><p><?php echo  number_format($dec_company_valuation1/$dec_ebitda_multiple1, 2, '.', '');
                                                ?></p></td>
                                             <?php       
                                                }else{
                                                    echo "<td style='width:30%'></td>";
                                    ...
                                    <tr class="tableValuationwidth">
                                        ...
                                        <?php if($dec_pat > 0 || $dec_pat < 0)
                                            {
                                            ?>
                                            <td  style='width:30%'><p><?php echo $dec_pat ;?></p></td>
                                             <?php
                                            } 
                                            else{
                                                if($dec_company_valuation1 >0 && $dec_pat_multiple1 >0){
                                            ?>      
                                               <td  style='width:30%'><p><?php echo number_format($dec_company_valuation1/$dec_pat_multiple1, 2, '.', ''); ?></p></td>
                                             <?php       
                                            }
        ...
        <div class="row masonry ">
            ...
            <div  class="work-masonry-thumb1 accordian-group" >
                     <div class="accordions">
                        <div class="accordions_dealtitle active"><span></span>
                        <h2 id="companyinfo" class="box_heading content-box ">Advisor Info (Buyer) </h2>
                        </div>
                         <div class="accordions_dealcontent" style="display: none;">
                            ...
                            <table cellspacing="0" cellpadding="0" class="tableInvest advisor_Table">
                               ...
                               <?php if(mysql_num_rows(mysql_query($adacquirersql))>0){ ?>  
                                        ...
                                        <tr>
                                            ...
                                            <td style="">
                                                <table cellspacing="0" cellpadding="0" class="tableInvest" style="margin-left: 25px;width:98%;">
                                                    <tbody>
                                                                ...
                                                                <table class="advisor_innerTable">
                                                                       ...
                                                                       <tr>
                                                                        ...
                                                                        ?>
                                                                           ...
                                                                           <p> <a class="postlink" href='advisor.php?value=<?php echo $myadinvrow["CIAId"];?>/2/<?php echo $flagvalue?>' target="_blank" style="color: #666 !important;">
                                                                            <?php echo $myadinvrow["cianame"]; ?></a>  (<?php echo $myadinvrow["AdvisorType"];?>)</p>
                                                                            <?php
            ...
            <div  class="work-masonry-thumb1 accordian-group" >
                     <div class="accordions">
                        <div class="accordions_dealtitle active"><span></span>
                        <h2 id="companyinfo" class="box_heading content-box ">Advisor Info (Seller)</h2>
                        </div>
                         <div class="accordions_dealcontent" style="display: none;">
                            ...
                            <table cellspacing="0" cellpadding="0" class="tableInvest advisor_Table">
                               ...
                               <?php if($comp_cnt>0 || $compinv_cnt>0){ ?>  
                                <?php if($comp_cnt>0) { ?>
                                        <tr>
                                           <!--  <td style="width: 20%;">
                                                                              <h4 style="padding: 10px 0px;">To Company</h4></td> -->
                                            <td style="">
                                                <table cellspacing="0" cellpadding="0" class="tableInvest" style="margin-left: 25px;width:98%;">
                                                    <tbody>
                                                                   ...
                                                                   <!--  <?php $firstChild = 0; While($myadcomprow=mysql_fetch_array($getcompanyrs, MYSQL_BOTH)) { ?>
                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        ?>
                                                                           ...
                                                                           <p> <a class="postlink" href='advisor.php?value=<?php echo $myadcomprow["CIAId"];?>/2/<?php echo $flagvalue?>' target="_blank" style="color: #666 !important;" >
                                                                            <?php echo $myadcomprow["cianame"]; ?></a>  (<?php echo $myadcomprow["AdvisorType"];?>)</p>
                                                                            <?php
...
<input type="hidden" name="period_flag" id="period_flag" value="<?php echo "2" ?>" />
...
<form action="<?php echo $actionlink1; ?>" name="tagForm" id="tagForm"  method="post">
 ...
 <!-- <form name="companyDisplay" method="post" id="exportform" action="exportdealinfo.php"> -->
    <form name="companyDisplay" method="post" id="exportform" action="exportmanda.php">
               ...
               // alert($('[name="'+fieldname+'"]').val());
                ...
                function resetmultipleinput(fieldname,fieldid,indexflagvalueid)
                {
                 ...
                 // if(indexflagvalueid == 0 || indexflagvalueid == 1){
                      hrefval= 'mandaindex.php?value='+indexflagvalueid;

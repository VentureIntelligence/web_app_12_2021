...
var tour = {
  ...
  ///////////////// PE Tour /////////////////
    ...
    { //19
      ...
      content: 'To view the subset of Venture Capital transactions along with related databases on Social VC / Impact Investments, Angel Investments, Incubation, etc, Please select the VC option here.',
      xOffset: -5,
      width: 450,
      zindex:1000,
      fixedElement: true, 
      ...
      showNextButton : false,
      onShow:function(){
         lockControls(["#investmentswitch"],'To proceed, select the "Venture Capital" option under PE/VC Investments');
         warmsg = 'To proceed, select the "Venture Capital" option under PE/VC Investments';

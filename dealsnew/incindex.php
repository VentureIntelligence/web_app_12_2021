                    ...
                    ?>
                            <div>
                             <span>
                                ...
                                <a class ="export" target="_blank" href="../Sample_Sheet_Investments.xls"> Export Sample</a>
                                </span>
                                <script type="text/javascript">
                                            $('#exportbtn').html('<a class="export"  href="../Sample_Sheet_Investments.xls">Export Sample</a>');
                                </script>
                             </span>
                            </div>

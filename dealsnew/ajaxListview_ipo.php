...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="myTable">
              <thead><tr>
                ...
                <th class="alignr header <?php echo ($orderby=="IPOSize" || $orderby=="hideamount,IPOSize")?$ordertype:""; ?>" id="IPOSize">IPO Size (US$ M)</th>
                </tr></thead>
                        ...
                        if ($company_cnt>0)
                          {
                             ...
                             While($myrow=mysql_fetch_array($companyrs, MYSQL_BOTH))
                             {
                              $hideFlagset = 0;
                                    ...
                                    if( in_array( $myrow["IPOId"], $uncheckArray ) ) {
                                        $rowClass = 'event_stop';
                                    } else {
                                        $rowClass = '';
                                    }
                          ...
                          <tr class="details_link <?php echo $rowClass; ?>" valueId="<?php echo $myrow["IPOId"];?>/<?php echo $vcflagValue;?>/<?php echo $searchallfield;?>">
                            ...
                            <?php 
                                if( $searchallfieldFlag != '' ) {
                                   /* if( in_array( $myrow["IPOId"], $uncheckArray ) ) {
                                    ...
                                    if(count($uncheckArray) > 0 && $uncheckArray[0]!='' &&  count($checkedArray) > 0 && $checkedArray[0]!=''){
                                            ...
                                            elseif( (in_array( $myrow["IPOId"], $checkedArray )) ) {
                                                    $checked = 'checked';
                                                    $rowClass = '';
                                    ...
                                    elseif(count($uncheckArray) > 0 && $uncheckArray[0]!=''){
                                        ...
                                        if( (in_array( $myrow["IPOId"], $checkedArray )) ) {
                                            $checked = 'checked';
                                            $rowClass = '';
                                ...
                                //=================================================================================================       
                            ?>
                            <td><input type="checkbox" data-deal-amount="<?php echo $myrow['IPOSize']; ?>" data-hide-flag="<?php echo $hideFlagset; ?>" data-company-id="<?php echo $myrow[ 'PECompanyId' ]; ?>" class="pe_checkbox" <?php echo $checked; ?> value="<?php echo $myrow["IPOId"];?>" /></td>
                            <?php
                                }
                            ?>

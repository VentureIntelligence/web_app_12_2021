...
<form name="addinvmgmt" method="post" action="addAdvisors_meracq.php">
...
<p > <b><center> <font style="font-family: Verdana; font-size: 10pt">Add Advisors - Target & Acquirer</font> </b></center></p>
...
function inst_advisor_investors($mamaid,$ciaId)
{
	...
	$insExecmgmtSql = "insert into mama_advisoracquirer values ($mamaid,$ciaId)";
		echo "<br>Ins Advisor Acquirer-  ". $insExecmgmtSql;
...
function inst_advisor_companies($MAMAId,$ciaId)
{
	...
	$insExecbrdSql = "insert into mama_advisorcompanies values ($MAMAId,$ciaId)";
		echo "<br>Ins Advisor Target-  ". $insExecbrdSql;

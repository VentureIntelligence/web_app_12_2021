...
<form name="addREcompBoardMgmt" method="post" action="addREcompBoardMgmt.php">
...
<p > <b><center> <font style="font-family: Verdana; font-size: 10pt">Add RE Board Executive(s)</font> </b></center></p>
...
<p > <b><center> <font style="font-family: Verdana; font-size: 10pt">Add RE Management Executive(s)</font> </b></center></p>
...
function inst_companies_managment($investorId,$executiveId)
{
	...
	$insExecmgmtSql = "insert into REcompanies_management values ($investorId,$executiveId)";
		echo "<br>Ins RE Mgmt-  ". $insExecmgmtSql;
...
function inst_companies_board($investorId,$executiveId)
{
	...
	$insExecbrdSql = "insert into REcompanies_board values ($investorId,$executiveId)";
		echo "<br>Ins into RE Company Board-  ". $insExecbrdSql;

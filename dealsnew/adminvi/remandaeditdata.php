...
$SelCompRef=$value;
   	$getDatasql = "SELECT pe.PECompanyId, pec.companyname, pec.industry, i.industry, pec.sector_business,
      	 ...
      	 Validation,hideamount,hidemoreinfor,pe.DealTypeId,dt.DealType,pe.AcquirerId,pe.Link,InvestmentDeals,EstimatedIRR,MoreInfoReturns,
	  ...
	  if($company_cnt > 0)
	{
		...
		$acquirerID=$mycomprow["AcquirerId"];
			...
			if($acrs=mysql_query($acquirerSql))
			{
			 ...
			 $advacquirersql="select advinv.PEId,advinv.CIAId,cia.cianame from REinvestments_advisoracquirer as advinv,
							...
							<td >
								...
								$strAdvComp="";
								  ...
								  if ($rsAdvisorCompany = mysql_query($advcompanysql))
								  {
									...
									{
										$strAdvComp=$strAdvComp.",".$myInvrow["cianame"];
									?>
								<tr><td >
							...
							<td >
								...
								$strAdvComp="";
								  ...
								  if ($rsAdvisorAcquirer = mysql_query($advacquirersql))
								  {
									...
									{
										$strAdvAcq=$strAdvAcq.",".trim($myInvrow["cianame"]);
									?>
								<tr><td >

							...
							if (trim($portfoliocompany) !="")
							{
								...
								if ($companyId >0)
								{
									...
									if($investment_cnt==0)
									{
											...
											$insertcompanysql="";
											$insertcompanysql= "INSERT INTO angelinvdeals (AngelDealId,InvesteeId,DealDate,MultipleRound,FollowonVCFund,Exited,Comment,MoreInfor,Validation,Link,Deleted)
											VALUES ($PEId,$companyId,'$fullDateAfter',$multipleround,$followonfund,$exitedvalue,'$comment','$moreinfor', '$validation','$link',$flagdeletion)";

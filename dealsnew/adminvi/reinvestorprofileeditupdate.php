...
<form name="reinvestorprofileeditupdate" >
...
<?php
	...
	$Db = new dbInvestments();
    	...
    	// echo "<br>----" .$mgmtExecutiveName;
    	 ...
    	 $UpdatecompanySql="Update REinvestors set Investor='$companyNameToUpdate',Address1='$address1ToUpdate',Address2='$address2ToUpdate',
    	 City='$adCityToUpdate',Zip='$zipToUpdate',Telephone='$telToUpdate',Fax='$faxToUpdate',
    	 Email='$emailToUpdate',website='$websiteToupdate',
    	 ...
    	 AdditionalInfor='$addinforToUpdate',Comment='$commentToUpdate',countryid='countryidToUpdate'
			...
			if($updaters=mysql_query($UpdatecompanySql))
			{
				...
				for ($i=0;$i<=$mgmtExecutiveIdArray-1;$i++)
				{
					...
					else
					{
						...
						$DeleteMgmtSql="Delete from REinvestors_management where ExecutiveId=$exeId and InvestorId=$companyIdtoUpdate";

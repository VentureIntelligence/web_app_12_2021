...
<?php
	...
	session_start();
		if (session_is_registered("SessLoggedAdminPwd") && session_is_registered("SessLoggedIpAdd"))
		{
			...
			$searchTitle = "List of RE Companies ";

			$compsearch=$_POST['companysearch'];
			if(trim($compsearch)=="")
			//	$getcompSql="select * from REcompanies order by companyname";
				$getcompSql="SELECT DISTINCT pe.PECompanyId, pec.*
			...
			elseif(trim($compsearch)!="")
				$getcompSql="select c.PECompanyId,c.companyname from REcompanies as c where companyname like '%$compsearch%' order by companyname";
  ...
  <SCRIPT>
   call()
	...
	<div style="width:565px; float:left; padding-left:2px;">
	  <div style="background-color:#FFFFFF; width:565px; height:405px; margin-top:5px;">
	    <div id="maintextpro">
		...
		<?php
		           ...
		           ?>
					...
					<div style="width: 542px; height:305px; overflow: scroll;">
								...
								<tr><th> RE Companies</th></tr>
						<?php
						   While($myrow=mysql_fetch_array($companyrs, MYSQL_BOTH))
							{
							 ?>
							<tr><Td>
							<A href="recompanyprofileedit.php?value=<?php echo $myrow["PECompanyId"];?> "
						   target="popup" onclick="MyWindow=window.open('recompanyprofileedit.php?value=<?php echo $myrow["PECompanyId"];?>', 'popup', 'scrollbars=1,width=600,height=500');MyWindow.focus(top);return false">
		...
		<div id="headingtextproboldbcolor">&nbsp; No. of Companies  - <?php echo $totalInv; ?>    </div>

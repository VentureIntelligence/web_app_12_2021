...
function deleteMembers()
{
	...
	var chk2;
//	alert('sowmya');
		var e=document.getElementsByName("DelEmailId[]");
		var f=document.getElementsByName("MADelEmailId[]");
		var g=document.getElementsByName("REDelEmailId[]");
	//	alert(f.length);
	    ...
	    for(var j=0;j<f.length;j++)
				...
				//	alert(chk1);
					...
					{
						f[j].checked=true;
						document.companyedit.action="deletemembers.php";
...
<link href="../dealsnew/vistyle.css" rel="stylesheet" type="text/css">
</head>
<body>
...
<!--   <SCRIPT LANGUAGE="JavaScript1.2" SRC="../top1.js"></SCRIPT>
 ...
 onmouseover="this.style.background='red';" onmouseout="this.style.background=''" /> --><br /><br />
		...
		?>
			...
			<input type="button"  value="Delete Members" name="deleteMember" onClick="deleteMembers();">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

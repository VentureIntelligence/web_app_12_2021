...
<?php
	...
	$Db = new dbInvestments();
		...
		// 			echo "<br>**********--Count--".$arraylengthcount;
    	 ...
    	 $UpdatecompanySql="update REcompanies set companyname='$companyNameToUpdate',industry=$industryIdtoUpdate,sector_business='$sectorToUpdate',
    	 city='$adCityToUpdate',website='$urlToUpdate',stockcode='$stockToUpdate',yearfounded='$yearfoundedToUpdate',

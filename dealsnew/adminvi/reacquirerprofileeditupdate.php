...
<p > <b><center> <font style="font-family: Verdana; font-size: 10pt">Edit RE Acqiorer Profile</font> </b></center></p>
<p></p><p></p>
...
<?php
	...
	$Db = new dbInvestments();
    	...
    	// echo "<br>----" .$mgmtExecutiveName;
    	 ...
    	 $UpdatecompanySql="Update REacquirers set Acquirer='$companyNameToUpdate',IndustryId=$industryidtoUpdate,Sector='$sectortoUpdate',Address='$address1ToUpdate',Address1='$address2ToUpdate',
    	 ...
    	 Email='$emailToUpdate',Website='$websiteToupdate', OtherLocations='$otherLocationToUpdate',
			...
			if($updaters=mysql_query($UpdatecompanySql))
			{
				...
				for ($i=0;$i<=$mgmtExecutiveIdArray-1;$i++)
				{
					...
					else
					{
						...
						$DeleteMgmtSql="Delete from REacquirer_management where ExecutiveId=$exeId and AcquirerId=$acquirerIdtoUpdate";

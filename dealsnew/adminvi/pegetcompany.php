...
<?php
	...
	session_start();
		if (session_is_registered("SessLoggedAdminPwd") && session_is_registered("SessLoggedIpAdd"))
		{
			...
			if(trim($compsearch)=="")
				$getcompSql="select distinct c.PECompanyId,c.companyname from pecompanies as c
				order by companyname";
			elseif(trim($compsearch)!="")
				$getcompSql="select distinct c.PECompanyId,c.companyname from pecompanies as c
				where companyname like '%$compsearch%' order by companyname";
   ...
   call()
	...
	<div style="width:565px; float:left; padding-left:2px;">
	  <div style="background-color:#FFFFFF; width:565px; height:405px; margin-top:5px;">
		...
		<div id="headingtextproboldbcolor">&nbsp; No. of Companies  - <?php echo $totalInv; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</div>

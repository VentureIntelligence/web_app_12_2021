	  ...
	  <div style="background-color:#FFF; width:565px; height:405px; margin-top:5px;">
		...
		<?php
			...
			for ($t=0;$t<=$MAMAArrayLength-1;$t++)
				...
				$updateSql="Update dealcompanies set PEInv=$PEInv,VCInv=$VCInv,REInv=$REInv,PEIpo=$PEIpo,VCIpo=$VCIpo,
				PEMa=$PEMa,VCMa=$VCMa,PEDir=$PEDir,VCDir=$CODir,SPDir=$SPDir,MAMA=$MaMa where DCompId=".$CompanyIdtoUpdate ;
				//echo "<br>--" .$updateSql;

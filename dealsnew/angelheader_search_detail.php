...
<link href="css/skin_11.css" rel="stylesheet" type="text/css" />  
...
<ul class="fr">
      ...
      <li ><div style="float:right;padding: 9px 15px" class="key-search"><b></b> <input type="text" id="searchallfield" name="searchallfield" placeholder="Search" value="<?php echo $searchallfield; ?>" style="padding:5px;"  /> 
...
<td class="vertical-form">
    ...
    <h3 id="investmenttype">INVESTMENTS - ANGEL</h3>
...
<SELECT NAME="year1" id="year1" onchange="this.form.submit();">
    <OPTION id=2 value="--"> Year </option>
    <?php 
		/*$yearsql="select distinct DATE_FORMAT( DealDate, '%Y') as Year from angelinvdeals order by DealDate asc";

...
if ($sql != '') {
    ...
    if ($vcflagValue == 0 || $hide_pms==1) {
        ...
        if ($type == 1) {
            ...
            if($hide_pms==1){
                $filename = 'PMS_year.xls'; //save our workbook as this file name
            }
            else {
                $filename = 'PEMA_year.xls'; //save our workbook as this file name
            }
        } 
        elseif ($type == 2 || $type == 5) {
            ...
            if($hide_pms==1){
                if ($type == 2)
                    $filename = 'PMS_industry.xls'; //save our workbook as this file name
                else
                    $filename = 'PMS_InvestorType.xls'; //save our workbook as this file name
            }
            else {
                
                if ($type == 2)
                    $filename = 'PEMA_industry.xls'; //save our workbook as this file name
                else
                    $filename = 'PEMA_InvestorType.xls'; //save our workbook as this file name
            }
        ...
        elseif ($type == 4) {
            ...
            if($hide_pms==1){
                $filename = 'PMS_Range.xls'; //save our workbook as this file name
            }
            else {
                    $filename = 'PEMA_Range.xls'; //save our workbook as this file name
            }
        }
    }

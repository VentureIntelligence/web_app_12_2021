...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <body >
                        ...
                        <div class="card">
                              <div class="ml-3 mt-3">
                                 ...
                                 <div class="copyright-body mt-2">
                                    ...
                                    <span class="error" id="columnnameErr" name="columnnameErr" style="display:none"> Select atleast one checkbox</span><br>
                           ...
                           <div class="card">
                              <div class="ml-3 mt-3">
                                 ...
                                 <div class="copyright-body mt-2">
                                    <!-- <div class="row"> -->
                                    <h6 class="duration">Select fields for excel file export</h6>
                                    <span class="error" id="exitcolumnnameErr" name="exitcolumnnameErr" style="display:none"> Select atleast one checkbox</span>
                                    <br>
                                    <!-- </div> -->
      ...
      <script>
         ...
         {
         $('#v-pills-messages-tab').trigger('click',['from-outside']);
         ...
         $('#v-pills-profile-tab').trigger('click',['from-outside']);
         ...
         {
         $('.impshowdealsbt').modal('hide')
         swal('You are upload in csv file only ')
         }
             ...
             if(parseInt(year1) == parseInt(year2))
        {
         ...
         url: 'saveFilter.php',
         type: "POST",
         data: {companyName: companyName,start_date:month1,end_date:month2,start_year:year1,end_year:year2,Intype:Intype,dealType:dealType,filterType:filterType,companytype:companytype,investorType:investorType,stage:stage,round:round,exitStatus:exitStatus,
    ...
    className: 'swal-wide',
         ...
         $('#mon2').val(currentMonth);
         var currentYear = (new Date).getFullYear();
         
         $('#yr1').val(1998);
         $('#yr2').val(currentYear)  
         $('#exitmon1').val(1);
         $('#exitmon2').val(currentMonth);
         $('#exityr1').val(1998);

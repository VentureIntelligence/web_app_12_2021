...
//********Mail details
		...
		$subject="IM Rep Download-" .$revenure_range_display."-".$firmname;
		$message="<html><center><b><u>Internet Mobile Report Download</u></b></center><br>
...
?>
	    ...
	    <div id="maintextpro">
           ...
           <div id="headingtextpro">
            <div id="headingtextprobold">PE Pulse on Internet & Mobile<br /></div>
           <!--The PE Pulse Report on Internet Mobile is the first of its kind to bring together the views of PE/VC investors, Entrepreneurs and Advisory Firms. <br /> <br />-->

			<span style="float:right" class="one"> <br/>
		  	<a href="pepulse-im-12.pdf"><img src="images/arrow.gif" border="0" /><b>Click Here</b></a> to access the microsite.<br/> <!--(Recommended: Use Right Click > Save As to download to your desktop)--></span>

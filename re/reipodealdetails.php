<?php
	...
	$SelCompRef=$value;
  	...
  	pe.IPOSize,pe.IPOAmount, pe.IPOValuation, DATE_FORMAT( IPODate, '%M-%Y' ) as IPODate ,pe.ExitStatus,
...
<?php
	$topNav = 'Deals'; 
	include_once('reipoheader_search.php');
?>
...
<?php
           ...
           $pageUrl="reipoindex.php";
           $refineUrl="reiporefine.php";

           include_once('reiporefine.php'); ?>
</div>
 </div>
</td>
...
<td class="profile-view-left" style="width:100%;">
    ...
    <div class="list-tab mt-list-tab">
            <ul>
            <li><a class="postlink"  href="<?php echo $pageUrl; ?>"  id="icon-grid-view"><i></i> List  View</a></li>
    ...
    <div class="view-detailed"> 
         <!--div class="detailed-title-links"> <h2>  <?php echo $myrow["companyname"]; ?></h2-->
             <div class="detailed-title-links"><h2> <A class="postlink" href='recompanydetails.php?value=<?php echo $myrow["PECompanyId"];?>/<?php echo  $SelCompRef2;?>' ><?php echo rtrim($myrow["companyname"]);?></a></h2>
		<?php if ($prevKey!='-1') {?> <a  class="postlink" id="previous" href="reipodealdetails.php?value=<?php echo $prevNextArr[$prevKey]; ?>">< Previous</a><?php } ?> 
        <?php if ($nextKey < count($prevNextArr)) { ?><a class="postlink" id="next" href="reipodealdetails.php?value=<?php echo $prevNextArr[$nextKey]; ?>"> Next > </a>  <?php } ?>
                    </div> 
 ...
 <div class="profilemain">
  ...
  <div class="postContainer postContent masonry-container">
					...
					While($myInvrow=mysql_fetch_array($getcompanyrs, MYSQL_BOTH))
					{
						...
						{
                            ?>                 
					<a class="postlink" href='reinvestordetails.php?value=<?php echo $myInvrow["InvestorId"] ?>/<?php echo  $SelCompRef2;?>' ><?php echo $myInvrow["Investor"]; ?></a><br />
				<?php
						}
     		...
     		<div  class="work-masonry-thumb col-1" href="http://erikjohanssonphoto.com/work/aizone-ss13/">
				...
				<td width="120">
                                    <h4>Company</h4> 
                                    <p><A class="postlink" href='recompanydetails.php?value=<?php echo $myrow["PECompanyId"].'/'.$SelCompRef2;?>' >

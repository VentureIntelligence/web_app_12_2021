...
<td class="profile-view-left" style="width:100%;">
    ...
    <div class="result-title">
                        ...
                        <?php if(!$_POST){?>
                            ...
                            <ul class="result-select">
                                ...
                                <li> 
                                    <?php echo $investorsearch;?><a  onclick="resetinput('investorsearch');"><img src="<?php echo $refUrl; ?>images/icon-close.png" width="9" height="8" border="0"></a>
                                </li>
                                <?php } 
    ...
    <div class="list-tab"><ul>
            ...
            <li class="active"><a id="icon-detailed-view" class="postlink" href="redirmandadeal.php?value=<?php echo $_GET['value'];?>" ><i></i> Detail View</a></li> 
            </ul></div> 
    ...
    <div class="view-detailed"> 
         <!--div class="detailed-title-links"> <h2>  <?php echo $myrow["companyname"]; ?></h2-->
             <div class="detailed-title-links"><h2> <A class="postlink" href='redircomdetails.php?value=<?php echo $myrow["PECompanyId"]."/".$newValue."/";?>' ><?php echo rtrim($myrow["companyname"]);?></a></h2>
		<?php 
               /* if(count($prevNextArr)>0){ 
                    
                    if ($prevKey!='-1') {?> <a  class="postlink" id="previous" href="remandadealdetails.php?value=<?php echo $prevNextArr[$prevKey]."/".$newValue; ?>">< Previous</a><?php } ?> 
      ...
      <div  class="work-masonry-thumb col-1" href="http://erikjohanssonphoto.com/work/aizone-ss13/">
                         ...
                         ?>
                           ...
                           <?php
                                    if ($getcompanyrs = mysql_query($advcompanysql))
                                    {
                                        ...
                                        {
				?>
                                                    <A class="postlink" href='rediradvisor.php?value=<?php echo $myadcomprow["CIAId"]; ?>/<?php echo $vcflagValue;?>/<?php echo $dealvalue;?>' >
                                                    <?php 
				...
				{ ?>
					...
					if ($getinvestorrs = mysql_query($adacquirersql))
					{
                                            ...
                                            { 
                                                ?>
                                            <A class="postlink" href='rediradvisor.php?value=<?php echo $myadinvrow["CIAId"];?>/<?php echo $vcflagValue;?>/<?php echo $dealvalue;?>' >
                                            <?php 
                                            //advisor.php?value=<?php echo $myadinvrow["CIAId"];   /1/<?php echo $flagvalue 
                    ...
                    <tbody> 
                      <tr>  
                        <td width="120"><h4>Company</h4> <p> <?php echo $openBracket;?>
                                <A class="postlink" href='redircomdetails.php?value=<?php echo $myrow["PECompanyId"]."/".$newValue;?>' > <?php echo rtrim($myrow["companyname"]);?></a><?php echo $closeBracket;?>
                                </p>
                        </td>

 ...
 <script>
  ...
  $(function() {
	var keywordsearchbox = $("#keywordsearch").combobox();
        ...
        var acquirersearchbox = $("#acquirersearch").combobox();
	...
	//});
         ...
         keywordsearchbox.on( "comboboxselect", function( event, ui ) {
           ...
           acquirersearchbox.combobox("destroy") ;
           ...
           $("#acquirersearch option:eq(0)").attr('selected','selected');
...
$("#rtour1,#rtour2,#rtour3,#rtour4").click(function() { 
    
     if(demotour==1)
         { 
             $('#rtour2 div').removeClass("checked");         
            $('#rtour3 div').addClass("checked");
            $('#rtour4 div').removeClass("checked");
            $('#rtour1 div').removeClass("checked");
         }
});
...
$('.typeoff-nav2').on('ifChecked', function(event){
     ...
     var value = $(this).val();
      if (value == 1) {
           var hrefval = 'remandaindex.php?type=1';
        ...
        //window.location.assign("trendviewlatest.php?type=1&value=0");
         ...
         var hrefval = 'remandaindex.php?type=2';
                     $('<input>').attr({type: 'hidden',id: 'searchallfield',name: 'searchallfield',value:'<?php echo $searchallfield; ?>'}).appendTo('#pesearch');
                    $("#pesearch").attr("action", hrefval);
                    $("#pesearch").submit();
                    return false;
  ...
  $(".datesubmit").click(function() {
	...
	if(year1 > year2)
	{
        ...
        else if(year1 == year2)
        {
            ...
            {   if(demotour==1)
                {
                     if(!(parseInt(month1)==1 && parseInt(month2)==3 && year1=="2012" && year2=="2012"))
                     {
                         showErrorDialog(warmsg);
                          return false;
                     }
...
<label id="rtour1"><input class="investment-nav" name="investments" type="radio" value=0  /> PE Investments - Real Estate </label>


<label   id="rtour2" ><input class="exist-nav" name="investments" type="radio" value="PE-BACKED-IPO" />PE backed IPO</label>

<label  id="rtour3" ><input class="exist-nav" name="investments" type="radio" value="PE-EXIST" checked="checked" />PE Exits via M&A </label>

<label  id="rtour4" ><input class="exist-nav" name="investments" type="radio" value="VC-EXIST" />Other M&A </label>

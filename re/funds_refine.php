...
<script>
    ...
    /// date search
       ...
       //document.searchall.action = 'refunds.php';
    });
...
<div class="acc_container" >
    <div class="block">
        ...
        <ul>
            ...
            <li class="odd">
<!--            <h4>Type</h4>    <div class="selectgroup">
...
<h4>Sector</h4>
            ...
            <li class="odd range-to"><h4>Size (US $ M)</h4>
                ...
                <SELECT name="sizeend" onchange="submitfilter();"><OPTION id=5 value="" selected>ALL  </option>
                        <?php
                            $counter=0;
                            ...
                            $i=1;
                                While($myrow=mysql_fetch_array($closedstatusrs, MYSQL_BOTH)){
                                    ...
                                    if($_REQUEST['cstatus']!='')
                                    {
                                        ...
                                        echo '<label style="clear:both;"> <input type="checkbox" name="cstatus[]" class="cstatus'.$id.'"  id="cstatus'.$id.'" value="'.$id.'" '.$isselect.'/> '.$name.'</label>';

                                    }
                                    else
                                    {
                                        echo '<label  style="clear:both;"> <input type="checkbox" name="cstatus[]" class="cstatus'.$id.'"  id="cstatus'.$id.'" value="'.$id.'" checked/> '.$name.'</label><br>';
                                    }
                                }
                        } ?>
                </div>

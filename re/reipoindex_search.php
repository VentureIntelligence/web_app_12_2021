...
$('.typeoff-nav2').on('ifChecked', function(event){
     ...
     var value = $(this).val();
      if (value == 1) {
           var hrefval = 'reipoindex.php?type=1';
        ...
        //window.location.assign("trendviewlatest.php?type=1&value=0");
         ...
         var hrefval = 'reipoindex.php?type=2';
                     $('<input>').attr({type: 'hidden',id: 'searchallfield',name: 'searchallfield',value:'<?php echo $searchallfield; ?>'}).appendTo('#pesearch');
                    $("#pesearch").attr("action", hrefval);
                    $("#pesearch").submit();
                    return false;
        //window.location.assign("trendviewlatest.php?type=2&value=0");
                     ...
                     var hrefval = 'reipoindex.php?type=5';
                     $('<input>').attr({type: 'hidden',id: 'searchallfield',name: 'searchallfield',value:'<?php echo $searchallfield; ?>'}).appendTo('#pesearch');
                    $("#pesearch").attr("action", hrefval);
                    $("#pesearch").submit();
                    return false;
...
<!--Header-->
<?php 
    $actionlink="reipoindex.php?value=1";
...
<label><input class="exist-nav" name="investments" type="radio" value="PE-BACKED-IPO" checked="checked"/>PE backed IPO</label>

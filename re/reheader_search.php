...
$(document).ready(function(){
     ...
     $('.investment-nav').on('ifChecked', function(event){
          ...
          <?php if($tour_reinve_page =='reinvestordetails' || $tour_reinve_page =='redealdetails') { ?>
        if(demotour==1)
         {  
...
$("#rtour1,#rtour2,#rtour4").click(function() { 
 ...
 $('.exist-nav').on('ifChecked', function(event){
      ...
      <?php if($tour_reinve_page =='reinvestordetails') { ?>
        if(demotour==1 && navvalue=='PE-EXIST')
         {  
...
<h3> </h3>
<label id="rtour1" ><input class="investment-nav" name="investments" type="radio" value=0 checked="checked"  /> PE Investments - Real Estate </label>

<label  id="rtour2" ><input class="exist-nav" name="investments" type="radio" value="PE-BACKED-IPO" <?php if($newValue=="1") { ?> checked="checked" <?php } ?> id="definition_step2"/>PE backed IPO</label>

<label  id="rtour3" ><input class="exist-nav" name="investments" type="radio" value="PE-EXIST" <?php if($newValue=="2") { ?> checked="checked" <?php } ?> id="definition_step3"/>PE Exits via M&A </label>

<label  id="rtour4" ><input class="exist-nav" name="investments" type="radio" value="VC-EXIST" <?php if($newValue=="3") { ?> checked="checked" <?php } ?> id="definition_step4"/>Other M&A</label>
</td>

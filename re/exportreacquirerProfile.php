 ...
 session_save_path("/tmp");
	...
	$Db = new dbInvestments();
		...
		$mailmessage="";
				...
				$getCompanySql="select ac.*,c.country from REacquirers as ac,country as c where AcquirerId=$AcqId and ac.CountryId=c.countryid";
				 $sql=$getCompanySql;
				//echo "<br>---" .$sql;
				 //execute query
				 ...
				 */
				     ...
				     while($row = mysql_fetch_row($result))
				     {
						...
						$mandasql="select peinv.MAMAId,DATE_FORMAT( peinv.DealDate, '%b-%Y' )as dealperiod,peinv.AcquirerId,
										...
										from acquirers as inv,mama as peinv,pecompanies as c
						...
						if($rsmanda= mysql_query($mandasql))
						{
							...
							{
								$strMandA=$strMandA.", ".$mymandarow["companyname"]."(".$mymandarow["dealperiod"].")";
							}

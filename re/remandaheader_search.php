...
<li <?php echo ($topNav=='Funds') ? 'class="active"' : '' ; ?>><a href="refunds.php" id="refundtour"><i class="i-directory"></i>Funds</a></li>
</ul> -->
<ul class="fr">
...
<label><input class="exist-nav" name="investments" type="radio" value="PE-EXIST" checked="checked" />PE Exits via M&A </label>

<label><input class="exist-nav" name="investments" type="radio" value="VC-EXIST" />Other M&A </label>

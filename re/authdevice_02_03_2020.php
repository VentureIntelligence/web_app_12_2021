...
function sendAuthEmail($companyId,$userEmail,$allowedDevices){
    ...
    $message 	.= "<p><b>Authorization Link:</b> <a href='".BASE_URL."re/auth.php?device=".$_POST['dauth']."&email=".$_POST['user_email']."&device_detail=".$_POST['device_details']."'>".BASE_URL."re/auth.php?device=".$_POST['dauth']."</a></p>";

...
//      Check  Is Trail Login  ?
        ...
        pe.Link,pe.uploadfilename,pe.source,Valuation,FinLink,ProjectName,ProjectDetailsFileName,listing_status
...
<td class="profile-view-left" style="width:100%;">
    ...
    <div class="list-tab  mt-list-tab"><ul>
            ...
            <li class="active"><a id="icon-detailed-view" class="postlink" href="redirdeal.php?value=<?php echo $_GET['value'];?>" ><i></i> Detail View</a></li> 
            </ul></div> 
    ...
    <div class="view-detailed"> 
        ...
        <div class="detailed-title-links"><h2> 
                <a class="postlink" href='redircomdetails.php?value=<?php echo $myrow["PECompanyId"];?>/<?php echo $vcflagValue; ?>/<?php echo $dealvalue; ?>' ><?php echo rtrim($myrow["companyname"]);?></a></h2>
 ...
 <div class="profilemain">
  ...
  <div class="postContainer postContent masonry-container">
      <div  class="work-masonry-thumb col-1" href="http://erikjohanssonphoto.com/work/aizone-ss13/">
		...
		?>
				<td width="120"><h4>Company</h4> <p> <?php echo $openBracket;?><A class="postlink" href='redircomdetails.php?value=<?php echo $myrow["PECompanyId"]; ?>/<?php echo $vcflagValue; ?>/<?php echo $dealvalue; ?>'>

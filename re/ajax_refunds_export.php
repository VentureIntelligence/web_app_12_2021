...
//            $filters.= $filterinvsql." and ";
        ...
        $sqlcapitalsrc = "select * from fundCapitalSource";
         ...
         $sql="SELECT re.InvestorId,re.Investor,fn.fundName,fn.fundId,fd.fundManager,fd.id,DATE_FORMAT( fd.fundDate, '%b-%Y' )as fundDate,fd.size,fts.fundTypeName as stage,fti.REType as sector,frs.fundStatus,fd.fundClosedStatus,fes.closeStatus,fcs.source, fd.moreInfo FROM fundRaisingDetails as fd

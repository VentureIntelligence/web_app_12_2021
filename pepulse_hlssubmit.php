...
filename - pepulse_hlssubmit
invoked from -pepulse_hls.htm  AND pepulse_hls.php ( 2 files)
*/
...
//********Mail details
			$RegDate=date("M-d-Y");
			$to="arun.natarajan@gmail.com,arihant@ventureintelligence.com,vivek@ventureintelligence.com";
		   	//$to .="sowmyakvn@gmail.com";
		$subject="HLS Rep Download-" .$revenure_range_display."-".$firmname;
		$message="<html><center><b><u>Healthcare & Life Sciences Report Download</u></b></center><br>
		<head></head>		<body >
...
?>
	    ...
	    <div id="maintextpro">
           ...
           <div id="headingtextpro">
            <div id="headingtextprobold">PE Pulse Healthcare & Life Sciences<br /> <br /></div>
           The PE Pulse Report on  Healthcare & Life Sciences is the first of its kind to bring together
           the views of  Healthcare & Life Sciences Entrepreneurs, PE/VC investors, Law Firms, Global
           Healthcare & Life Sciences Consultants and Investment Banks. <br /> <br />

			<span style="float:right" class="one">
		  	<a href="pepulse-hls.pdf"><img src="images/arrow.gif" border="0" /> Download this report </a></span>

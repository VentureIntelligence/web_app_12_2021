...
/*
formname - pepulse_edusubmit.php
filename - pepulse_edusubmit
invoked from -pepulse_edu.htm  AND pepulse_edu.php ( 2 files)
*/
...
<!--
    ...
    <?php
				...
				if($revenue_range==1)
					$revenure_range_display="0-5 Cr";
				elseif($revenue_range ==2)
					$revenure_range_display="5-10 Cr";
				elseif($revenue_range ==3)
					$revenure_range_display="10-15 Cr";
				elseif($revenue_range ==4)
					$revenure_range_display="15-25 Cr";
				elseif($revenue_range ==5)
					$revenure_range_display="25-50 Cr";
				elseif($revenue_range ==6)
					$revenure_range_display="> 50 Cr";

//********Mail details

			$RegDate=date("M-d-Y");
			$to="arun.natarajan@gmail.com,weekly@ventureintelligence.com";
		   	//$to .="sow_ram@yahoo.com";
		$subject="VC Newsletter-" .$revenure_range_display."-".$firmname;
		$message="<html><center><b><u>VC Newsletter </u></b></center><br>
...
?>
	    ...
	    <div id="maintextpro">
           ...
           <div id="headingtextpro">
            ...
            Thanks for your interest in receiving the Deal Digest Weekly Newsletter.<br /></div>
           <!--The PE Pulse Report on Education is the first of its kind to bring together the views of Education Entrepreneurs, PE/VC investors, Law Firms, Global Educational Consultants and Investment Banks. Knowledge Partners for this report include Parthenon, India Equity Partners, KPMG and Narasappa, Doraswamy & Raja.<br /> <br />

			<span style="float:right" class="one"> <br/>
		  	<a href="1pepulse-edu.pdf"><img src="images/arrow.gif" border="0" /><b>Click Here</b></a> to download the PDF version.<br/> (Recommended: Use Right Click > Save As to download to your desktop)</span>-->

   ...
   call()
	...
	<div style="width:565px; float:left; padding-left:2px;">
	  ...
	  /* mail */
	  				...
	  				<tr><td > Private Equity</td><td width=64%>$bestfundpe</td></tr>
	  				<tr><td > PE-RE</td><td width=64%>$bestfundre</td></tr>
	    ...
	    <div id="maintextpro">
          <div id="headingtextpro">
		  	...
		  	<br/>Thanks for participating in the APEX Awards process. We will communicate the results to you as soon they are compiled.<br /><br /> <br />

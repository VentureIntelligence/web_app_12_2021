...
?>
		...
		<label>Deal Type </label>	
			<span style="font-family: Verdana,Arial,Helvetica,sans-serif;font-size:11px;"><input type="radio" value="pe" name="deal_type">Private Equity</span>			<span  style="font-family: Verdana,Arial,Helvetica,sans-serif;font-size:11px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" checked="" value="ma" name="deal_type">M&amp;A </span>
...
<div id="tabsmain">
<ul>
<li id="tbs" style="clear:right;"><a href="#tabsmain-1">Transaction</a></li>
<li id="tbs"><a href="#tabsmain-2">Legal</a></li>
<li id="custom" style="float:right;">Advanced Search<img src="media/images/search.png" style="padding-left:4px;width:20px;height:20px;"></li>
...
<table id="box-table-a" class="transcationpe" summary="Employee Pay Sheet">
    <thead>
       ...
       <th colspan="5"><b> Top Advisors - PE </b></th>
    	...
    	<tr>
            <th id="ranktpe" scope="col">Rank</th>            
            <th id="companynametpe" scope="col">Company Name</th>
            <th id="dealstpe" scope="col"># of Deals</th>
            <th id="pointstpe" scope="col">Points</th>
            <th id="amounttpe" scope="col">Amount $M</th>            
        </tr>
    </thead>
    <tbody>

...
<div id="container" style="margin-top: 50px;">
    <div class="result-cnt">
        ...
        <?php 
            ...
            {*/
                ...
                $nanoSql="select * from faq where DBtype='M&A' and status='0' ORDER BY faq_order_no ASC";
                /*echo $nanoSql;
                exit();*/
    ...
    require_once('../dealsnew/aws.php');    // load logins
    require_once('../dealsnew/aws.phar');

...
//                                $cl_count = count($_POST);
    ...
    <div class="list-tab mt-list-tab"><ul>
            <li id="listviewtab"><a class="postlink"  href="<?php echo $actionlink; ?>"  id="icon-grid-view"><i></i> List  View</a></li>
    ...
    <div class="view-detailed"> 
         <div class="detailed-title-links"> <h2>  <?php echo $myrow["companyname"]; ?></h2>
             <!--div class="detailed-title-links"><h2> <A class="postlink" href='companydetails.php?value=<?php echo $myrow["PECompanyId"].'/'.$VCFlagValue.'/';?>' ><?php echo rtrim($myrow["companyname"]);?></a></h2-->
        <?php if ($prevKey!='-1') {?> <a  class="postlink" id="previous" href="madealdetails.php?value=<?php echo $prevNextArr[$prevKey]; ?>">< Previous</a><?php } ?> 
        <?php if ($nextKey < count($prevNextArr)) { ?><a class="postlink" id="next" href="madealdetails.php?value=<?php echo $prevNextArr[$nextKey]; ?>"> Next > </a>  <?php } ?>
                    </div> 
                        
        <div class="profilemain" id="dealinfo">
               ...
               <ul>
                 ...
                 <?php
                    ...
                    {
                    ?>
                    <li><h4>Revenue Multiple (Based on EV)</h4><p><?php echo $dec_revenue_multiple; ?></p></li>
                    <?php
                    }
                    ...
                    {
                    ?>
                    <li><h4>EBITDA Multiple (Based on EV)</h4><p><?php echo $dec_ebitda_multiple; ?></p></li>
                    <?php
                    }
                    ...
                    {
                    ?>
                   <li><h4>PAT Multiple (Based on EV)</h4><p><?php echo $dec_pat_multiple; ?></p></li>
                    <?php
                    }
                    ?>
                ...
                <?php
                    ...
                    {
                    ?>
                        <li><h4>Revenue (INR Cr)</h4><p><?php echo $dec_revenue; ?></p></li>
                     <?php
                    }
                    else{
                        if($dec_company_valuation >0 && $dec_revenue_multiple >0){ ?>

                            <li><h4>Revenue (INR Cr)</h4><p><?php echo number_format($dec_company_valuation/$dec_revenue_multiple, 2, '.', ''); ?></p></li>
                    <?php }
                    ...
                    <li><h4>EBITDA (INR Cr)</h4><p><?php echo $dec_ebitda; ?></p></li>
                     <?php
                    } 
                    else{
                        if($dec_company_valuation >0 && $dec_ebitda_multiple >0){ ?>

                            <li><h4>EBITDA (INR Cr)</h4><p><?php echo number_format($dec_company_valuation/$dec_ebitda_multiple, 2, '.', ''); ?></p></li>
                    <?php }
                    ...
                    {
                    ?>
                        <li><h4>PAT (INR Cr)</h4><p><?php echo $dec_pat; ?></p></li>
                     <?php
                    }else{
                        if($dec_company_valuation >0 && $dec_pat_multiple >0){ ?>

                            <li><h4>PAT (INR Cr)</h4><p><?php echo number_format($dec_company_valuation/$dec_pat_multiple, 2, '.', ''); ?></p></li>
                    <?php }
        ...
        <div class="postContainer postContent masonry-container">
            <div  class="work-masonry-thumb col-1" href="http://erikjohanssonphoto.com/work/aizone-ss13/" id="companyInfo">
                    <h2>Company Info</h2>
        ...
        ?>
                       ...
                       <?php if($myrow["uploadfilename"]!=""){ ?><td><h4>Financials </h4><p><a href=<?php echo $file;?> target="_blank" > Click here </a> </td></tr> <?php } ?>
            ...
            <div  class="work-masonry-thumb col-1" href="http://erikjohanssonphoto.com/work/aizone-ss13/" id="acquirerInfo">
                    <h2>Acquirer Info</h2>
                    <table cellpadding="0" cellspacing="0" class="tablelistview">
                    <tbody>
         ...
         <?php
                         ...
                         <tr> <?php if($AcquirerIndustryname!=""){ ?><td><h4>Industry (Acquirer)</h4><p><?php echo $AcquirerIndustryname;?></p></td><?php } ?>
                             <?php if($Acquirergroupname!=""){ ?><td><h4>Group (Acquirer)</h4><p><?php echo $Acquirergroupname;?></p></td><?php } ?></tr>
                ...
                <?php if($comp_cnt>0)
                    ...
                    ?>
                        ...
                        ?>
                                ...
                                <A class="postlink" href='maadvisor.php?value=<?php echo $myadcomprow["CIAId"];?>' >
                    ...
                    if($compinv_cnt>0)
                    {
                        ...
                        <?php
                                  ...
                                  {
                          ?>
                                  <a class="postlink" href='maadvisor.php?value=<?php echo $myadinvrow["CIAId"];?>' >
...
<!--            <div  class="work-masonry-thumb col-1" href="http://erikjohanssonphoto.com/work/tac-3/">
                 <h2>Exits Info</h2>
                  ...
                  <table class="tablelistview" cellpadding="0" cellspacing="0">
                         <?php
                            ...
                            {
                            ?>
                            <td ><h4>&nbsp;EBITDA Multiple (Based on Enterprise Valuation)
           ...
           <div  class="work-masonry-thumb col-2" href="http://erikjohanssonphoto.com/work/tac-3/" id="moreInfo">
                 <h2>More Info</h2>

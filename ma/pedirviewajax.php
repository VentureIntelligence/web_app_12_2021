<?php
        ...
        if($_REQUEST['sv'] =='')
        {
            ...
            if($_POST['showdeals'] != '')
            {
                $dealvalue = $_POST['showdeals'];
                     ...
                     $dealvalue = isset($_REQUEST['showvalue']) ? $_REQUEST['showvalue']:103; 
            }
        }
        else         
        {
        $dealvalue= isset($_REQUEST['sv']) ? $_REQUEST['sv'] : 103;
        }
	...
	$topNav = 'Directory';
        $defpage=$defvalue;
        $stagedef=1;
	include_once('madir_header1.php');
?>
<div id="container" >
    ...
    <div class="holder">
                ...
                ?>
                 ...
                 <?php } 
                     ...
                     ?>
                 <a class="jp-next">Next â†’</a>
                     <?php } else { ?>
                  <a class="jp-next jp-disabled">Next â†’</a>
                     <?php  } ?>
    </div>
        </div>
			<?php

...
//echo "<br>---" .$TrialSql;
    ...
    <div class="result-title">    
                 <h2>
                    <span > <?php echo  $_SESSION['totalall']; ?> Results Found for M&A Legal Transition</span> 
                 </h2>
                <?php 
                if(($exportToExcel==1))
                   {
     ...
     <div class="list-tab mt-list-tab"><ul>
            ...
            <li class="active"><a id="icon-detailed-view" href="diracquirer.php?value=<?php echo $_GET['value'];?>/<?php echo $dealvalues;?>" ><i></i> Detail View</a></li> 
            </ul></div> 	
    <div class="view-detailed"> 
         <div class="detailed-title-links"> <h2>  <?php echo $advisorname; ?></h2>
		<?php if ($prevKey!='-1') {?> <a  class="postlink" id="previous" href="diradvisor.php?value=<?php echo $prevNextArr[$prevKey]; ?>/<?php echo $dealvalue; ?>">< Previous</a><?php } ?> 
        <?php if ($nextKey < count($prevNextArr)) { ?><a class="postlink" id="next" href="diradvisor.php?value=<?php echo $prevNextArr[$nextKey]; ?>/<?php echo $dealvalue; ?>"> Next > </a>  <?php } ?>
                    </div> 
    ...
    ?>
         ...
         <div class="postContainer postContent masonry-container">
          ...
          if ($getcompanyrs = mysql_query($advisor_to_companysql))
            ...
            {
    ?>
        <div  class="work-masonry-thumb col-2" href="http://erikjohanssonphoto.com/work/aishti-ss13/" id="advisortoTargets">
        <h2>Advisor to Targets</h2>
                            ...
                            While($myInvrow=mysql_fetch_array($getcompanyrs, MYSQL_BOTH))
                    {
                            ...
                            if(($invResult==0) && ($invResult1==0) && ($invResult2==0))
                            {
                                  echo $myInvrow["Companyname"];?>
                                    ( <a href="<?php echo $dealpage;?>?value=<?php echo $myInvrow["MAMAId"];?>/<?php echo $dealvalue; ?>">
         ...
         <?php
             ...
             if ($getinvrs = mysql_query($advisor_to_investorsql))
            {
                     $inv_cnt = mysql_num_rows($getinvrs);
            }
            if($inv_cnt > 0)
            {
            ?>
        <div  class="work-masonry-thumb col-2" href="http://erikjohanssonphoto.com/work/aishti-ss13/" id="advisortoAcquirer">
        ...
        <tr><td><p>
                  <?php
                    ...
                    echo $myInvestrow["Companyname"]; ?>
                                    ...
                                    ( <a href="<?php echo $dealpage;?>?value=<?php echo $myInvestrow["MAMAId"];?>/<?php echo $dealvalue; ?>">
 ...
 <div class="lb" id="popup-box">
	<div class="title">Send this to your Colleague</div>
        <form>
            ...
            <div class="entry">
                    <h5>Subject</h5>
                    <p>Checkout this profile - <?php echo $advisorname; ?> - in Venture Intelligence</p>
                    <input type="hidden" name="subject" id="subject" value="Checkout this profile - <?php echo $advisorname; ?> - in Venture Intelligence"  />
            </div>
            <div class="entry">
                    <h5>Message</h5>
...
<script type="text/javascript" >
    $(document).ready(function(){
            <?php if(isset($_SESSION["demoTour"]) && isset($_SESSION["demoTour"])) { ?>

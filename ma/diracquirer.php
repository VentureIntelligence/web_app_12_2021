...
<?php
	...
	$topNav = 'Directory'; 
        ...
        $SelCompRef=$expvalue[0];
	$AcqId=	$expvalue[0];
        $dealvalue=$expvalue[1];
...
<tr>
 ...
 <?php
        ...
        //session_start();
        $prevNextArr = array();
        $prevNextArr = $_SESSION['acquirerId'];
	...
	if($rsInd= mysql_query($indSql))
	{
		...
		{  ?>
			...
			$acqIndustrySql="select industry,industryid from industry where industryid=".$AcIndustry;
	 ...
	 ?>
            ...
            <div class="result-title">    
                 <h2>
                    <span > <?php echo  $_SESSION['totalall']; ?> Results Found for M&A</span> 
                 </h2>
                <?php 
                if(($exportToExcel==1))
                   {
    ...
    <div class="list-tab mt-list-tab"><ul>
            <li><a  class="postlink" href="<?php echo $actionlink; ?>?value=<?php echo $dealvalue;?>"  id="icon-grid-view"><i></i> List  View</a></li>
    ...
    <div class="view-detailed"> 
		...
		<?php if ($prevKey!='-1') {?> <a  class="postlink" id="previous" href="diracquirer.php?value=<?php echo $prevNextArr[$prevKey]; ?>/<?php echo $dealvalue; ?>">< Previous</a><?php } ?> 
        <?php if ($nextKey < count($prevNextArr)) { ?><a class="postlink" id="next" href="diracquirer.php?value=<?php echo $prevNextArr[$nextKey]; ?>/<?php echo $dealvalue; ?>"> Next > </a>  <?php } ?>
                    </div> 
        ...
        <div class="postContainer postContent masonry-container">
            <div  class="work-masonry-thumb col-1" href="http://erikjohanssonphoto.com/work/aizone-ss13/">
                    ...
                    <?php
                            ...
                            ?>
                                            (<?php echo $myInvestrow["indname"];?>; <a href="dirdealdetails.php?value=<?php echo $myInvestrow["MAMAId"];?>/<?php echo $dealvalue;?>">

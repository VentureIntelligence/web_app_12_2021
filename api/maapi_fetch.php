<?php
    ...
    if( !$is_admin || $userCheck ) {
        $sel = "SELECT malogin_members.DCompId, malogin_members.EmailId, malogin_members.Name, malogin_members.user_authorization_status, dealcompanies.api_access 
                        FROM malogin_members
                        LEFT JOIN dealcompanies
                            ON dealcompanies.DCompId = malogin_members.DCompId 
                        WHERE malogin_members.EmailId = '$userName' AND malogin_members.Passwrd = '" . $password . "'";

                    ...
                    if($cprofile_id != ''){
                        ...
                        if(mysql_num_rows($PLStsQry) > 0){
                            while($res = mysql_fetch_array($PLStsQry)){
                                ...
                                $res1['OptnlIncome'] = ( $curreny_code == 'INR' ) ? trim( $res['OptnlIncome'] ) : (string)(trim( $res['OptnlIncome'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                $res1['OtherIncome'] = ( $curreny_code == 'INR' ) ? trim( $res['OtherIncome'] ) : (string)(trim( $res['OtherIncome'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                $res1['OptnlAdminandOthrExp'] = ( $curreny_code == 'INR' ) ? trim( $res['OptnlAdminandOthrExp'] ) : (string)(trim( $res['OptnlAdminandOthrExp'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                $res1['OptnlProfit'] = ( $curreny_code == 'INR' ) ? trim( $res['OptnlProfit'] ) : (string)(trim( $res['OptnlProfit'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                $res1['EBITDA'] = ( $curreny_code == 'INR' ) ? trim( $res['EBITDA'] ) : (string)(trim( $res['EBITDA'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                $res1['Interest'] = ( $curreny_code == 'INR' ) ? trim( $res['Interest'] ) : (string)(trim( $res['Interest'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                $res1['EBDT'] = ( $curreny_code == 'INR' ) ? trim( $res['EBDT'] ) : (string)(trim( $res['EBDT'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                $res1['Depreciation'] = ( $curreny_code == 'INR' ) ? trim( $res['Depreciation'] ) : (string)(trim( $res['Depreciation'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                $res1['EBT'] = ( $curreny_code == 'INR' ) ? trim( $res['EBT'] ) : (string)(trim( $res['EBT'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                $res1['Tax'] = ( $curreny_code == 'INR' ) ? trim( $res['Tax'] ) : (string)(trim( $res['Tax'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                $res1['PAT'] = ( $curreny_code == 'INR' ) ? trim( $res['PAT'] ) : (string)(trim( $res['PAT'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                $res1['FY'] = trim( $res['FY'] );
                                $res1['TotalIncome'] = ( $curreny_code == 'INR' ) ? trim( $res['TotalIncome'] ) : (string)(trim( $res['TotalIncome'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                $res1['BINR'] = ( $curreny_code == 'INR' ) ? trim( $res['BINR'] ) : (string)(trim( $res['BINR'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                $res1['DINR'] = ( $curreny_code == 'INR' ) ? trim( $res['DINR'] ) : (string)(trim( $res['DINR'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                ...
                                if($res['EmployeeRelatedExpenses']!= ""){
                                    $EmployeeRelatedExpenses1 = ( $curreny_code == 'INR' ) ? trim( $res['EmployeeRelatedExpenses'] ) : (string)(trim( $res['EmployeeRelatedExpenses'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                }else{
                                ...
                                if($res['EarninginForeignExchange']!= ""){
                                    $EarninginForeignExchange1 = ( $curreny_code == 'INR' ) ? trim( $res['EarninginForeignExchange'] ) : (string)(trim( $res['EarninginForeignExchange'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                }else{
                                ...
                                if($res['OutgoinForeignExchange']!= ""){
                                    $OutgoinForeignExchange1 = ( $curreny_code == 'INR' ) ? trim( $res['OutgoinForeignExchange'] ) : (string)(trim( $res['OutgoinForeignExchange'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                }else{
                        ...
                        $growth = array();
                            ...
                            if(mysql_num_rows($Qry) > 0){
                                while($res = mysql_fetch_array($Qry)){
                                    $res1 = array();
                                    $res1['FY'] = trim($res['FY']);
                                    $res1['ShareCapital'] = ( $curreny_code == 'INR' ) ? trim($res['ShareCapital']) : (string)(trim( $res['ShareCapital'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['ShareApplication'] = ( $curreny_code == 'INR' ) ? trim($res['ShareApplication']) : (string)(trim( $res['ShareApplication'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['ReservesSurplus'] = ( $curreny_code == 'INR' ) ? trim($res['ReservesSurplus']) : (string)(trim( $res['ReservesSurplus'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['TotalFunds'] = ( $curreny_code == 'INR' ) ? trim($res['TotalFunds']) : (string)(trim( $res['TotalFunds'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['SecuredLoans'] = ( $curreny_code == 'INR' ) ? trim($res['SecuredLoans']) : (string)(trim( $res['SecuredLoans'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['UnSecuredLoans'] = ( $curreny_code == 'INR' ) ? trim($res['UnSecuredLoans']) : (string)(trim( $res['UnSecuredLoans'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['LoanFunds'] = ( $curreny_code == 'INR' ) ? trim($res['LoanFunds']) : (string)(trim( $res['LoanFunds'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['OtherLiabilities'] = ( $curreny_code == 'INR' ) ? trim($res['OtherLiabilities']) : (string)(trim( $res['OtherLiabilities'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['DeferredTax'] = ( $curreny_code == 'INR' ) ? trim($res['DeferredTax']) : (string)(trim( $res['DeferredTax'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['SourcesOfFunds'] = ( $curreny_code == 'INR' ) ? trim($res['SourcesOfFunds']) : (string)(trim( $res['SourcesOfFunds'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['GrossBlock'] = ( $curreny_code == 'INR' ) ? trim($res['GrossBlock']) : (string)(trim( $res['GrossBlock'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['LessAccumulated'] = ( $curreny_code == 'INR' ) ? trim($res['LessAccumulated']) : (string)(trim( $res['LessAccumulated'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['NetBlock'] = ( $curreny_code == 'INR' ) ? trim($res['NetBlock']) : (string)(trim( $res['NetBlock'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['CapitalWork'] = ( $curreny_code == 'INR' ) ? trim($res['CapitalWork']) : (string)(trim( $res['CapitalWork'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['FixedAssets'] = ( $curreny_code == 'INR' ) ? trim($res['FixedAssets']) : (string)(trim( $res['FixedAssets'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['IntangibleAssets'] = ( $curreny_code == 'INR' ) ? trim($res['IntangibleAssets']) : (string)(trim( $res['IntangibleAssets'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['OtherNonCurrent'] = ( $curreny_code == 'INR' ) ? trim($res['OtherNonCurrent']) : (string)(trim( $res['OtherNonCurrent'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['Investments'] = ( $curreny_code == 'INR' ) ? trim($res['Investments']) : (string)(trim( $res['Investments'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['DeferredTaxAssets'] = ( $curreny_code == 'INR' ) ? trim($res['DeferredTaxAssets']) : (string)(trim( $res['DeferredTaxAssets'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['SundryDebtors'] = ( $curreny_code == 'INR' ) ? trim($res['SundryDebtors']) : (string)(trim( $res['SundryDebtors'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['CashBankBalances'] = ( $curreny_code == 'INR' ) ? trim($res['CashBankBalances']) : (string)(trim( $res['CashBankBalances'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['Inventories'] = ( $curreny_code == 'INR' ) ? trim($res['Inventories']) : (string)(trim( $res['Inventories'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['LoansAdvances'] = ( $curreny_code == 'INR' ) ? trim($res['LoansAdvances']) : (string)(trim( $res['LoansAdvances'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['OtherCurrentAssets'] = ( $curreny_code == 'INR' ) ? trim($res['OtherCurrentAssets']) : (string)(trim( $res['OtherCurrentAssets'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['CurrentAssets'] = ( $curreny_code == 'INR' ) ? trim($res['CurrentAssets']) : (string)(trim( $res['CurrentAssets'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['Provisions'] = ( $curreny_code == 'INR' ) ? trim($res['Provisions']) : (string)(trim( $res['Provisions'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['CurrentLiabilitiesProvision'] = ( $curreny_code == 'INR' ) ? trim($res['CurrentLiabilitiesProvision']) : (string)(trim( $res['CurrentLiabilitiesProvision'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['NetCurrentAssets'] = ( $curreny_code == 'INR' ) ? trim($res['NetCurrentAssets']) : (string)(trim( $res['NetCurrentAssets'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['ProfitLoss'] = ( $curreny_code == 'INR' ) ? trim($res['ProfitLoss']) : (string)(trim( $res['ProfitLoss'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['Miscellaneous'] = ( $curreny_code == 'INR' ) ? trim($res['Miscellaneous']) : (string)(trim( $res['Miscellaneous'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['TotalAssets'] = ( $curreny_code == 'INR' ) ? trim($res['TotalAssets']) : (string)(trim( $res['TotalAssets'] )/$currencyValue[ trim( $res['FY'] ) ]);
                            ...
                            if(mysql_num_rows($Qry) > 0){
                                while($res = mysql_fetch_array($Qry)){
                                    $res1 = array();
                                    $res1['FY'] = $res['FY'];
                                    $res1['ShareCapital'] = ( $curreny_code == 'INR' ) ? $res['ShareCapital'] : (string)(trim( $res['ShareCapital'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['ReservesSurplus'] = ( $curreny_code == 'INR' ) ? $res['ReservesSurplus'] : (string)(trim( $res['ReservesSurplus'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['TotalFunds'] = ( $curreny_code == 'INR' ) ? $res['TotalFunds'] : (string)(trim( $res['TotalFunds'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['ShareApplication'] = ( $curreny_code == 'INR' ) ? $res['ShareApplication'] : (string)(trim( $res['ShareApplication'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['L_term_borrowings'] = ( $curreny_code == 'INR' ) ? $res['L_term_borrowings'] : (string)(trim( $res['L_term_borrowings'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['deferred_tax_liabilities'] = ( $curreny_code == 'INR' ) ? $res['deferred_tax_liabilities'] : (string)(trim( $res['deferred_tax_liabilities'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['O_long_term_liabilities'] = ( $curreny_code == 'INR' ) ? $res['O_long_term_liabilities'] : (string)(trim( $res['O_long_term_liabilities'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['L_term_provisions'] = ( $curreny_code == 'INR' ) ? $res['L_term_provisions'] : (string)(trim( $res['L_term_provisions'] ))/$currencyValue[ trim( $res['FY'] ) ]; 
                                    $res1['T_non_current_liabilities'] = ( $curreny_code == 'INR' ) ? $res['T_non_current_liabilities'] : (string)(trim( $res['T_non_current_liabilities'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['S_term_borrowings'] = ( $curreny_code == 'INR' ) ? $res['S_term_borrowings'] : (string)(trim( $res['S_term_borrowings'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['Trade_payables'] = ( $curreny_code == 'INR' ) ? $res['Trade_payables'] : (string)(trim( $res['Trade_payables'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['O_current_liabilities'] = ( $curreny_code == 'INR' ) ? $res['O_current_liabilities'] : (string)(trim( $res['O_current_liabilities'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['S_term_provisions'] = ( $curreny_code == 'INR' ) ? $res['S_term_provisions'] : (string)(trim( $res['S_term_provisions'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['T_current_liabilities'] = ( $curreny_code == 'INR' ) ? $res['T_current_liabilities'] : (string)(trim( $res['T_current_liabilities'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['T_equity_liabilities'] = ( $curreny_code == 'INR' ) ? $res['T_equity_liabilities'] : (string)(trim( $res['T_equity_liabilities'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['Tangible_assets'] = ( $curreny_code == 'INR' ) ? $res['Tangible_assets'] : (string)(trim( $res['Tangible_assets'] )/$currencyValue[ trim( $res['FY'] ) ] ); 
                                    $res1['Intangible_assets'] = ( $curreny_code == 'INR' ) ? $res['Intangible_assets'] : (string)(trim( $res['Intangible_assets'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['T_fixed_assets'] = ( $curreny_code == 'INR' ) ? $res['T_fixed_assets'] : (string)(trim( $res['T_fixed_assets'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['N_current_investments'] = ( $curreny_code == 'INR' ) ? $res['N_current_investments'] : (string)(trim( $res['N_current_investments'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['Deferred_tax_assets'] = ( $curreny_code == 'INR' ) ? $res['Deferred_tax_assets'] : (string)(trim( $res['Deferred_tax_assets'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['L_term_loans_advances'] = ( $curreny_code == 'INR' ) ? $res['L_term_loans_advances'] : (string)(trim( $res['L_term_loans_advances'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['O_non_current_assets'] = ( $curreny_code == 'INR' ) ? $res['O_non_current_assets'] : (string)(trim( $res['O_non_current_assets'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['T_non_current_assets'] = ( $curreny_code == 'INR' ) ? $res['T_non_current_assets'] : (string)(trim( $res['T_non_current_assets'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['Current_investments'] = ( $curreny_code == 'INR' ) ? $res['Current_investments'] : (string)(trim( $res['Current_investments'] )/$currencyValue[ trim( $res['FY'] ) ]);

                                    $res1['Inventories'] = ( $curreny_code == 'INR' ) ? $res['Inventories'] : (string)(trim( $res['Inventories'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['Trade_receivables'] = ( $curreny_code == 'INR' ) ? $res['Trade_receivables'] : (string)(trim( $res['Trade_receivables'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['Cash_bank_balances'] = ( $curreny_code == 'INR' ) ? $res['Cash_bank_balances'] : (string)(trim( $res['Cash_bank_balances'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['S_term_loans_advances'] = ( $curreny_code == 'INR' ) ? $res['S_term_loans_advances'] : (string)(trim( $res['S_term_loans_advances'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['O_current_assets'] = ( $curreny_code == 'INR' ) ? $res['O_current_assets'] : (string)(trim( $res['O_current_assets'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['T_current_assets'] = ( $curreny_code == 'INR' ) ? $res['T_current_assets'] : (string)(trim( $res['T_current_assets'] )/$currencyValue[ trim( $res['FY'] ) ]);
                                    $res1['Total_assets'] = ( $curreny_code == 'INR' ) ? $res['Total_assets'] : (string)(trim( $res['Total_assets'] )/$currencyValue[ trim( $res['FY'] ) ]);
...
//-----------------------------------------------------------Funding Details------------------------------------------------------------------------------------------
$getcompanysql = "select PECompanyId from pecompanies where CINNo ='".$cin."'";

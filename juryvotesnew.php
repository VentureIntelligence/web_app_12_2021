...
<body>
<form name="juryvotes" method="post" action="juryvotessubmitnew.php" >
	...
	<div style="width:565px; float:left; padding-left:2px;">
	  ...
	  <?php
		...
		//	$Db = new dbConnect();
			...
			$link = mysql_connect("localhost", "venture_admin",  "lQfcjxmrS2");
			$dbname="venture_Tsjmedia";
			//$dbname = 'tsjmedia';
		...
		if(($loginemail != "")  && ($loginpassword!=""))
		{
			...
			if($row_cnt==1)
			{
				While($myrow=mysql_fetch_array($selectrs))
				{
					$juryname = $myrow[1];
				}
			?>
				  ...
				  Please find below the nominations for the Venture Intelligence APEX Awards 2007.
					The nominations were based on Venture Intelligence research and a poll of Limited Partners and Investment Bankers.
					<u>Please note that the period for consideration for APEX 2007 is from Oct '05 to Dec '06.</u>
					<i>
					The individual jury votes are treated strictly confidential and directed exlusively for
				 ...
				 <img src="images/dot1.gif" /> Exits  <br />
				 <img src="images/dot1.gif" /> Succesful raising of a follow-on fund  <br />
				 ...
				 <div id="headingtextprobold"> Best Fund - Early Stage & Specialized   <br /> </div>
				 <input type="radio" value="SIDBI Venture Capital" name="bfes"> SIDBI Venture Capital <br/>
				 <input type="radio" value="IDFC Private Equity" name="bfes"> IDFC Private Equity <br />
				 <input type="radio" value=" Sequoia India" name="bfes"> Sequoia India (Formerly WestBridge Capital)  <br /> <br />

				<div id="headingtextprobold"> Best Fund - Growth Stage   <br /></div>
				<input type="radio" value="Baring Private Equity Partners" name="BFGS"> Baring Private Equity Partners <br />
				<input type="radio" value="India Value Fund" name="BFGS"> India Value Fund <br />
				<input type="radio" value="UTI Ventures" name="BFGS"> UTI Ventures <br />
				<input type="radio" value="Kotak Private Equity" name="BFGS"> Kotak Private Equity <br /> <br />

				<div id="headingtextprobold"> Best Fund - Late Stage & PIPE  <br /></div>
				<input type="radio" value="Warbug Pincus" name="BFLS"> Warbug Pincus <br />
				<input type="radio" value="ICICI Venture" name="BFLS"> ICICI Venture <br />
				<input type="radio" value="ChrysCapital" name="BFLS"> ChrysCapital <br />
				<input type="radio" value="Citigroup" name="BFLS"> Citigroup <br />
				<input type="radio" value="Temasek" name="BFLS"> Temasek <br />
				<input type="radio" value="Newbridge" name="BFLS"> Newbridge <br /> <br />
...
<?php
		...
		?>
			  ...
			  <div id="headingtextprobold">  <a href="juryloginnew.php">Jury Login  </a> <br /> <br /></div>

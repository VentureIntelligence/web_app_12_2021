...
<form name="addAcqinvmgmt" method="post" action="addAcquirerMgmt.php">
...
<?php
	...
	{
?>
<p > <b><center> <font style="font-family: Verdana; font-size: 10pt">Add Management Executive(s) for Acquirer</font> </b></center></p>
...
function inst_acquirer_managment($acquirerId,$executiveId)
{
	...
	$insExecmgmtSql = "insert into acquirer_management values ($acquirerId,$executiveId)";

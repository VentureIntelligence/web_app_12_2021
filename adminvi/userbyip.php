...
if (session_is_registered("SessLoggedAdminPwd") && session_is_registered("SessLoggedIpAdd"))
{
    ...
    { 
        if(!isset($_POST['logsort'])){
            ...
            $logsort = ' ip_count desc';
        }else{

            $logsort = ' ip_count '.$_POST['logsort'];
    ...
    $UserbyIPSql="SELECT ipAdd IP,substring_index(EmailId, '@', -1) domain, COUNT(*) ip_count FROM dealLog " .$allquerydate." and PE_MA = 0 and ipAdd !='' and substring_index(EmailId, '@', -1)  NOT IN ('kutung.com') ".$bycompany_name." GROUP BY IP ORDER BY ".$order_by.$orgsort.$logsort." limit $limit";
...
function findEmails()
{
    ...
    document.log.action="userbyip.php";
	...
	<div style="width:565px; float:left; padding-left:2px;">
            <div style=" width:565px;  margin-top:4px;">
                <div class="tab-header">
                    ...
                    <span class="tab-title link-active" data-id="ipa" data-value="2"><a href="userbyip.php">IP Addresses</a></span>
                ...
                <div id="maintextpro" style="background-color: #ffffff;width:100%; min-height: 738px;">
                        ...
                        <div class="filter-sec" style="/*border:0px !important;*/">
                            <form name="log" method="post" action="" id="log">
                                ...
                                <div class="ftype-wrapper comp_div">
                                    ...
                                    <div class="comp-name" style="display: <?php echo $_POST['type_result'] ==2 ? '':none; ?>" id="comp_name" placeholder="Search by email">
                    ...
                    <div id="pe-section" class="pe-section">
                        <div class="all-items">
                            ...
                            <div class="all-content" id="ipa">
                                <form id="ipdetails" action="https://www.melissadata.com/lookups/iplocation.asp" method="post" target="_blank">
                                ...
                                <div class="title-sec">
                                    ...
                                    <div></div>
                                    <div>
                                        <span>Organization <i class="sort" id="orgsort" data-sortby="<?php echo $orgsorted !='' ? $orgsorted:'desc'; ?>"></i></span>
                                    </div>
                                 ...
                                 if ($userip_cnt > 0)
                                    {
                                        ...
                                        ?>
                                            <div class="content-sec">
                                                ...
                                                <div class="ip-add"><span><?php echo $myrow['IP']; ?></span></div>
                                                <div class="expand-icon"><span class="zmdi zmdi-chevron-down"></span></div>
                                                <div class="o-name"><span><?php echo $myrow['domain']; ?></span></div>
                                                <div class="num-logins  text-right"><span><?php echo  $myrow['ip_count']; ?></span></div>
                                                <div class="det-link"><span><a class="ip-link" data-ip="<?php echo $myrow['IP']; ?>" title="Who is this? <?php echo $myrow['IP']; ?>"><img src="../Images/globe-icon.ico" class="globe-icon"></a></span></div>
                                                            ...
                                                            if ($user_cnt > 0)
                                                            {
                                                                ...
                                                                ?>
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        <div class="text-right"><?php echo $myrow['user_count']; ?></div>
                                                                    </div>

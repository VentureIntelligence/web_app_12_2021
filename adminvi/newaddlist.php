...
// && session_is_registered("SessLoggedIpAdd"))
                ...
                if($action=='add')
                {
                    $insertsql= "INSERT INTO nanotool (typeofReport,titleofReport,periodofReport,ar_PE,ar_VC,ar_Earlystage,ar_MA,ar_RE,ar_Infra,ar_Social,ar_Cleantech,date,definitions,zscore_id)
                                        VALUES ('$typeofreport','$titleofreport','$periodofreport',$ar_PE,$ar_VC,$ar_Early,$ar_MA,$ar_RE,$ar_Infra,$ar_social,$ar_cleantech,'$dateofreport','$def','$zscore_id')";
                    //echo "<br>@@@@ :".$insertsql;
                ...
                else
                {
                  ...
                  // echo $row['nanobi_EC'];
                   ...
                   $target_file='./nanofolder/'.$filename;
                    ...
                    fwrite($handle, $nanocode); // write it
                    fclose($handle);
                    $updatesql="update nanotool set typeofReport='$typeofreport', titleofReport='$titleofreport', periodofReport='$periodofreport', ar_PE=$ar_PE, ar_VC=$ar_VC, ar_Earlystage=$ar_Early, 

...
<body>
    <form name="adminFilter" id="adminFilter" method="post" action="exportcfscomapny.php" >
                    ...
                    <div style="padding:0px 15px">
                        <div id="maintextpro">
                            <div id="headingtextpro">
                                <h3 style="margin-bottom:15px;float:left;">Export CFS Companies</h3>
                        ...
                        <div > -->
                        <input type="checkbox" id="Pecompanyauto_sug" name="companyauto_sug" value="pe" checked>
                          <label for="Pecompanyauto_sug">all</label><br>
                        </div>

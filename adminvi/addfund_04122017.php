...
if($dbType =='PE')
      ...
      //Insert into Table
        $sqlIns = "INSERT INTO `fundRaisingDetails` (`dbType`,`investorId`,`fundName`,`fundManager`,`REsector`,`size`,`fundStatus`,`fundClosedStatus`,`fundDate`,`capitalSource`,`moreInfo`,`source`) ";
        $sqlIns .= " VALUES ('".$dbType."','".$investorId."','".$fundnameId."','".$fundMan."','".$REsector."','".$fundSize."','".$fundStatus."','".$fundCloseStatus."','".$fundDate."','".$capitalSource."','".$moreInfo."','".$source."')";
 }      

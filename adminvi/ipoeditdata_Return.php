...
<body>
 <form name=editdeal method=post action="ipoupdatedata_Return.php">
 <table border=1 align=center cellpadding=0 cellspacing=0 width=45%
		...
		While($mycomprow=mysql_fetch_array($companyrs, MYSQL_BOTH))
		{
			...
			?>
				...
				<tr>
                                               				  ...
                                               				  if ($rsinvestors = mysql_query($getInvestorsSql))
									  {
										While($myInvrow=mysql_fetch_array($rsinvestors, MYSQL_BOTH))
										{
											...
											$strInvestorValue =ereg_replace(" ","/",$investorString);
                                                                                        ...
                                                                                        $invMoreInfo[$i]=$myrow["InvMoreInfo"];
   										?>
								...
								<tr> <td> </td><td><input type="button" value="Add Investors,Return Multiple and More Info" name="addInvestor"

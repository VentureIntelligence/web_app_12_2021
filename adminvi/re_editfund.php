 ...
 if (session_is_registered("SessLoggedAdminPwd") && session_is_registered("SessLoggedIpAdd")){
    ...
    if ($_POST){
       ...
       // $fundTypStage       = $_POST['fundTypeStage'];
        ...
        $sqlUpdate ="UPDATE `fundRaisingDetails` SET `dbType` = '$dbType',`investorId` = '".$investorId."',`fundName` = '".$fundnameId."',`fundManager` = '".$fundMan."',`REsector` = '".$REsector."',`size` = ".$fundSize.",`fundStatus` = '".$fundStatus."',`fundClosedStatus` = '".$fundCloseStatus."',`fundDate` = '".$fundDate."',`capitalSource` = '".$capitalSource."',`moreInfo` = '".$moreInfo."',`source` = '".$source."', `amount_raised` = " . $amount_raised . " WHERE `id` = '".$fundId."'";

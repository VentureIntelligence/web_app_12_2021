...
<?php
	...
	if($updaters=mysql_query($UpdatecompanySql))
	{
	    ...
	    Validation='$validationtoUpdate', Link='$linktoUpdate',Deleted=$flagDeletion,AggHide=$hideAggregatetoUpdate
		...
		if ($investoridarray>0)
		{
			...
			{
			    $updatePEInv_InvestorSql="delete from angel_investors where AngelDealId=$PEIdtoUpdate and InvestorId=$delId";

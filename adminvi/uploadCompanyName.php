...
{
    if (document.dealsupload.companyFilePath.value == "")
    {
	alert("Please choose the file (Company name) .xls to import");
	return false;
    }
    else
    {
        //	return true;
	document.dealsupload.action="generatecompanyname.php";
                             ...
                             <div id="maintextpro" style="background-color: #ffffff;width:100%; " class="main_content_container">
                                <div id="headingtextpro">
                                    <div class="acc-section">
                                        <div class="accordian">
                                            <h3 class="acc-title"><span>CFS</span> <i class="zmdi zmdi-chevron-down"></i></h3>
                                            <div class="acc-content">
                                                <p>Upload Company Name:</p>
                                                <div class="upload-sec">
                                                    <input type="file" NAME="companyFilePath" class="ip-file">
                                                </div>

...
if (session_is_registered("SessLoggedAdminPwd") && session_is_registered("SessLoggedIpAdd"))
{
    ...
    { 
        if(!isset($_POST['logsort'])){
            ...
            $logsort = ' user_count desc';
        }else{

            $logsort = ' user_count '.$_POST['logsort'];
    ...
    if($type==1){
        ...
        $UsertopSql="SELECT substring_index(EmailId, '@', 1) users,substring_index(EmailId, '@', -1) domain, COUNT(*) user_count,EmailId FROM dealLog " .$allquerydate." and PE_MA = 0 and substring_index(EmailId, '@', -1)!='' and substring_index(EmailId, '@', -1)  NOT IN ('kutung.com') ".$bycompany_name." GROUP BY substring_index(EmailId, '@', 1) order by ".$logsort ." ".$orgsort. $order_by." LIMIT $limit";
        ...
        $cfsUsertopSql="SELECT substring_index(EmailId, '@', 1) users,substring_index(EmailId, '@', -1) domain, COUNT(*) user_count,EmailId FROM userlog_device where dbTYpe = 'CFS' and substring_index(EmailId, '@', -1)!='' and substring_index(EmailId, '@', -1)  NOT IN ('kutung.com') ".$bycompany_name." GROUP BY substring_index(EmailId, '@', 1) order by ".$logsort ." ".$orgsort. $order_by." LIMIT $limit";
        if ($cfsusersrs = mysql_query($cfsUsertopSql))
        {
            $cfsusers_cnt = mysql_num_rows($cfsusersrs);
        }
    }
...
function findEmails()
{
    ...
    document.log.action="topusers.php";
	...
	<div style="width:565px; float:left; padding-left:2px;">
            <div style=" width:565px;  margin-top:4px;">
                <div class="tab-header">
                    ...
                    <span class="tab-title link-active" data-id="use" data-value="3"><a href="topusers.php">Users</a></span>
                ...
                <div id="maintextpro" style="background-color: #ffffff;width:100%; min-height: 687px;">
                    <div id="headingtextpro">
                        <div class="filter-sec" style="/*border:0px !important;*/">
                            <form name="log" method="post" action="" id="log">
                                ...
                                <?php if($users_cnt > 0 || $cfsusers_cnt > 0){ ?>
                        ...
                        <form name="export"  method="post" action="" >
                            ...
                            <?php if($type==1){ ?>
                                    ...
                                    <input type="hidden" name="fetchby" value="3">
                                <?php }else{ ?>
                                    
                                    <input type="hidden" name="fetchby" value="5">
                                <?php } ?>
                        </form>
                        ...
                        <div class="all-items">
                            ...
                            <div class="all-content" id="use">
                                ...
                                if($type == 1){
                                    ...
                                    if ($users_cnt > 0)
                                    {
                                        ...
                                        ?>
                                            <div class="content-sec">
                                                ...
                                                <div class="u-name"><span><?php echo $myrow['EmailId']; ?></span></div>
                                                <div class="o-name"><span><?php echo $myrow['domain']; ?></span></div>
                                                <div class="num-logins  text-right"><span><?php echo $myrow['user_count']; ?></span></div>
                                            </div>
                                    ...
                                    {
                                        $org=1; 
                                        While($myrow=mysql_fetch_array($cfsusersrs, MYSQL_BOTH))
                                        { 
                                        ?>
                                            <div class="content-sec">
                                                <div class="s-no"><span><?php echo $org; ?></span></div>

...
?>
   		...
   		<tr bgcolor="#808000"><td colspan=2 align=center style="color: #FFFFFF" ><b> Add RE Deal</b></td></tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td> 
                                                                        <select name="exitstatus">
                                                                            ...
                                                                            <option id="1" value="1" selected="">Unexited  </option>
                                                                            <option id="2" value="2">Partially Exited  </option>
                                                                            <option id="3" value="3">Fully Exited  </option>
							...
							`	<tr>
								...
								<td >
								<input type="CHECKBOX" name="chkhideAggRE" id="myCheck"  >

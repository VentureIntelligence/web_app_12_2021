		...
		//		echo "<br>company update Query-- " .$UpdatecompanySql;
			if($updaters=mysql_query($UpdatecompanySql))
			{
    				...
    				Company_Valuation='$company_valuation',Sales_Multiple='$sales_multiple',EBITDA_Multiple='$EBITDA_multiple',
                                    ...
                                    Valuation='$valuation',FinLink='$finlink',ExitStatus='$exitstatusvalue',Revenue='$revenue',EBITDA='$ebitda',PAT='$pat',price_to_book='$price_to_book',book_value_per_share='$book_value_per_share',price_per_share='$price_per_share',stakeSold=$stakesold
    				...
    				Company_Valuation='$company_valuation',Sales_Multiple='$sales_multiple',EBITDA_Multiple='$EBITDA_multiple',
                                    Netprofit_Multiple=$netprofit_multiple,InvestorSale=$investorsale,SellingInvestors='$selling_investors',
                                    Valuation='$valuation',FinLink='$finlink',ExitStatus=$exitstatusvalue,Valuation_Working_fname='$filename',Revenue='$revenue',EBITDA='$ebitda',PAT='$pat',price_to_book='$price_to_book',book_value_per_share='$book_value_per_share',price_per_share='$price_per_share',stakeSold=$stakesold
                                    where IPOId=$IPOIdtoUpdate";
                                }

...
<body>
 <form name=editacqprofile method=post action="acquirerprofileeditupdate.php">
...
$value = isset($_REQUEST['value']) ? $_REQUEST['value'] : '';
	...
	$SelCompRef=$value;
   	...
   	acq.countryid,c.country,Telephone,Fax,Email,Website,linkedIn,
   	OtherLocations,AdditionalInfor FROM acquirers as acq,country as c WHERE
				...
				<tr>
					...
					<?php
						...
						if($ind_cnt > 0)
						{
							if($mycomprow[9] == 11)
                                            {
                                                echo "<OPTION id=". $mycomprow[9]. " value='11' SELECTED>Choose Country</OPTION> \n";
                                            }else{
                                                echo "<OPTION id=". $mycomprow[9]. " value='11' >Choose Country</OPTION> \n";
                                            }
...
<!--
				...
				<td><textarea name="txtaddinfor" rows="2" cols="50"><?php echo $mycomprow["AdditionalInfor"]; ?> </textarea> </td>
					...
					onClick="window.open('addAcquirerMgmt.php?value=<?php echo $SelCompRef;?>','mywindow','width=400,height=400')">

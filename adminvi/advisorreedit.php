...
<body>
 <form name=advisoredit method=post action="advisorreupdate.php">
...
$value = isset($_REQUEST['value']) ? $_REQUEST['value'] : '';
        $currentyear = date("Y");
	$advisorId=$value;
   	$getDatasql = " select * from REadvisor_cias where CIAId=$advisorId";
	  ...
	  if($company_cnt > 0)
	{
	     	While($mycomprow=mysql_fetch_array($companyrs, MYSQL_BOTH))
		{
         ...
         ?>
                       	<tr bgcolor="#808000"><td colspan=2 align=center style="color: #FFFFFF" ><b> RE-Advisor Edit Deal</b></td></tr>
				<tr>
...
<table align=center>
<tr> <Td> <input type="submit" value="Update RE-Advsior Info" name="updateDeal" > </td></tr></table>

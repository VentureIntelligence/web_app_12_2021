<?php
    ...
    if (session_is_registered("SessLoggedAdminPwd") && session_is_registered("SessLoggedIpAdd"))
    {
        ...
        $searchTitle = "List of Incubatees ";

        $incubatee=$_POST['companysearch'];
        if(trim($incubatee)=="")
                $getinvSql="select distinct pe.IncubateeId,c.companyname from pecompanies as c,incubatordeals as pe
                where c.PECompanyId=pe.IncubateeId and pe.Deleted=0 order by companyname";
        elseif(trim($incubatee)!="")
                $getinvSql="select distinct pe.IncubateeId,c.companyname from pecompanies as c,incubatordeals as pe
                where c.PECompanyId=pe.IncubateeId and pe.Deleted=0 and companyname like '%$incubatee%' order by companyname";
                ...
                <form name="getinvestor"  method="post" >
					...
					$totalInv=0;
				 	  // echo "<br> query final-----" .$getcompSql;
						 ...
						 if ($companyrs = mysql_query($getinvSql))
						 {
				           ...
				           {
				              	$searchTitle= $searchTitle ." -- No Incubators found for this search ";
				           }
					...
					<div style="width: 542px; /*height:305px;*/ overflow: scroll;" class="content_container">
						   ...
						   While($myrow=mysql_fetch_array($companyrs, MYSQL_BOTH))
							{
							 ?>
							<tr><Td>
							<A href="companyprofileedit.php?value=<?php echo $myrow["IncubateeId"];?> "
						   target="popup" onclick="MyWindow=window.open('companyprofileedit.php?value=<?php echo $myrow["IncubateeId"];?>', 'popup', 'scrollbars=1,width=600,height=500');MyWindow.focus(top);return false">
						...
						?>
                                ...
                                <div id="headingtextproboldbcolor" style="margin-top: -20px;">&nbsp; No. of Incubators  - <?php echo $totalInv; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                </div>
                            </div>
                        </div>
                    </form>
                    <span style="float:left;margin-left: 15px;margin-top: -40px;">
                        <form name="pelisting"  method="post" action="exportIncubatees.php">

...
if (session_is_registered("SessLoggedAdminPwd") && session_is_registered("SessLoggedIpAdd"))
{
    ...
    { 
        if(!isset($_POST['datesort'])){
            ...
            $datesort = ' last_date desc';
        }else{

            $datesort = ' last_date '.$_POST['datesort'];
    ...
    if(!isset($_POST['orgsortby']) && !isset($_POST['logsortby']) && !isset($_POST['datesortby']) || ($_POST['orgsortby']==0 && $_POST['logsortby']==0 && $_POST['datesortby']==0))
    { 
        $order_by = ' last_date desc';
    }
    
    $exportsortby = $logsort . $orgsort . $datesort . $order_by;
    ...
    $UserorgSql="SELECT substring_index(EmailId, '@', -1) domain, COUNT(*) email_count, MAX(LoggedIn) as last_date FROM dealLog " .$allquerydate." and PE_MA = 0 and substring_index(EmailId, '@', -1)  NOT IN ('kutung.com') ".$bycompany_name." GROUP BY substring_index(EmailId, '@', -1) ORDER BY ". $logsort . $orgsort . $datesort . $order_by." LIMIT $limit";
...
function findEmails()
{
    ...
    document.log.action="lastlogin.php";
	...
	<div style="width:565px; float:left; padding-left:2px;">
            <div style=" width:565px;  margin-top:4px;">
                <div class="tab-header">
                    ...
                    <span class="tab-title link-active" data-id="las" data-value="5"><a href="lastlogin.php">Last Login</a></span>
                ...
                <div id="maintextpro" style="background-color: #ffffff;width:100%; min-height: 738px;">
                    <div id="headingtextpro">
                        ...
                        <form name="export"  method="post" action="" >                              
                            ...
                            <input type="hidden" name="fetchby" value="6">
                        </form>

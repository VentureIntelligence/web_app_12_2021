			...
			While($myrow=mysql_fetch_array($rsgetInvestorId, MYSQL_BOTH))
			{
				...
				echo "<br>Insert return investor id--" .$invId;
			             ...
			             $updateAdTypeSql="Update advisor_cias set AdvisorType='$adtype' where CIAId=$AdInvestorId";
                                    ...
                                    elseif($pereflagAfterSubmit=="RE")
                                    {
                                        $updateAdTypeSql="Update REadvisor_cias set AdvisorType='$adtype' where CIAId=$AdInvestorId";
		}
...
{
	echo "<Br>INSIDE FUNCTION TO ADD ADVISOR INVESTORS-- ".$pereflagAfterSubmit;

						...
						<?php
						   While($myrow=mysql_fetch_array($companyrs, MYSQL_BOTH))
							...
							<tr><td><input type="checkbox" name="AdvisorId[]" value="<?php echo $myrow["CIAId"];?>" >
                                                                    <a href="advisorreedit.php?value=<?php echo $myrow["CIAId"];?> "
						   target="popup" onclick="MyWindow=window.open('advisorreedit.php?value=<?php echo $myrow["CIAId"];?>', 'popup', 'scrollbars=1,width=600,height=500');MyWindow.focus(top);return false">
                                                        <?php echo $myrow["cianame"];?></a> </td> <td> <?php echo $myrow["AdvisorType"];?> </td>
